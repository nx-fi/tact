...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndCommentAndStringAndSliceReceiverTester_init_args = {
    $$type: 'EmptyAndCommentAndStringAndSliceReceiverTester_init_args';
}

function initEmptyAndCommentAndStringAndSliceReceiverTester_init_args(src: EmptyAndCommentAndStringAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyAndCommentAndStringAndSliceReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyAndCommentAndStringAndSliceReceiverTester_init_args({ $$type: 'EmptyAndCommentAndStringAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyAndCommentAndStringAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndCommentAndStringAndSliceReceiverTester_types: ABIType[] = [
...
const EmptyAndCommentAndStringAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndCommentAndStringAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndCommentAndStringAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndCommentAndStringAndSliceReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyAndCommentAndStringAndSliceReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyAndCommentAndStringAndSliceReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyAndCommentAndStringAndSliceReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyAndCommentAndStringAndSliceReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyAndCommentAndStringAndSliceReceiverTester_types,
        getters: EmptyAndCommentAndStringAndSliceReceiverTester_getters,
        receivers: EmptyAndCommentAndStringAndSliceReceiverTester_receivers,
        errors: EmptyAndCommentAndStringAndSliceReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message" | string | Slice) {
    ...
    async sendExternal(provider: ContractProvider, message: null | 'message' | string | Slice) {
