...
function initContractWithOptionals_init_args(
    src: ContractWithOptionals_init_args,
) {
    return (builder: Builder) => {
        const b_0 = builder;
        if (src.a !== null && src.a !== undefined) {
...
async function ContractWithOptionals_init(
    a: bigint | null,
    b: boolean | null,
    c: Cell | null,
    d: Address | null,
...
export class ContractWithOptionals implements Contract {
    ...
    async getIsNotNullA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(74449 as any, builder.build()))
            .stack;
    ...
    async getIsNotNullB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(70322 as any, builder.build()))
            .stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(66195 as any, builder.build()))
            .stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(94836 as any, builder.build()))
            .stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(90709 as any, builder.build()))
            .stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullF(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(86582 as any, builder.build()))
            .stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getNullA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(119020 as any, builder.build()))
            .stack;
    ...
    async getNullB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(123023 as any, builder.build()))
            .stack;
    ...
    async getNullC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(127150 as any, builder.build()))
            .stack;
    ...
    async getNullD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(98377 as any, builder.build()))
            .stack;
    ...
    async getNullE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(102504 as any, builder.build()))
            .stack;
    ...
    async getNullF(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(106507 as any, builder.build()))
            .stack;
        const result_p = source.readTupleOpt();
    ...
    async getNotNullA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(110911 as any, builder.build()))
            .stack;
    ...
    async getNotNullB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(98652 as any, builder.build()))
            .stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getNotNullC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(102781 as any, builder.build()))
            .stack;
    ...
    async getNotNullD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(123290 as any, builder.build()))
            .stack;
    ...
    async getNotNullE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(127419 as any, builder.build()))
            .stack;
    ...
    async getNotNullF(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115160 as any, builder.build()))
            .stack;
    ...
    async getTestVariables(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(87190 as any, builder.build()))
            .stack;
        const result = loadGetterTupleSomeGenericStruct(source);
        return result;
    }
