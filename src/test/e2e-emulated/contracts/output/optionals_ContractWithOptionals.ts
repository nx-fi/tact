...
function dictValueParserSomeGenericStruct(): DictionaryValue<SomeGenericStruct> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSomeGenericStruct(src)).endCell());
        },
        parse: (src) => {
...
function dictValueParserStructWithOptionals(): DictionaryValue<StructWithOptionals> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeStructWithOptionals(src)).endCell());
        },
        parse: (src) => {
...
export function storeContractWithOptionals$Data(src: ContractWithOptionals$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
        if (src.a !== null && src.a !== undefined) { b_0.storeBit(true).storeInt(src.a, 257); } else { b_0.storeBit(false); }
        if (src.b !== null && src.b !== undefined) { b_0.storeBit(true).storeBit(src.b); } else { b_0.storeBit(false); }
...
export function loadContractWithOptionals$Data(slice: Slice) {
    ...
    const sc_2 = sc_1.loadRef().beginParse();
    const _f = sc_2.loadBit() ? loadStructWithOptionals(sc_2) : null;
    return { $$type: 'ContractWithOptionals$Data' as const, a: _a, b: _b, c: _c, d: _d, e: _e, f: _f };
}
...
function storeTupleContractWithOptionals$Data(source: ContractWithOptionals$Data) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.a);
    builder.writeBoolean(source.b);
    builder.writeCell(source.c);
...
function dictValueParserContractWithOptionals$Data(): DictionaryValue<ContractWithOptionals$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeContractWithOptionals$Data(src)).endCell());
        },
        parse: (src) => {
...
export const ContractWithOptionals_getterMapping: { [key: string]: string } = {
...
export class ContractWithOptionals implements Contract {
    ...
    async getIsNotNullA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(74449 as any, builder.build())).stack;
    ...
    async getIsNotNullB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(70322 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(66195 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(94836 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(90709 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNullF(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(86582 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getNullA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(119020 as any, builder.build())).stack;
    ...
    async getNullB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(123023 as any, builder.build())).stack;
    ...
    async getNullC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(127150 as any, builder.build())).stack;
    ...
    async getNullD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(98377 as any, builder.build())).stack;
    ...
    async getNullE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(102504 as any, builder.build())).stack;
    ...
    async getNullF(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(106507 as any, builder.build())).stack;
        const result_p = source.readTupleOpt();
    ...
    async getNotNullA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(110911 as any, builder.build())).stack;
    ...
    async getNotNullB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(98652 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getNotNullC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(102781 as any, builder.build())).stack;
    ...
    async getNotNullD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(123290 as any, builder.build())).stack;
    ...
    async getNotNullE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(127419 as any, builder.build())).stack;
    ...
    async getNotNullF(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115160 as any, builder.build())).stack;
    ...
    async getTestVariables(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(87190 as any, builder.build())).stack;
        const result = loadGetterTupleSomeGenericStruct(source);
        return result;
    }
