...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type CommentAndStringAndSliceReceiverTester_init_args = {
    $$type: 'CommentAndStringAndSliceReceiverTester_init_args';
}

function initCommentAndStringAndSliceReceiverTester_init_args(src: CommentAndStringAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function CommentAndStringAndSliceReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initCommentAndStringAndSliceReceiverTester_init_args({ $$type: 'CommentAndStringAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const CommentAndStringAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const CommentAndStringAndSliceReceiverTester_types: ABIType[] = [
...
const CommentAndStringAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const CommentAndStringAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const CommentAndStringAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class CommentAndStringAndSliceReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await CommentAndStringAndSliceReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await CommentAndStringAndSliceReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new CommentAndStringAndSliceReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new CommentAndStringAndSliceReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  CommentAndStringAndSliceReceiverTester_types,
        getters: CommentAndStringAndSliceReceiverTester_getters,
        receivers: CommentAndStringAndSliceReceiverTester_receivers,
        errors: CommentAndStringAndSliceReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "message" | string | Slice) {
    ...
    async sendExternal(provider: ContractProvider, message: 'message' | string | Slice) {
