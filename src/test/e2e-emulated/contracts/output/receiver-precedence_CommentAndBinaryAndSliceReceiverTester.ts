...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type CommentAndBinaryAndSliceReceiverTester_init_args = {
    $$type: 'CommentAndBinaryAndSliceReceiverTester_init_args';
}

function initCommentAndBinaryAndSliceReceiverTester_init_args(src: CommentAndBinaryAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const CommentAndBinaryAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const CommentAndBinaryAndSliceReceiverTester_types: ABIType[] = [
...
const CommentAndBinaryAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const CommentAndBinaryAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const CommentAndBinaryAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class CommentAndBinaryAndSliceReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "message" | Message | Slice | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | 'message' | Message | Slice) {
