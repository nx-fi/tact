...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndCommentAndStringReceiverTester_init_args = {
    $$type: 'EmptyAndCommentAndStringReceiverTester_init_args';
}

function initEmptyAndCommentAndStringReceiverTester_init_args(src: EmptyAndCommentAndStringReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyAndCommentAndStringReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyAndCommentAndStringReceiverTester_init_args({ $$type: 'EmptyAndCommentAndStringReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyAndCommentAndStringReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndCommentAndStringReceiverTester_types: ABIType[] = [
...
const EmptyAndCommentAndStringReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndCommentAndStringReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndCommentAndStringReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndCommentAndStringReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyAndCommentAndStringReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyAndCommentAndStringReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyAndCommentAndStringReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyAndCommentAndStringReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyAndCommentAndStringReceiverTester_types,
        getters: EmptyAndCommentAndStringReceiverTester_getters,
        receivers: EmptyAndCommentAndStringReceiverTester_receivers,
        errors: EmptyAndCommentAndStringReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message" | string) {
    ...
    async sendExternal(provider: ContractProvider, message: null | 'message' | string) {
