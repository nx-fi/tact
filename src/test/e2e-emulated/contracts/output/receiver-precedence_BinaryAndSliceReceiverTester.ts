...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type BinaryAndSliceReceiverTester_init_args = {
    $$type: 'BinaryAndSliceReceiverTester_init_args';
}

function initBinaryAndSliceReceiverTester_init_args(src: BinaryAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const BinaryAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const BinaryAndSliceReceiverTester_types: ABIType[] = [
...
const BinaryAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const BinaryAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const BinaryAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class BinaryAndSliceReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Message | Slice | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | Message | Slice) {
