...
type Child1_init_args = {
    $$type: "Child1_init_args";
};

function initChild1_init_args(src: Child1_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child1_errors: { [key: number]: { message: string } } = {
...
const Child1_getters: ABIGetter[] = [];

export const Child1_getterMapping: { [key: string]: string } = {};

const Child1_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child1 implements Contract {
    static async init() {
