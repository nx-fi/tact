...
function dictValueParserMathTester$Data(): DictionaryValue<MathTester$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeMathTester$Data(src)).endCell());
        },
        parse: (src) => {
...
export class MathTester implements Contract {
    ...
    async getAdd(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        const source = (await provider.get(83863 as any, builder.build())).stack;
    ...
    async getSub(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(80400 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getMul(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(99260 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDiv(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(125000 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getMod(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(126476 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getShr(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(89358 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getShl(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(110321 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getAnd(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(108636 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getOr(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(83393 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getXor(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(78952 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseNot(provider: ContractProvider, a: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(a);
        const source = (await provider.get(85436 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getAddAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(120881 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getSubAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(114791 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getMulAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(129050 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDivAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(85125 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getModAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(81709 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseOrAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(116497 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseAndAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(89159 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseXorAug(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(104526 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getCompare1(provider: ContractProvider, a: bigint, b: bigint | null) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(80704 as any, builder.build())).stack;
    ...
    async getCompare2(provider: ContractProvider, a: bigint, b: bigint | null) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(68387 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare3(provider: ContractProvider, a: bigint | null, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(72450 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare4(provider: ContractProvider, a: bigint | null, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(93157 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare5(provider: ContractProvider, a: bigint | null, b: bigint | null) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(97220 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare6(provider: ContractProvider, a: bigint | null, b: bigint | null) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(84903 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare7(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(88966 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare8(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(109161 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare9(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(113224 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare10(provider: ContractProvider, a: bigint, b: bigint) {
        ...
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(127339 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare11(provider: ContractProvider, a: Address, b: Address) {
        ...
        const source = (await provider.get(123210 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare12(provider: ContractProvider, a: Address, b: Address | null) {
        ...
        builder.writeAddress(a);
        builder.writeAddress(b);
        const source = (await provider.get(119081 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare13(provider: ContractProvider, a: Address | null, b: Address) {
        ...
        builder.writeAddress(a);
        builder.writeAddress(b);
        const source = (await provider.get(114952 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare14(provider: ContractProvider, a: Address | null, b: Address | null) {
        ...
        builder.writeAddress(a);
        builder.writeAddress(b);
        const source = (await provider.get(111087 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare15(provider: ContractProvider, a: Address, b: Address) {
        ...
        builder.writeAddress(a);
        builder.writeAddress(b);
        const source = (await provider.get(106958 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare16(provider: ContractProvider, a: Address, b: Address | null) {
        ...
        builder.writeAddress(a);
        builder.writeAddress(b);
        const source = (await provider.get(102829 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare17(provider: ContractProvider, a: Address | null, b: Address) {
        ...
        builder.writeAddress(a);
        builder.writeAddress(b);
        const source = (await provider.get(98700 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare18(provider: ContractProvider, a: Address | null, b: Address | null) {
        ...
        builder.writeAddress(a);
        builder.writeAddress(b);
        const source = (await provider.get(94307 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare19(provider: ContractProvider, a: Cell, b: Cell) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(90178 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare20(provider: ContractProvider, a: Cell, b: Cell | null) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(107576 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare21(provider: ContractProvider, a: Cell | null, b: Cell) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(111641 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare22(provider: ContractProvider, a: Cell | null, b: Cell | null) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(99450 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare23(provider: ContractProvider, a: Cell, b: Cell) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(103515 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare24(provider: ContractProvider, a: Cell, b: Cell | null) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(124092 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare25(provider: ContractProvider, a: Cell | null, b: Cell) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(128157 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare26(provider: ContractProvider, a: Cell | null, b: Cell | null) {
        ...
        builder.writeCell(a);
        builder.writeCell(b);
        const source = (await provider.get(115966 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare27(provider: ContractProvider, a: Dictionary<bigint, bigint>, b: Dictionary<bigint, bigint>) {
        ...
        const source = (await provider.get(120031 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare28(provider: ContractProvider, a: Dictionary<bigint, bigint>, b: Dictionary<bigint, bigint>) {
        ...
        builder.writeCell(a.size > 0 ? beginCell().storeDictDirect(a, Dictionary.Keys.BigInt(257), Dictionary.Values.BigInt(257)).endCell() : null);
        builder.writeCell(b.size > 0 ? beginCell().storeDictDirect(b, Dictionary.Keys.BigInt(257), Dictionary.Values.BigInt(257)).endCell() : null);
        const source = (await provider.get(75056 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare29(provider: ContractProvider, a: Slice, b: Slice) {
        ...
        const source = (await provider.get(79121 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare30(provider: ContractProvider, a: Slice, b: Slice | null) {
        ...
        builder.writeSlice(a.asCell());
        builder.writeSlice(b?.asCell());
        const source = (await provider.get(104201 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare31(provider: ContractProvider, a: Slice | null, b: Slice) {
        ...
        builder.writeSlice(a?.asCell());
        builder.writeSlice(b.asCell());
        const source = (await provider.get(100136 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    
    async getCompare32(provider: ContractProvider, a: Slice | null, b: Slice | null) {
        const builder = new TupleBuilder();
        builder.writeSlice(a?.asCell());
        builder.writeSlice(b?.asCell());
        const source = (await provider.get(112459 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare33(provider: ContractProvider, a: Slice, b: Slice) {
        ...
        builder.writeSlice(a.asCell());
        builder.writeSlice(b.asCell());
        const source = (await provider.get(108394 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare34(provider: ContractProvider, a: Slice, b: Slice | null) {
        ...
        builder.writeSlice(a.asCell());
        builder.writeSlice(b?.asCell());
        const source = (await provider.get(120717 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare35(provider: ContractProvider, a: Slice | null, b: Slice) {
        ...
        builder.writeSlice(a?.asCell());
        builder.writeSlice(b.asCell());
        const source = (await provider.get(116652 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    
    async getCompare36(provider: ContractProvider, a: Slice | null, b: Slice | null) {
        const builder = new TupleBuilder();
        builder.writeSlice(a?.asCell());
        builder.writeSlice(b?.asCell());
        const source = (await provider.get(128975 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare37(provider: ContractProvider, a: string, b: string) {
        ...
        const source = (await provider.get(124910 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare38(provider: ContractProvider, a: string, b: string | null) {
        ...
        builder.writeString(a);
        builder.writeString(b);
        const source = (await provider.get(71169 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare39(provider: ContractProvider, a: string | null, b: string) {
        ...
        builder.writeString(a);
        builder.writeString(b);
        const source = (await provider.get(67104 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare40(provider: ContractProvider, a: string | null, b: string | null) {
        ...
        builder.writeString(a);
        builder.writeString(b);
        const source = (await provider.get(69278 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare41(provider: ContractProvider, a: string, b: string) {
        ...
        builder.writeString(a);
        builder.writeString(b);
        const source = (await provider.get(73407 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare42(provider: ContractProvider, a: string, b: string | null) {
        ...
        builder.writeString(a);
        builder.writeString(b);
        const source = (await provider.get(77532 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare43(provider: ContractProvider, a: string | null, b: string) {
        ...
        builder.writeString(a);
        builder.writeString(b);
        const source = (await provider.get(81661 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getCompare44(provider: ContractProvider, a: string | null, b: string | null) {
        ...
        builder.writeString(a);
        builder.writeString(b);
        const source = (await provider.get(85530 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNull1(provider: ContractProvider, a: bigint | null) {
        const builder = new TupleBuilder();
        builder.writeNumber(a);
        const source = (await provider.get(111973 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNull1(provider: ContractProvider, a: bigint | null) {
        const builder = new TupleBuilder();
        builder.writeNumber(a);
        const source = (await provider.get(89158 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNull2(provider: ContractProvider, address: Address | null) {
        ...
        const source = (await provider.get(99590 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNull2(provider: ContractProvider, address: Address | null) {
        const builder = new TupleBuilder();
        builder.writeAddress(address);
        const source = (await provider.get(93221 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNull3(provider: ContractProvider, cell: Cell | null) {
        ...
        const source = (await provider.get(103719 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getIsNotNull3(provider: ContractProvider, cell: Cell | null) {
        const builder = new TupleBuilder();
        builder.writeCell(cell);
        const source = (await provider.get(97284 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getLog2(provider: ContractProvider, num: bigint) {
        ...
        const source = (await provider.get(75030 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getLog(provider: ContractProvider, num: bigint, base: bigint) {
        ...
        const source = (await provider.get(125279 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPow(provider: ContractProvider, base: bigint, exp: bigint) {
        ...
        const source = (await provider.get(118124 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPow2(provider: ContractProvider, exp: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(exp);
        const source = (await provider.get(94960 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(78380 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(66127 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(70254 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(90761 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence5(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(94888 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence6(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(82635 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence7(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(86762 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence8(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107269 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence9(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(111396 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence10(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(68674 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence11(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(72803 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getPrecedence12(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(76800 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseNot1(provider: ContractProvider, x: bigint) {
        ...
        const source = (await provider.get(118903 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseNot2(provider: ContractProvider, x: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        const source = (await provider.get(122900 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseNot3(provider: ContractProvider, x: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        const source = (await provider.get(127029 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBitwiseNot4(provider: ContractProvider, x: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        const source = (await provider.get(98514 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getAugmentedAnd(provider: ContractProvider, a: boolean, b: boolean) {
        ...
        const source = (await provider.get(127849 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getAugmentedOr(provider: ContractProvider, a: boolean, b: boolean) {
        ...
        builder.writeBoolean(a);
        builder.writeBoolean(b);
        const source = (await provider.get(121304 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    
    async getAugmentedShiftLeft(provider: ContractProvider, a: bigint, b: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(104823 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getAugmentedShiftRight(provider: ContractProvider, a: bigint, b: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(a);
        builder.writeNumber(b);
        const source = (await provider.get(110189 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getShiftLeft0(provider: ContractProvider, i: bigint) {
        ...
        const source = (await provider.get(106230 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getShiftRight0(provider: ContractProvider, i: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(i);
        const source = (await provider.get(78486 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getSign(provider: ContractProvider, x: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        const source = (await provider.get(115590 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDivc(provider: ContractProvider, x: bigint, y: bigint) {
        ...
        const source = (await provider.get(92387 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getMuldivc(provider: ContractProvider, x: bigint, y: bigint, z: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        builder.writeNumber(y);
        builder.writeNumber(z);
        const source = (await provider.get(107929 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getMulShiftRight(provider: ContractProvider, x: bigint, y: bigint, z: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        builder.writeNumber(y);
        builder.writeNumber(z);
        const source = (await provider.get(127246 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getMulShiftRightRound(provider: ContractProvider, x: bigint, y: bigint, z: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        builder.writeNumber(y);
        builder.writeNumber(z);
        const source = (await provider.get(121903 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getMulShiftRightCeil(provider: ContractProvider, x: bigint, y: bigint, z: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        builder.writeNumber(y);
        builder.writeNumber(z);
        const source = (await provider.get(93115 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getSqrt(provider: ContractProvider, x: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(x);
        const source = (await provider.get(91833 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
