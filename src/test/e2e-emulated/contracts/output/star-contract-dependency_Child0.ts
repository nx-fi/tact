...
type Child0_init_args = {
    $$type: "Child0_init_args";
};

function initChild0_init_args(src: Child0_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child0_errors: { [key: number]: { message: string } } = {
...
const Child0_getters: ABIGetter[] = [];

export const Child0_getterMapping: { [key: string]: string } = {};

const Child0_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child0 implements Contract {
    static async init() {
