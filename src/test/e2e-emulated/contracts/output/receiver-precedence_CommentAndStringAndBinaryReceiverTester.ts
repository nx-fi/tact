...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type CommentAndStringAndBinaryReceiverTester_init_args = {
    $$type: 'CommentAndStringAndBinaryReceiverTester_init_args';
}

function initCommentAndStringAndBinaryReceiverTester_init_args(src: CommentAndStringAndBinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const CommentAndStringAndBinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const CommentAndStringAndBinaryReceiverTester_types: ABIType[] = [
...
const CommentAndStringAndBinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const CommentAndStringAndBinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const CommentAndStringAndBinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class CommentAndStringAndBinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "message" | string | Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | 'message' | string | Message) {
