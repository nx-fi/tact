...
async function Child8_init() {
    const __code = Cell.fromBase64('te6ccgEBAQEAVgAAqP8AII5GMAHQctch0gDSAPpAIRA0UGZvBPhhAvhi7UTQ0gABlNMfATGSMHDiMAGRMOBwIddJIMIflTEB0x8wkTLiwAABwSGw3PLAguFtgBP0vPLICw==');
