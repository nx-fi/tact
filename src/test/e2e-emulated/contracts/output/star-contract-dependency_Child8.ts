...
type Child8_init_args = {
    $$type: "Child8_init_args";
};

function initChild8_init_args(src: Child8_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child8_errors: { [key: number]: { message: string } } = {
...
const Child8_getters: ABIGetter[] = [];

export const Child8_getterMapping: { [key: string]: string } = {};

const Child8_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child8 implements Contract {
    static async init() {
