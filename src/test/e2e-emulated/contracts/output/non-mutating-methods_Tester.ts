...
export function loadSomeStruct(slice: Slice) {
    ...
    return { $$type: 'SomeStruct' as const, i: _i, b: _b };
}
...
async function Tester_init() {
    const __code = Cell.fromBase64('');
...
const Tester_types: ABIType[] = [
    ...
    {"name":"SomeStruct","header":null,"fields":[{"name":"i","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"b","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"Tester$Data","header":null,"fields":[]},
]

const Tester_getters: ABIGetter[] = [
    {"name":"test1","methodId":70304,"arguments":[],"returnType":{"kind":"simple","type":"bool","optional":false}},
]
