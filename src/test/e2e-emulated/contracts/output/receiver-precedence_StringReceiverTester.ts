...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type StringReceiverTester_init_args = {
    $$type: 'StringReceiverTester_init_args';
}

function initStringReceiverTester_init_args(src: StringReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function StringReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initStringReceiverTester_init_args({ $$type: 'StringReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const StringReceiverTester_errors: { [key: number]: { message: string } } = {
...
const StringReceiverTester_types: ABIType[] = [
...
const StringReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const StringReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const StringReceiverTester_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text"}},
    {"receiver":"external","message":{"kind":"text"}},
]


export class StringReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await StringReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await StringReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new StringReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new StringReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  StringReceiverTester_types,
        getters: StringReceiverTester_getters,
        receivers: StringReceiverTester_receivers,
        errors: StringReceiverTester_errors,
    };
    ...
    async sendExternal(provider: ContractProvider, message: string) {
