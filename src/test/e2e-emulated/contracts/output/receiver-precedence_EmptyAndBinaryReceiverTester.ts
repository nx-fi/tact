...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndBinaryReceiverTester_init_args = {
    $$type: 'EmptyAndBinaryReceiverTester_init_args';
}

function initEmptyAndBinaryReceiverTester_init_args(src: EmptyAndBinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const EmptyAndBinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndBinaryReceiverTester_types: ABIType[] = [
...
const EmptyAndBinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndBinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndBinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndBinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | null | Message) {
