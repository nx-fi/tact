...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndCommentReceiverTester_init_args = {
    $$type: 'EmptyAndCommentReceiverTester_init_args';
}

function initEmptyAndCommentReceiverTester_init_args(src: EmptyAndCommentReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyAndCommentReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyAndCommentReceiverTester_init_args({ $$type: 'EmptyAndCommentReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyAndCommentReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndCommentReceiverTester_types: ABIType[] = [
...
const EmptyAndCommentReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndCommentReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndCommentReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndCommentReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyAndCommentReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyAndCommentReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyAndCommentReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyAndCommentReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyAndCommentReceiverTester_types,
        getters: EmptyAndCommentReceiverTester_getters,
        receivers: EmptyAndCommentReceiverTester_receivers,
        errors: EmptyAndCommentReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message") {
    ...
    async sendExternal(provider: ContractProvider, message: null | 'message') {
