...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type StringAndBinaryAndSliceReceiverTester_init_args = {
    $$type: 'StringAndBinaryAndSliceReceiverTester_init_args';
}

function initStringAndBinaryAndSliceReceiverTester_init_args(src: StringAndBinaryAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const StringAndBinaryAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const StringAndBinaryAndSliceReceiverTester_types: ABIType[] = [
...
const StringAndBinaryAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const StringAndBinaryAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const StringAndBinaryAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class StringAndBinaryAndSliceReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: string | Message | Slice | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | string | Message | Slice) {
