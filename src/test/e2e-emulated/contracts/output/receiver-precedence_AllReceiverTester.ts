...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type AllReceiverTester_init_args = {
    $$type: 'AllReceiverTester_init_args';
}

function initAllReceiverTester_init_args(src: AllReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const AllReceiverTester_errors: { [key: number]: { message: string } } = {
...
const AllReceiverTester_types: ABIType[] = [
...
const AllReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const AllReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const AllReceiverTester_receivers: ABIReceiver[] = [
...
export class AllReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message" | string | Message | Slice | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | null | 'message' | string | Message | Slice) {
