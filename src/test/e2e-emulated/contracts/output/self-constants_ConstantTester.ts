...
async function ConstantTester_init() {
    const __code = Cell.fromBase64(
        "",
    );
...
export class ConstantTester implements Contract {
    ...
    async getB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(85220 as any, builder.build()))
            .stack;
    ...
    async getC2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(84072 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getTraitB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(105663 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getTraitC2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(120853 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
