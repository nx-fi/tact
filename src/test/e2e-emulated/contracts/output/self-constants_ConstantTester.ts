...
export function loadConstantTester$Data(slice: Slice) {
    const sc_0 = slice;
    const _value = sc_0.loadIntBig(257);
    return { $$type: 'ConstantTester$Data' as const, value: _value };
}
...
async function ConstantTester_init() {
    const __code = Cell.fromBase64('');
...
const ConstantTester_types: ABIType[] = [
    ...
    {"name":"ConstantTester$Data","header":null,"fields":[{"name":"value","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
]

const ConstantTester_getters: ABIGetter[] = [
    {"name":"b","methodId":85220,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"c2","methodId":84072,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"value","methodId":121536,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"traitB","methodId":105663,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"traitC2","methodId":120853,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]
...
export class ConstantTester implements Contract {
    ...
    public static readonly A = 41n;
    public static readonly B = 42n;
    public static readonly A2 = 41n;
    public static readonly C2 = 51n;
    public static readonly B2 = 9n;
    public static readonly storageReserve = 0n;
    public static readonly TraitA = 41n;
    public static readonly TraitB = 42n;
    public static readonly TraitA2 = 41n;
    public static readonly TraitC2 = 51n;
    public static readonly TraitB2 = 9n;
    ...
    async getB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(85220 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getC2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(84072 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getTraitB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(105663 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getTraitC2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(120853 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
