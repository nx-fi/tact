...
export class Parent implements Contract {
    ...
    async getGetChild0(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115516 as any, builder.build()))
            .stack;
    ...
    async getGetChild1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(119581 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(123774 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(127839 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(99256 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild5(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(103321 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild6(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107514 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild7(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(111579 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild8(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(82484 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    ...
    async getGetChild9(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(86549 as any, builder.build()))
            .stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
