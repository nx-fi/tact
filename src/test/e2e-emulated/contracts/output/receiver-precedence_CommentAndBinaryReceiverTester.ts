...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type CommentAndBinaryReceiverTester_init_args = {
    $$type: 'CommentAndBinaryReceiverTester_init_args';
}

function initCommentAndBinaryReceiverTester_init_args(src: CommentAndBinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const CommentAndBinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const CommentAndBinaryReceiverTester_types: ABIType[] = [
...
const CommentAndBinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const CommentAndBinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const CommentAndBinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class CommentAndBinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "message" | Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | 'message' | Message) {
