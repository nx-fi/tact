...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndStringAndSliceReceiverTester_init_args = {
    $$type: 'EmptyAndStringAndSliceReceiverTester_init_args';
}

function initEmptyAndStringAndSliceReceiverTester_init_args(src: EmptyAndStringAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyAndStringAndSliceReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyAndStringAndSliceReceiverTester_init_args({ $$type: 'EmptyAndStringAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyAndStringAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndStringAndSliceReceiverTester_types: ABIType[] = [
...
const EmptyAndStringAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndStringAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndStringAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndStringAndSliceReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyAndStringAndSliceReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyAndStringAndSliceReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyAndStringAndSliceReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyAndStringAndSliceReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyAndStringAndSliceReceiverTester_types,
        getters: EmptyAndStringAndSliceReceiverTester_getters,
        receivers: EmptyAndStringAndSliceReceiverTester_receivers,
        errors: EmptyAndStringAndSliceReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | string | Slice) {
    ...
    async sendExternal(provider: ContractProvider, message: null | string | Slice) {
