...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndBinaryAndSliceReceiverTester_init_args = {
    $$type: 'EmptyAndBinaryAndSliceReceiverTester_init_args';
}

function initEmptyAndBinaryAndSliceReceiverTester_init_args(src: EmptyAndBinaryAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const EmptyAndBinaryAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndBinaryAndSliceReceiverTester_types: ABIType[] = [
...
const EmptyAndBinaryAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndBinaryAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndBinaryAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndBinaryAndSliceReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | Message | Slice | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | null | Message | Slice) {
