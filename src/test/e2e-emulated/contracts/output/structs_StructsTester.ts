...
function dictValueParserVarIntegers(): DictionaryValue<VarIntegers> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeVarIntegers(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserLongStruct15(): DictionaryValue<LongStruct15> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeLongStruct15(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserLongStruct16(): DictionaryValue<LongStruct16> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeLongStruct16(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserLongStruct32(): DictionaryValue<LongStruct32> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeLongStruct32(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadLongNestedStruct(slice: Slice) {
    ...
    return {
        $$type: "LongNestedStruct" as const,
        x1: _x1,
        x2: _x2,
        x3: _x3,
        x4: _x4,
...
function dictValueParserLongNestedStruct(): DictionaryValue<LongNestedStruct> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeLongNestedStruct(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadLongNestedStructWithOpts(slice: Slice) {
    ...
    return {
        $$type: "LongNestedStructWithOpts" as const,
        x1: _x1,
        x2: _x2,
        x3: _x3,
        x4: _x4,
...
function dictValueParserLongNestedStructWithOpts(): DictionaryValue<LongNestedStructWithOpts> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeLongNestedStructWithOpts(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserDoubleNestedStructOpt(): DictionaryValue<DoubleNestedStructOpt> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeDoubleNestedStructOpt(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserTripleNestedStructOpt(): DictionaryValue<TripleNestedStructOpt> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeTripleNestedStructOpt(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadLongAndDeepNestedStruct(slice: Slice) {
    ...
    return {
        $$type: "LongAndDeepNestedStruct" as const,
        x1: _x1,
        x2: _x2,
        x3: _x3,
        x4: _x4,
...
function dictValueParserLongAndDeepNestedStruct(): DictionaryValue<LongAndDeepNestedStruct> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeLongAndDeepNestedStruct(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserOptionalFields(): DictionaryValue<OptionalFields> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeOptionalFields(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function storeStructsTester$Data(src: StructsTester$Data) {
    return (builder: Builder) => {
        ...
        b_2.storeDict(
            src.mapWithLongStructs15,
            Dictionary.Keys.BigInt(257),
            dictValueParserLongStruct15(),
        );
        b_2.storeDict(
            src.mapWithLongStructs16,
            Dictionary.Keys.BigInt(257),
            dictValueParserLongStruct16(),
        );
        b_2.storeDict(
            src.mapWithLongStructs32,
            Dictionary.Keys.BigInt(257),
            dictValueParserLongStruct32(),
        );
...
export function loadStructsTester$Data(slice: Slice) {
    ...
    const _mapWithLongStructs15 = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        dictValueParserLongStruct15(),
        sc_2,
    );
    const _mapWithLongStructs16 = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        dictValueParserLongStruct16(),
        sc_2,
    );
    const _mapWithLongStructs32 = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        dictValueParserLongStruct32(),
        sc_2,
    );
    ...
    return {
        $$type: "StructsTester$Data" as const,
        s1: _s1,
        s2: _s2,
        t1: _t1,
        t2: _t2,
        mapWithLongStructs15: _mapWithLongStructs15,
        mapWithLongStructs16: _mapWithLongStructs16,
        mapWithLongStructs32: _mapWithLongStructs32,
        x1: _x1,
        x2: _x2,
        x3: _x3,
        x4: _x4,
...
function loadTupleStructsTester$Data(source: TupleReader) {
    ...
    const _mapWithLongStructs15 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        dictValueParserLongStruct15(),
        source.readCellOpt(),
    );
    const _mapWithLongStructs16 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        dictValueParserLongStruct16(),
        source.readCellOpt(),
    );
    const _mapWithLongStructs32 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        dictValueParserLongStruct32(),
        source.readCellOpt(),
    );
...
function storeTupleStructsTester$Data(source: StructsTester$Data) {
    ...
    builder.writeCell(
        source.mapWithLongStructs15.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.mapWithLongStructs15,
                      Dictionary.Keys.BigInt(257),
                      dictValueParserLongStruct15(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.mapWithLongStructs16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.mapWithLongStructs16,
                      Dictionary.Keys.BigInt(257),
                      dictValueParserLongStruct16(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.mapWithLongStructs32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.mapWithLongStructs32,
                      Dictionary.Keys.BigInt(257),
                      dictValueParserLongStruct32(),
                  )
                  .endCell()
...
function dictValueParserStructsTester$Data(): DictionaryValue<StructsTester$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeStructsTester$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
const StructsTester_types: ABIType[] = [
    ...
    },
    {
        ...
        fields: [
            ...
            {
                name: "s",
                type: { kind: "simple", type: "MyStruct1", optional: true },
            },
        ],
    },
    {
    ...
    },
    {
        ...
        fields: [
            ...
            {
                name: "s",
                type: { kind: "simple", type: "MyStruct2", optional: false },
            },
        ],
    },
    {
    ...
    },
    {
        ...
        fields: [
            ...
            {
                name: "s1",
                type: { kind: "simple", type: "LongStruct15", optional: false },
            },
            {
                name: "s2",
                type: { kind: "simple", type: "LongStruct16", optional: false },
            },
            {
                name: "s3",
                type: { kind: "simple", type: "LongStruct32", optional: false },
            },
        ],
    },
    {
        name: "LongNestedStructWithOpts",
        header: null,
        fields: [
            {
                name: "x1",
            ...
            {
                name: "s1",
                type: { kind: "simple", type: "LongStruct15", optional: true },
            },
            {
                name: "s2",
                type: { kind: "simple", type: "LongStruct16", optional: false },
            ...
            {
                name: "s3",
                type: { kind: "simple", type: "LongStruct32", optional: true },
            },
        ],
    },
    {
    ...
    },
    {
        ...
        fields: [
            {
                name: "start",
                type: { kind: "simple", type: "Point", optional: false },
            },
            {
                name: "end",
                type: { kind: "simple", type: "Point", optional: false },
    ...
    },
    {
        ...
        fields: [
            ...
            {
                name: "line1",
                type: { kind: "simple", type: "Line", optional: false },
            },
            {
                name: "line2",
                type: { kind: "simple", type: "Line", optional: true },
            },
        ],
    },
    {
        name: "DoubleNestedStructOpt",
        header: null,
        fields: [
            {
                name: "a",
    ...
    {
        name: "StructsTester$Data",
        header: null,
        fields: [
            {
                name: "s1",
                type: { kind: "simple", type: "S", optional: false },
            },
            {
                name: "s2",
                type: { kind: "simple", type: "S", optional: false },
            ...
            {
                name: "t1",
                type: { kind: "simple", type: "T", optional: false },
            },
            {
                name: "t2",
                type: { kind: "simple", type: "T", optional: false },
...
const StructsTester_getters: ABIGetter[] = [
    ...
    },
    {
        ...
        arguments: [
            {
                name: "s",
                type: { kind: "simple", type: "MyStruct1", optional: false },
            },
        ],
    ...
    },
    {
        ...
        returnType: { kind: "simple", type: "MyStruct1", optional: false },
    },
    {
        name: "fromSlice1",
        methodId: 118478,
    ...
    },
    {
        ...
        returnType: { kind: "simple", type: "MyStruct2", optional: false },
    },
    {
        name: "fromSlice2",
        methodId: 130733,
    ...
    },
    {
        ...
        arguments: [
            {
                name: "m",
                type: { kind: "simple", type: "MyMessage1", optional: false },
            },
        ],
        returnType: { kind: "simple", type: "cell", optional: false },
    },
    {
        name: "fromCellMessage1",
        methodId: 65739,
        arguments: [
            {
                name: "src",
        ...
        returnType: { kind: "simple", type: "MyMessage1", optional: false },
    },
    {
        name: "fromSliceMessage1",
        methodId: 100880,
        arguments: [
            {
                name: "src",
    ...
    {
        name: "contractStructConstantImmediate",
        methodId: 131046,
        arguments: [],
        returnType: { kind: "simple", type: "MyStruct3", optional: false },
    },
    {
        name: "globalConstStructConstantImmediate",
        methodId: 96485,
        arguments: [],
        returnType: { kind: "simple", type: "MyStruct3", optional: false },
    },
    {
        name: "contractStructConstantFieldImmediate",
        methodId: 115253,
        arguments: [],
        returnType: { kind: "simple", type: "string", optional: false },
    },
    {
        name: "globalConstStructConstantFieldImmediate",
        methodId: 72941,
        arguments: [],
        returnType: { kind: "simple", type: "string", optional: false },
    },
    {
        name: "contractStructConstantViaVar",
        methodId: 103564,
        arguments: [],
        returnType: { kind: "simple", type: "MyStruct3", optional: false },
    },
    {
        name: "globalConstStructConstantViaVar",
        methodId: 105147,
        arguments: [],
        returnType: { kind: "simple", type: "MyStruct3", optional: false },
    },
    {
        name: "contractStructConstantFieldViaVar",
        methodId: 97692,
        arguments: [],
        returnType: { kind: "simple", type: "string", optional: false },
    },
    {
        name: "globalConstStructConstantFieldViaVar",
        methodId: 118768,
        arguments: [],
        returnType: { kind: "simple", type: "string", optional: false },
    },
    {
        name: "longStruct15Test",
        methodId: 92569,
        arguments: [],
        returnType: { kind: "simple", type: "LongStruct15", optional: false },
    },
    {
        name: "longStruct16Test",
        methodId: 100171,
        arguments: [],
        returnType: { kind: "simple", type: "LongStruct16", optional: false },
    },
    {
        name: "longStruct32Test",
        methodId: 99597,
        arguments: [],
        returnType: { kind: "simple", type: "LongStruct32", optional: false },
    },
    {
        name: "longNestedStructTest",
        methodId: 101744,
        arguments: [],
        returnType: {
            kind: "simple",
    ...
    {
        name: "longNestedStructWithOptsTest",
        methodId: 103572,
        arguments: [],
        returnType: {
            kind: "simple",
    ...
    },
    {
        ...
        methodId: 126791,
        arguments: [],
        returnType: { kind: "simple", type: "Location", optional: false },
    },
    {
        name: "location2",
        methodId: 122660,
    ...
    {
        name: "intFieldsStruct",
        methodId: 98928,
        arguments: [],
        returnType: { kind: "simple", type: "IntFields", optional: false },
    },
    {
        name: "intFieldsFromCell",
        methodId: 75138,
        arguments: [
            {
                name: "src",
    ...
    {
        name: "uintFieldsMessage",
        methodId: 72699,
        arguments: [],
        returnType: { kind: "simple", type: "UintFields", optional: false },
    },
    {
        name: "uintFieldsFromCell",
        methodId: 121259,
        arguments: [
            {
                name: "src",
    ...
    },
    {
        ...
        methodId: 79909,
        arguments: [],
        returnType: { kind: "simple", type: "OptionalFields", optional: false },
    },
    {
        name: "destructuringTest1",
        methodId: 121307,
        arguments: [],
        returnType: {
            kind: "simple",
    ...
    {
        name: "destructuringTest7",
        methodId: 112925,
        arguments: [],
        returnType: { kind: "simple", type: "S1", optional: false },
    },
    {
        name: "destructuringTest7Const",
        methodId: 79254,
        arguments: [],
        returnType: { kind: "simple", type: "S1", optional: false },
    },
    {
        name: "destructuringTest8",
        methodId: 84210,
        arguments: [],
        returnType: {
            kind: "simple",
...
export const StructsTester_getterMapping: { [key: string]: string } = {
    ...
    contractStructConstantFieldImmediate:
        "getContractStructConstantFieldImmediate",
    globalConstStructConstantFieldImmediate:
        "getGlobalConstStructConstantFieldImmediate",
    ...
    globalConstStructConstantFieldViaVar:
        "getGlobalConstStructConstantFieldViaVar",
...
const StructsTester_receivers: ABIReceiver[] = [
    ...
    {
        receiver: "internal",
        message: { kind: "text", text: "exampleVarIntegers" },
    },
];
...
export class StructsTester implements Contract {
    ...
    async send(
        ...
        message: null | Foo | "example" | "exampleVarIntegers",
    ) {
    ...
    async getStructInitializerTest(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(69602 as any, builder.build()))
            .stack;
    ...
    async getToCell1(provider: ContractProvider, s: MyStruct1) {
        ...
        const source = (await provider.get(82862 as any, builder.build()))
            .stack;
    ...
    async getToSlice1(provider: ContractProvider, s: MyStruct1) {
        const builder = new TupleBuilder();
        builder.writeTuple(storeTupleMyStruct1(s));
        const source = (await provider.get(69666 as any, builder.build()))
            .stack;
    ...
    async getFromCell1(provider: ContractProvider, src: Cell) {
        ...
        const source = (await provider.get(76221 as any, builder.build()))
            .stack;
    ...
    async getFromSlice1(provider: ContractProvider, src: Slice) {
        ...
        const source = (await provider.get(118478 as any, builder.build()))
            .stack;
        const result = loadGetterTupleMyStruct1(source);
        return result;
    }
    ...
    async getToCell2(provider: ContractProvider, s: MyStruct2) {
        ...
        const source = (await provider.get(95181 as any, builder.build()))
            .stack;
        const result = source.readCell();
        return result;
    }
    ...
    async getFromCell2(provider: ContractProvider, src: Cell) {
        const builder = new TupleBuilder();
        builder.writeCell(src);
        const source = (await provider.get(72158 as any, builder.build()))
            .stack;
    ...
    async getFromSlice2(provider: ContractProvider, src: Slice) {
        const builder = new TupleBuilder();
        builder.writeSlice(src.asCell());
        const source = (await provider.get(130733 as any, builder.build()))
            .stack;
        const result = loadGetterTupleMyStruct2(source);
        return result;
    }
    ...
    async getTest1(provider: ContractProvider, s1: MyStruct1, s2: MyStruct2) {
        ...
        const source = (await provider.get(70304 as any, builder.build()))
            .stack;
        const result = source.readCell();
        return result;
    }
    ...
    async getToCellMessage1(provider: ContractProvider, m: MyMessage1) {
        ...
        const source = (await provider.get(103675 as any, builder.build()))
            .stack;
        const result = source.readCell();
        return result;
    }
    ...
    async getFromCellMessage1(provider: ContractProvider, src: Cell) {
        const builder = new TupleBuilder();
        builder.writeCell(src);
        const source = (await provider.get(65739 as any, builder.build()))
            .stack;
    ...
    async getFromSliceMessage1(provider: ContractProvider, src: Slice) {
        const builder = new TupleBuilder();
        builder.writeSlice(src.asCell());
        const source = (await provider.get(100880 as any, builder.build()))
            .stack;
        const result = loadGetterTupleMyMessage1(source);
        return result;
    }
    ...
    async getContractStructConstantImmediate(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(131046 as any, builder.build()))
            .stack;
    ...
    async getGlobalConstStructConstantImmediate(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(96485 as any, builder.build()))
            .stack;
        const result = loadGetterTupleMyStruct3(source);
        return result;
    }
    ...
    async getContractStructConstantFieldImmediate(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115253 as any, builder.build()))
            .stack;
        const result = source.readString();
        return result;
    }

    async getGlobalConstStructConstantFieldImmediate(
        provider: ContractProvider,
    ) {
        const builder = new TupleBuilder();
        const source = (await provider.get(72941 as any, builder.build()))
            .stack;
        const result = source.readString();
        return result;
    }
    ...
    async getContractStructConstantViaVar(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(103564 as any, builder.build()))
            .stack;
        const result = loadGetterTupleMyStruct3(source);
        return result;
    }
    ...
    async getGlobalConstStructConstantViaVar(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(105147 as any, builder.build()))
            .stack;
        const result = loadGetterTupleMyStruct3(source);
        return result;
    }
    ...
    async getContractStructConstantFieldViaVar(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(97692 as any, builder.build()))
            .stack;
        const result = source.readString();
        return result;
    }
    ...
    async getGlobalConstStructConstantFieldViaVar(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(118768 as any, builder.build()))
            .stack;
        const result = source.readString();
        return result;
    }
    ...
    async getLongStruct15Test(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(92569 as any, builder.build()))
            .stack;
    ...
    async getLongStruct16Test(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(100171 as any, builder.build()))
            .stack;
    ...
    async getLongStruct32Test(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(99597 as any, builder.build()))
            .stack;
    ...
    async getLongNestedStructTest(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(101744 as any, builder.build()))
            .stack;
    ...
    async getLongNestedStructWithOptsTest(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(103572 as any, builder.build()))
            .stack;
    ...
    async getLongContractTest(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(81181 as any, builder.build()))
            .stack;
    ...
    async getLocation1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(126791 as any, builder.build()))
            .stack;
    ...
    async getLocation2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(122660 as any, builder.build()))
            .stack;
        const result = loadGetterTupleLocation(source);
        return result;
    }
    ...
    async getTripleNestedStructOpt1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(102164 as any, builder.build()))
            .stack;
    ...
    async getTripleNestedStructOpt2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(114551 as any, builder.build()))
            .stack;
        const result = loadGetterTupleTripleNestedStructOpt(source);
        return result;
    }
    ...
    async getTripleNestedStructOpt3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(110422 as any, builder.build()))
            .stack;
        const result = loadGetterTupleTripleNestedStructOpt(source);
        return result;
    }
    ...
    async getLongAndDeepNestedStruct1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(87259 as any, builder.build()))
            .stack;
    ...
    async getLongAndDeepNestedStruct2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(91320 as any, builder.build()))
            .stack;
        const result = loadGetterTupleLongAndDeepNestedStruct(source);
        return result;
    }
    ...
    async getLongAndDeepNestedStruct3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(95385 as any, builder.build()))
            .stack;
        const result = loadGetterTupleLongAndDeepNestedStruct(source);
        return result;
    }
    ...
    async getIntFieldsStruct(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(98928 as any, builder.build()))
            .stack;
    ...
    async getIntFieldsFromCell(provider: ContractProvider, src: Cell) {
        const builder = new TupleBuilder();
        builder.writeCell(src);
        const source = (await provider.get(75138 as any, builder.build()))
            .stack;
        const result = loadGetterTupleIntFields(source);
        return result;
    }
    ...
    async getUintFieldsMessage(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(72699 as any, builder.build()))
            .stack;
    ...
    async getUintFieldsFromCell(provider: ContractProvider, src: Cell) {
        const builder = new TupleBuilder();
        builder.writeCell(src);
        const source = (await provider.get(121259 as any, builder.build()))
            .stack;
        const result = loadGetterTupleUintFields(source);
        return result;
    }
    ...
    async getOptionalFields(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(79909 as any, builder.build()))
            .stack;
    ...
    async getDestructuringTest1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(121307 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest1Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(112759 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(125368 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest2Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(95895 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(129433 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest3Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(78647 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(100734 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest4Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(129910 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest5(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(104799 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest5Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(114390 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest6(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(108860 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest6Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(94262 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest7(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(112925 as any, builder.build()))
            .stack;
    ...
    async getDestructuringTest7Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(79254 as any, builder.build()))
            .stack;
        const result = loadGetterTupleS1(source);
        return result;
    }
    ...
    async getDestructuringTest8(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(84210 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDestructuringTest8Const(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(127125 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
