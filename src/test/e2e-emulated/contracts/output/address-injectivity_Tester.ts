...
function dictValueParserTester$Data(): DictionaryValue<Tester$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeTester$Data(src)).endCell());
        },
        parse: (src) => {
 ...
 type Tester_init_args = {
    $$type: 'Tester_init_args';
}

function initTester_init_args(src: Tester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
async function Tester_init() {
    const __code = Cell.fromBase64('');
...
const Tester_errors: { [key: number]: { message: string } } = {
...
const Tester_getters: ABIGetter[] = [
    {"name":"checkAddressInjectivity","methodId":105691,"arguments":[],"returnType":{"kind":"simple","type":"bool","optional":false}},
]

export const Tester_getterMapping: { [key: string]: string } = {
    'checkAddressInjectivity': 'getCheckAddressInjectivity',
}

const Tester_receivers: ABIReceiver[] = [
...
export class Tester implements Contract {
    ...
    async getCheckAddressInjectivity(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(105691 as any, builder.build())).stack;
