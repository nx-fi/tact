...
export function storeLocalTypeInferenceTester$Data(
    src: LocalTypeInferenceTester$Data,
) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
...
function storeTupleLocalTypeInferenceTester$Data(
    source: LocalTypeInferenceTester$Data,
) {
    const builder = new TupleBuilder();
    return builder.build();
}
...
function dictValueParserLocalTypeInferenceTester$Data(): DictionaryValue<LocalTypeInferenceTester$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell()
                    .store(storeLocalTypeInferenceTester$Data(src))
                    .endCell(),
            );
        },
        parse: (src) => {
            return loadLocalTypeInferenceTester$Data(
...
function initLocalTypeInferenceTester_init_args(
    src: LocalTypeInferenceTester_init_args,
) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
...
const LocalTypeInferenceTester_getters: ABIGetter[] = [
    ...
    },
    {
        ...
        methodId: 124068,
        arguments: [],
        returnType: { kind: "simple", type: "MyStruct", optional: false },
    },
    {
        name: "test15",
        methodId: 128133,
...
export class LocalTypeInferenceTester implements Contract {
    ...
    async getTest13(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(103491 as any, builder.build()))
            .stack;
        const result = Dictionary.loadDirect(
            Dictionary.Keys.BigInt(257),
    ...
    async getTest14(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(124068 as any, builder.build()))
            .stack;
    ...
    async getTest15(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(128133 as any, builder.build()))
            .stack;
        const result = loadGetterTupleMyStruct(source);
        return result;
    }
    ...
    async getTest16(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115942 as any, builder.build()))
            .stack;
    ...
    async getTest17(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(120007 as any, builder.build()))
            .stack;
        const result = source.readBigNumberOpt();
        return result;
    }
    ...
    async getTest18(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(75048 as any, builder.build()))
            .stack;
        const result = source.readBigNumberOpt();
        return result;
    }
    ...
    async getTest19(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(79113 as any, builder.build()))
            .stack;
        const result = source.readBigNumberOpt();
        return result;
    }
