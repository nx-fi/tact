...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyBouncedTester_init_args = {
    $$type: 'EmptyBouncedTester_init_args';
}

function initEmptyBouncedTester_init_args(src: EmptyBouncedTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyBouncedTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyBouncedTester_init_args({ $$type: 'EmptyBouncedTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyBouncedTester_errors: { [key: number]: { message: string } } = {
...
const EmptyBouncedTester_types: ABIType[] = [
...
const EmptyBouncedTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyBouncedTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyBouncedTester_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SendCellToAddress"}},
    {"receiver":"internal","message":{"kind":"text","text":"reset"}},
]


export class EmptyBouncedTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyBouncedTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyBouncedTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyBouncedTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyBouncedTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyBouncedTester_types,
        getters: EmptyBouncedTester_getters,
        receivers: EmptyBouncedTester_receivers,
        errors: EmptyBouncedTester_errors,
    };
