...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type BinaryReceiverTester_init_args = {
    $$type: 'BinaryReceiverTester_init_args';
}

function initBinaryReceiverTester_init_args(src: BinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const BinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const BinaryReceiverTester_types: ABIType[] = [
...
const BinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const BinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const BinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class BinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | Message) {
