...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type StringAndSliceReceiverTester_init_args = {
    $$type: 'StringAndSliceReceiverTester_init_args';
}

function initStringAndSliceReceiverTester_init_args(src: StringAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const StringAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const StringAndSliceReceiverTester_types: ABIType[] = [
...
const StringAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const StringAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const StringAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class StringAndSliceReceiverTester implements Contract {
    ...
    async sendExternal(provider: ContractProvider, message: string | Slice) {
