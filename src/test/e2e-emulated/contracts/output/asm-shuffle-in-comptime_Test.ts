...
async function Test_init() {
    const __code = Cell.fromBase64('te6ccgEBBgEAlAABFP8A9KQT9LzyyAsBAgFiAgMBhtAB0HLXIdIA0gD6QCEQNFBmbwT4YQL4Yts8ApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbCZMMh/AcoAye1U4DDywIIEAhGhXy22eAO2eGMEBQAU7UTQ0gAwkW3gbQBCi1aGVsbG+CFfAm2LVoZWxsb4Il8CbpMgw2SRcOKSpgrg');
...
const Test_getters: ABIGetter[] = [
    {"name":"foo","methodId":110486,"arguments":[{"name":"a","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]
...
export class Test implements Contract {
    ...
    async getFoo(provider: ContractProvider, a: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(a);
        const source = (await provider.get(110486 as any, builder.build())).stack;
