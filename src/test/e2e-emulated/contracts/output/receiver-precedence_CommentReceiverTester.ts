...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type CommentReceiverTester_init_args = {
    $$type: 'CommentReceiverTester_init_args';
}

function initCommentReceiverTester_init_args(src: CommentReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function CommentReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initCommentReceiverTester_init_args({ $$type: 'CommentReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const CommentReceiverTester_errors: { [key: number]: { message: string } } = {
...
const CommentReceiverTester_types: ABIType[] = [
...
const CommentReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const CommentReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const CommentReceiverTester_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text","text":"message"}},
    {"receiver":"external","message":{"kind":"text","text":"message"}},
]


export class CommentReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await CommentReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await CommentReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new CommentReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new CommentReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  CommentReceiverTester_types,
        getters: CommentReceiverTester_getters,
        receivers: CommentReceiverTester_receivers,
        errors: CommentReceiverTester_errors,
    };
    ...
    async sendExternal(provider: ContractProvider, message: 'message') {
