...
type Child9_init_args = {
    $$type: "Child9_init_args";
};

function initChild9_init_args(src: Child9_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child9_errors: { [key: number]: { message: string } } = {
...
const Child9_getters: ABIGetter[] = [];

export const Child9_getterMapping: { [key: string]: string } = {};

const Child9_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child9 implements Contract {
    static async init() {
