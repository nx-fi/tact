...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type AllBouncedTester_init_args = {
    $$type: 'AllBouncedTester_init_args';
}

function initAllBouncedTester_init_args(src: AllBouncedTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function AllBouncedTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initAllBouncedTester_init_args({ $$type: 'AllBouncedTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const AllBouncedTester_errors: { [key: number]: { message: string } } = {
...
const AllBouncedTester_types: ABIType[] = [
...
const AllBouncedTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const AllBouncedTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const AllBouncedTester_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SendCellToAddress"}},
    {"receiver":"internal","message":{"kind":"text","text":"reset"}},
]


export class AllBouncedTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await AllBouncedTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await AllBouncedTester_init();
        const address = contractAddress(0, __gen_init);
        return new AllBouncedTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new AllBouncedTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  AllBouncedTester_types,
        getters: AllBouncedTester_getters,
        receivers: AllBouncedTester_receivers,
        errors: AllBouncedTester_errors,
    };
