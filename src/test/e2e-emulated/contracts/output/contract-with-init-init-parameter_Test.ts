...
async function Test_init(init: Init) {
    const __code = Cell.fromBase64(
        "te6ccgEBBgEAgwABFP8A9KQT9LzyyAsBAgFiAgMBktAB0HLXIdIA0gD6QCEQNFBmbwT4YQL4Yts8ApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbCfyH8BygABAYEBAc8Aye1U4DDywIIEAg+hDsW2ebZ4YwQFACjtRNDSAAGXgQEB1wABMeDTBwEB0QACIA==",
    );
...
export class Test implements Contract {
    ...
    async getData(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(100194 as any, builder.build()))
            .stack;
