...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type SliceReceiverTester_init_args = {
    $$type: 'SliceReceiverTester_init_args';
}

function initSliceReceiverTester_init_args(src: SliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const SliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const SliceReceiverTester_types: ABIType[] = [
...
const SliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const SliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const SliceReceiverTester_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"any"}},
    {"receiver":"external","message":{"kind":"any"}},
]


export class SliceReceiverTester implements Contract {
