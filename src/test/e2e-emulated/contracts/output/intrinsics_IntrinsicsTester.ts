...
export function loadIntrinsicsTester$Data(slice: Slice) {
    ...
    return { $$type: 'IntrinsicsTester$Data' as const, a: _a, b: _b, c: _c, d: _d, e: _e, f: _f, g: _g, h: _h, i: _i, j: _j, k: _k, l: _l, m: _m, n: _n, o: _o, p: _p, q: _q, r: _r, s: _s, t: _t, u: _u, w: _w, v: _v };
}
...
function dictValueParserIntrinsicsTester$Data(): DictionaryValue<IntrinsicsTester$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeIntrinsicsTester$Data(src)).endCell());
        },
        parse: (src) => {
...
async function IntrinsicsTester_init() {
    const __code = Cell.fromBase64('');
...
export class IntrinsicsTester implements Contract {
    ...
    async getGetTons(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(85126 as any, builder.build())).stack;
    ...
    async getGetTons2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(72025 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetString(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(97624 as any, builder.build())).stack;
    ...
    async getGetString2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(123179 as any, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    ...
    async getGetAddress(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(67571 as any, builder.build())).stack;
    ...
    async getGetAddress2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(103926 as any, builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    ...
    async getGetCell(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(83057 as any, builder.build())).stack;
    ...
    async getGetCell2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(94033 as any, builder.build())).stack;
        const result = source.readCell();
        return result;
    }
    ...
    async getGetPow(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(93948 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetPow2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(92025 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetComment(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(116303 as any, builder.build())).stack;
        const result = source.readCell();
        return result;
    }
    ...
    async getGetHash(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(120167 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHashSlice(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(104138 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHash2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(125641 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHash3(provider: ContractProvider, src: Slice) {
        ...
        const source = (await provider.get(129768 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHash4(provider: ContractProvider, src: string) {
        ...
        const source = (await provider.get(100879 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHashLongComptime(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(121679 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHashLongRuntime(provider: ContractProvider, src: string) {
        const builder = new TupleBuilder();
        builder.writeString(src);
        const source = (await provider.get(113535 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHashLongRuntimeSlice(provider: ContractProvider, src: Slice) {
        const builder = new TupleBuilder();
        builder.writeSlice(src.asCell());
        const source = (await provider.get(122586 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHashSha256U(provider: ContractProvider, src: Slice) {
        const builder = new TupleBuilder();
        builder.writeSlice(src.asCell());
        const source = (await provider.get(68441 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetHashHashextsha256(provider: ContractProvider, src: Slice) {
        const builder = new TupleBuilder();
        builder.writeSlice(src.asCell());
        const source = (await provider.get(112782 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetSlice(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(84384 as any, builder.build())).stack;
    ...
    async getGetSlice2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(94204 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(78245 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(103779 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(99650 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(128421 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetAscii(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(77750 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetAscii2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(95644 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetAscii3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(91581 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetAscii4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(71002 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetCrc32(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(71531 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetCrc32_2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(85945 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetCrc32_3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(90008 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetCrc32_4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(77695 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetRawSlice5(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(124292 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice6(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(120295 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice7(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(116166 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice8(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(78889 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice9(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(74760 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice10(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(119580 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice11(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115517 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice12(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(127838 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice13(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(123775 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice14(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(103320 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice15(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(99257 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice16(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(111578 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice17(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107515 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice18(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(86548 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice19(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(82485 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice20(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(99919 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice21(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(104046 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice22(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(108045 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice23(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(112172 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    ...
    async getGetRawSlice24(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(116427 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
