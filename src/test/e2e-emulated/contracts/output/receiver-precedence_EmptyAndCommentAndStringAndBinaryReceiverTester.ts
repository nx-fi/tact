...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndCommentAndStringAndBinaryReceiverTester_init_args = {
    $$type: 'EmptyAndCommentAndStringAndBinaryReceiverTester_init_args';
}

function initEmptyAndCommentAndStringAndBinaryReceiverTester_init_args(src: EmptyAndCommentAndStringAndBinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const EmptyAndCommentAndStringAndBinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndCommentAndStringAndBinaryReceiverTester_types: ABIType[] = [
...
const EmptyAndCommentAndStringAndBinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndCommentAndStringAndBinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndCommentAndStringAndBinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndCommentAndStringAndBinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message" | string | Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | null | 'message' | string | Message) {
