...
type Child2_init_args = {
    $$type: "Child2_init_args";
};

function initChild2_init_args(src: Child2_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child2_errors: { [key: number]: { message: string } } = {
...
const Child2_getters: ABIGetter[] = [];

export const Child2_getterMapping: { [key: string]: string } = {};

const Child2_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child2 implements Contract {
    static async init() {
