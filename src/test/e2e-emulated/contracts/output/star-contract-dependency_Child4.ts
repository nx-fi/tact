...
type Child4_init_args = {
    $$type: "Child4_init_args";
};

function initChild4_init_args(src: Child4_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child4_errors: { [key: number]: { message: string } } = {
...
const Child4_getters: ABIGetter[] = [];

export const Child4_getterMapping: { [key: string]: string } = {};

const Child4_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child4 implements Contract {
    static async init() {
