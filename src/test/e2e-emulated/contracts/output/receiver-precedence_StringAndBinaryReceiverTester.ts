...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type StringAndBinaryReceiverTester_init_args = {
    $$type: 'StringAndBinaryReceiverTester_init_args';
}

function initStringAndBinaryReceiverTester_init_args(src: StringAndBinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const StringAndBinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const StringAndBinaryReceiverTester_types: ABIType[] = [
...
const StringAndBinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const StringAndBinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const StringAndBinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class StringAndBinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: string | Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | string | Message) {
