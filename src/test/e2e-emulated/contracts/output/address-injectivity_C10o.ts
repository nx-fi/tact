...
function initC10o_init_args(src: C10o_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
...
async function C10o_init(v: bigint) {
    const __code = Cell.fromBase64('te6ccgEBBgEAswABmP8AII4+MDDQctch0gDSAPpAIRA0UFVvBPhhAfhi7UTQ0gABnYEBAdcAgQEB1wBZbBKbgQEB1wABAdGAZAHiW9zywILh9KQT9LzyyAsBAgJxAgMBT74o52omhpAADOwICA64BAgIDrgCy2CU3AgIDrgACA6MAyAPFtnjYQwEAVG9l7dqJoaQAAzsCAgOuAQICA64AstglNwICA64AAgOjAMgDxLG2eNhDAUAAiEABlIQoA==');
...
const C10o_errors: { [key: number]: { message: string } } = {
...
export const C10o_getterMapping: { [key: string]: string } = {
    'incrAndGetField1': 'getIncrAndGetField1',
    'getField2': 'getGetField2',
}

const C10o_receivers: ABIReceiver[] = [
]


export class C10o implements Contract {
