...
export function storeGetAllMapsResult(src: GetAllMapsResult) {
    return (builder: Builder) => {
        ...
        if (
            src.int256_varuint16 !== null &&
            src.int256_varuint16 !== undefined
        ) {
        ...
        if (
            src.int256_varuint32 !== null &&
            src.int256_varuint32 !== undefined
        ) {
        ...
        if (
            src.uint42_varuint16 !== null &&
            src.uint42_varuint16 !== undefined
        ) {
        ...
        if (
            src.uint42_varuint32 !== null &&
            src.uint42_varuint32 !== undefined
        ) {
        ...
        if (
            src.uint256_varint16 !== null &&
            src.uint256_varint16 !== undefined
        ) {
        ...
        if (
            src.uint256_varint32 !== null &&
            src.uint256_varint32 !== undefined
        ) {
        ...
        if (
            src.uint256_varuint16 !== null &&
            src.uint256_varuint16 !== undefined
        ) {
        ...
        if (
            src.uint256_varuint32 !== null &&
            src.uint256_varuint32 !== undefined
        ) {
        ...
        if (
            src.address_varint16 !== null &&
            src.address_varint16 !== undefined
        ) {
        ...
        if (
            src.address_varint32 !== null &&
            src.address_varint32 !== undefined
        ) {
        ...
        if (
            src.address_varuint16 !== null &&
            src.address_varuint16 !== undefined
        ) {
        ...
        if (
            src.address_varuint32 !== null &&
            src.address_varuint32 !== undefined
        ) {
...
export function loadGetAllMapsResult(slice: Slice) {
    ...
    return {
        $$type: "GetAllMapsResult" as const,
        int_varint16: _int_varint16,
        int_varint32: _int_varint32,
        int_varuint16: _int_varuint16,
        int_varuint32: _int_varuint32,
        int_bool: _int_bool,
        int_cell: _int_cell,
        int_address: _int_address,
        int_struct: _int_struct,
        int8_varint16: _int8_varint16,
        int8_varint32: _int8_varint32,
        int8_varuint16: _int8_varuint16,
        int8_varuint32: _int8_varuint32,
        int8_bool: _int8_bool,
        int8_cell: _int8_cell,
        int8_address: _int8_address,
        int8_struct: _int8_struct,
        int42_varint16: _int42_varint16,
        int42_varint32: _int42_varint32,
        int42_varuint16: _int42_varuint16,
        int42_varuint32: _int42_varuint32,
        int42_bool: _int42_bool,
        int42_cell: _int42_cell,
        int42_address: _int42_address,
        int42_struct: _int42_struct,
        int256_varint16: _int256_varint16,
        int256_varint32: _int256_varint32,
        int256_varuint16: _int256_varuint16,
        int256_varuint32: _int256_varuint32,
        int256_bool: _int256_bool,
        int256_cell: _int256_cell,
        int256_address: _int256_address,
        int256_struct: _int256_struct,
        uint8_varint16: _uint8_varint16,
        uint8_varint32: _uint8_varint32,
        uint8_varuint16: _uint8_varuint16,
        uint8_varuint32: _uint8_varuint32,
        uint8_bool: _uint8_bool,
        uint8_cell: _uint8_cell,
        uint8_address: _uint8_address,
        uint8_struct: _uint8_struct,
        uint42_varint16: _uint42_varint16,
        uint42_varint32: _uint42_varint32,
        uint42_varuint16: _uint42_varuint16,
        uint42_varuint32: _uint42_varuint32,
        uint42_bool: _uint42_bool,
        uint42_cell: _uint42_cell,
        uint42_address: _uint42_address,
        uint42_struct: _uint42_struct,
        uint256_varint16: _uint256_varint16,
        uint256_varint32: _uint256_varint32,
        uint256_varuint16: _uint256_varuint16,
        uint256_varuint32: _uint256_varuint32,
        uint256_bool: _uint256_bool,
        uint256_cell: _uint256_cell,
        uint256_address: _uint256_address,
        uint256_struct: _uint256_struct,
        address_varint16: _address_varint16,
        address_varint32: _address_varint32,
        address_varuint16: _address_varuint16,
        address_varuint32: _address_varuint32,
        address_bool: _address_bool,
        address_cell: _address_cell,
        address_address: _address_address,
...
function loadTupleGetAllMapsResult(source: TupleReader) {
    ...
    const _int_struct = _int_struct_p
        ? loadTupleSomeStruct(_int_struct_p)
        : null;
    ...
    const _int8_struct = _int8_struct_p
        ? loadTupleSomeStruct(_int8_struct_p)
        : null;
    ...
    const _int42_struct = _int42_struct_p
        ? loadTupleSomeStruct(_int42_struct_p)
        : null;
    ...
    const _int256_struct = _int256_struct_p
        ? loadTupleSomeStruct(_int256_struct_p)
        : null;
    ...
    const _uint8_struct = _uint8_struct_p
        ? loadTupleSomeStruct(_uint8_struct_p)
        : null;
    ...
    const _uint42_struct = _uint42_struct_p
        ? loadTupleSomeStruct(_uint42_struct_p)
        : null;
    ...
    const _uint256_struct = _uint256_struct_p
        ? loadTupleSomeStruct(_uint256_struct_p)
        : null;
    source = source.readTuple();
    ...
    const _address_struct = _address_struct_p
        ? loadTupleSomeStruct(_address_struct_p)
        : null;
    return {
        $$type: "GetAllMapsResult" as const,
        int_varint16: _int_varint16,
...
function dictValueParserGetAllMapsResult(): DictionaryValue<GetAllMapsResult> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeGetAllMapsResult(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadReplaceAllMapsResult(slice: Slice) {
    ...
    return {
        $$type: "ReplaceAllMapsResult" as const,
        int_varint16: _int_varint16,
        int_varint32: _int_varint32,
        int_varuint16: _int_varuint16,
        int_varuint32: _int_varuint32,
...
function dictValueParserReplaceAllMapsResult(): DictionaryValue<ReplaceAllMapsResult> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeReplaceAllMapsResult(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadReplaceGetAllMapsResult(slice: Slice) {
    ...
    const _address_struct = sc_23.loadBit() ? loadSomeStruct(sc_23) : null;
    return {
        $$type: "ReplaceGetAllMapsResult" as const,
        int_varint16: _int_varint16,
        int_varint32: _int_varint32,
        int_varuint16: _int_varuint16,
        int_varuint32: _int_varuint32,
...
function dictValueParserReplaceGetAllMapsResult(): DictionaryValue<ReplaceGetAllMapsResult> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeReplaceGetAllMapsResult(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadExistsAllMapsResult(slice: Slice) {
    ...
    const _address_struct = sc_0.loadBit();
    return {
        $$type: "ExistsAllMapsResult" as const,
        int_varint16: _int_varint16,
        int_varint32: _int_varint32,
        int_varuint16: _int_varuint16,
        int_varuint32: _int_varuint32,
...
function dictValueParserExistsAllMapsResult(): DictionaryValue<ExistsAllMapsResult> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeExistsAllMapsResult(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadIsEmptyAllMapsResult(slice: Slice) {
    ...
    const _address_struct = sc_0.loadBit();
    return {
        $$type: "IsEmptyAllMapsResult" as const,
        int_varint16: _int_varint16,
        int_varint32: _int_varint32,
        int_varuint16: _int_varuint16,
        int_varuint32: _int_varuint32,
...
function dictValueParserIsEmptyAllMapsResult(): DictionaryValue<IsEmptyAllMapsResult> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeIsEmptyAllMapsResult(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadAsCellAllMapsResult(slice: Slice) {
    ...
    return {
        $$type: "AsCellAllMapsResult" as const,
        int_varint16: _int_varint16,
        int_varint32: _int_varint32,
        int_varuint16: _int_varuint16,
        int_varuint32: _int_varuint32,
...
function dictValueParserAsCellAllMapsResult(): DictionaryValue<AsCellAllMapsResult> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeAsCellAllMapsResult(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadSetAllMaps(slice: Slice) {
    ...
    return {
        $$type: "SetAllMaps" as const,
        keyInt: _keyInt,
        keyInt8: _keyInt8,
        keyInt42: _keyInt42,
        keyInt256: _keyInt256,
        keyUint8: _keyUint8,
        keyUint42: _keyUint42,
        keyUint256: _keyUint256,
        keyAddress: _keyAddress,
        valueVarint16: _valueVarint16,
        valueVarint32: _valueVarint32,
        valueVaruint16: _valueVaruint16,
        valueVaruint32: _valueVaruint32,
        valueBool: _valueBool,
        valueCell: _valueCell,
...
function loadTupleSetAllMaps(source: TupleReader) {
    ...
    const _valueStruct = _valueStruct_p
        ? loadTupleSomeStruct(_valueStruct_p)
        : null;
    return {
        $$type: "SetAllMaps" as const,
        keyInt: _keyInt,
...
function dictValueParserReplaceAllMaps(): DictionaryValue<ReplaceAllMaps> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeReplaceAllMaps(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function loadReplaceGetAllMaps(slice: Slice) {
    ...
    const _valueStruct = sc_5.loadBit() ? loadSomeStruct(sc_5) : null;
    return {
        $$type: "ReplaceGetAllMaps" as const,
        keyInt: _keyInt,
        keyInt8: _keyInt8,
        keyInt42: _keyInt42,
        keyInt256: _keyInt256,
...
function dictValueParserReplaceGetAllMaps(): DictionaryValue<ReplaceGetAllMaps> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeReplaceGetAllMaps(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserCheckNullReference(): DictionaryValue<CheckNullReference> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeCheckNullReference(src)).endCell(),
            );
        },
        parse: (src) => {
...
export function storeMapTestContract$Data(src: MapTestContract$Data) {
    return (builder: Builder) => {
        ...
        const b_9 = new Builder();
        b_9.storeDict(
            src.int256_varuint16,
            Dictionary.Keys.BigInt(256),
            Dictionary.Values.BigVarUint(4),
        );
        b_9.storeDict(
            src.int256_varuint32,
            Dictionary.Keys.BigInt(256),
            Dictionary.Values.BigVarUint(5),
        );
        b_9.storeDict(
        ...
        b_14.storeDict(
            src.uint42_varuint16,
            Dictionary.Keys.BigUint(42),
            Dictionary.Values.BigVarUint(4),
        );
        b_14.storeDict(
            src.uint42_varuint32,
            Dictionary.Keys.BigUint(42),
            Dictionary.Values.BigVarUint(5),
        );
        const b_15 = new Builder();
        ...
        b_16.storeDict(
            src.uint256_varint16,
            Dictionary.Keys.BigUint(256),
            Dictionary.Values.BigVarInt(4),
        );
        b_16.storeDict(
            src.uint256_varint32,
            Dictionary.Keys.BigUint(256),
            Dictionary.Values.BigVarInt(5),
        );
        const b_17 = new Builder();
        b_17.storeDict(
            src.uint256_varuint16,
            Dictionary.Keys.BigUint(256),
            Dictionary.Values.BigVarUint(4),
        );
        b_17.storeDict(
            src.uint256_varuint32,
            Dictionary.Keys.BigUint(256),
            Dictionary.Values.BigVarUint(5),
        );
        b_17.storeDict(
        ...
        const b_19 = new Builder();
        b_19.storeDict(
            src.address_varint16,
            Dictionary.Keys.Address(),
            Dictionary.Values.BigVarInt(4),
        );
        b_19.storeDict(
            src.address_varint32,
            Dictionary.Keys.Address(),
            Dictionary.Values.BigVarInt(5),
        );
        b_19.storeDict(
            src.address_varuint16,
            Dictionary.Keys.Address(),
            Dictionary.Values.BigVarUint(4),
        );
        const b_20 = new Builder();
        b_20.storeDict(
            src.address_varuint32,
            Dictionary.Keys.Address(),
            Dictionary.Values.BigVarUint(5),
        );
        b_20.storeDict(
...
export function loadMapTestContract$Data(slice: Slice) {
    const sc_0 = slice;
    const _int_varint16 = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarInt(4),
        sc_0,
    );
    const _int_varint32 = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarInt(5),
        sc_0,
    );
    const sc_1 = sc_0.loadRef().beginParse();
    const _int_varuint16 = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarUint(4),
        sc_1,
    );
    const _int_varuint32 = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarUint(5),
        sc_1,
    );
    const _int_bool = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.Bool(),
        sc_1,
    );
    const sc_2 = sc_1.loadRef().beginParse();
    const _int_cell = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.Cell(),
        sc_2,
    );
    const _int_address = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.Address(),
        sc_2,
    );
    const _int_struct = Dictionary.load(
        Dictionary.Keys.BigInt(257),
        dictValueParserSomeStruct(),
        sc_2,
    );
    const sc_3 = sc_2.loadRef().beginParse();
    const _int8_varint16 = Dictionary.load(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarInt(4),
        sc_3,
    );
    const _int8_varint32 = Dictionary.load(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarInt(5),
        sc_3,
    );
    const _int8_varuint16 = Dictionary.load(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarUint(4),
        sc_3,
    );
    const sc_4 = sc_3.loadRef().beginParse();
    const _int8_varuint32 = Dictionary.load(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarUint(5),
        sc_4,
    );
    const _int8_bool = Dictionary.load(
        Dictionary.Keys.Int(8),
        Dictionary.Values.Bool(),
        sc_4,
    );
    const _int8_cell = Dictionary.load(
        Dictionary.Keys.Int(8),
        Dictionary.Values.Cell(),
        sc_4,
    );
    const sc_5 = sc_4.loadRef().beginParse();
    const _int8_address = Dictionary.load(
        Dictionary.Keys.Int(8),
        Dictionary.Values.Address(),
        sc_5,
    );
    const _int8_struct = Dictionary.load(
        Dictionary.Keys.Int(8),
        dictValueParserSomeStruct(),
        sc_5,
    );
    const _int42_varint16 = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarInt(4),
        sc_5,
    );
    const sc_6 = sc_5.loadRef().beginParse();
    const _int42_varint32 = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarInt(5),
        sc_6,
    );
    const _int42_varuint16 = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarUint(4),
        sc_6,
    );
    const _int42_varuint32 = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarUint(5),
        sc_6,
    );
    const sc_7 = sc_6.loadRef().beginParse();
    const _int42_bool = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.Bool(),
        sc_7,
    );
    const _int42_cell = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.Cell(),
        sc_7,
    );
    const _int42_address = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.Address(),
        sc_7,
    );
    const sc_8 = sc_7.loadRef().beginParse();
    const _int42_struct = Dictionary.load(
        Dictionary.Keys.BigInt(42),
        dictValueParserSomeStruct(),
        sc_8,
    );
    const _int256_varint16 = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarInt(4),
        sc_8,
    );
    const _int256_varint32 = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarInt(5),
        sc_8,
    );
    const sc_9 = sc_8.loadRef().beginParse();
    const _int256_varuint16 = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarUint(4),
        sc_9,
    );
    const _int256_varuint32 = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarUint(5),
        sc_9,
    );
    const _int256_bool = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.Bool(),
        sc_9,
    );
    const sc_10 = sc_9.loadRef().beginParse();
    const _int256_cell = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.Cell(),
        sc_10,
    );
    const _int256_address = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.Address(),
        sc_10,
    );
    const _int256_struct = Dictionary.load(
        Dictionary.Keys.BigInt(256),
        dictValueParserSomeStruct(),
        sc_10,
    );
    const sc_11 = sc_10.loadRef().beginParse();
    const _uint8_varint16 = Dictionary.load(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarInt(4),
        sc_11,
    );
    const _uint8_varint32 = Dictionary.load(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarInt(5),
        sc_11,
    );
    const _uint8_varuint16 = Dictionary.load(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarUint(4),
        sc_11,
    );
    const sc_12 = sc_11.loadRef().beginParse();
    const _uint8_varuint32 = Dictionary.load(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarUint(5),
        sc_12,
    );
    const _uint8_bool = Dictionary.load(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.Bool(),
        sc_12,
    );
    const _uint8_cell = Dictionary.load(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.Cell(),
        sc_12,
    );
    const sc_13 = sc_12.loadRef().beginParse();
    const _uint8_address = Dictionary.load(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.Address(),
        sc_13,
    );
    const _uint8_struct = Dictionary.load(
        Dictionary.Keys.Uint(8),
        dictValueParserSomeStruct(),
        sc_13,
    );
    const _uint42_varint16 = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarInt(4),
        sc_13,
    );
    const sc_14 = sc_13.loadRef().beginParse();
    const _uint42_varint32 = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarInt(5),
        sc_14,
    );
    const _uint42_varuint16 = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarUint(4),
        sc_14,
    );
    const _uint42_varuint32 = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarUint(5),
        sc_14,
    );
    const sc_15 = sc_14.loadRef().beginParse();
    const _uint42_bool = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.Bool(),
        sc_15,
    );
    const _uint42_cell = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.Cell(),
        sc_15,
    );
    const _uint42_address = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.Address(),
        sc_15,
    );
    const sc_16 = sc_15.loadRef().beginParse();
    const _uint42_struct = Dictionary.load(
        Dictionary.Keys.BigUint(42),
        dictValueParserSomeStruct(),
        sc_16,
    );
    const _uint256_varint16 = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarInt(4),
        sc_16,
    );
    const _uint256_varint32 = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarInt(5),
        sc_16,
    );
    const sc_17 = sc_16.loadRef().beginParse();
    const _uint256_varuint16 = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarUint(4),
        sc_17,
    );
    const _uint256_varuint32 = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarUint(5),
        sc_17,
    );
    const _uint256_bool = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.Bool(),
        sc_17,
    );
    const sc_18 = sc_17.loadRef().beginParse();
    const _uint256_cell = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.Cell(),
        sc_18,
    );
    const _uint256_address = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.Address(),
        sc_18,
    );
    const _uint256_struct = Dictionary.load(
        Dictionary.Keys.BigUint(256),
        dictValueParserSomeStruct(),
        sc_18,
    );
    const sc_19 = sc_18.loadRef().beginParse();
    const _address_varint16 = Dictionary.load(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarInt(4),
        sc_19,
    );
    const _address_varint32 = Dictionary.load(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarInt(5),
        sc_19,
    );
    const _address_varuint16 = Dictionary.load(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarUint(4),
        sc_19,
    );
    const sc_20 = sc_19.loadRef().beginParse();
    const _address_varuint32 = Dictionary.load(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarUint(5),
        sc_20,
    );
    const _address_bool = Dictionary.load(
        Dictionary.Keys.Address(),
        Dictionary.Values.Bool(),
        sc_20,
    );
    const _address_cell = Dictionary.load(
        Dictionary.Keys.Address(),
        Dictionary.Values.Cell(),
        sc_20,
    );
    const sc_21 = sc_20.loadRef().beginParse();
    const _address_address = Dictionary.load(
        Dictionary.Keys.Address(),
        Dictionary.Values.Address(),
        sc_21,
    );
    const _address_struct = Dictionary.load(
        Dictionary.Keys.Address(),
        dictValueParserSomeStruct(),
        sc_21,
    );
...
function loadTupleMapTestContract$Data(source: TupleReader) {
    const _int_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _int_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    const _int_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _int_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    const _int_bool = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _int_cell = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    const _int_address = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _int_struct = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(257),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
    const _int8_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _int8_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    const _int8_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _int8_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    const _int8_bool = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _int8_cell = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    source = source.readTuple();
    const _int8_address = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _int8_struct = Dictionary.loadDirect(
        Dictionary.Keys.Int(8),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
    const _int42_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _int42_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    const _int42_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _int42_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    const _int42_bool = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _int42_cell = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    const _int42_address = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _int42_struct = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(42),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
    const _int256_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _int256_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    const _int256_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _int256_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    source = source.readTuple();
    const _int256_bool = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _int256_cell = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    const _int256_address = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _int256_struct = Dictionary.loadDirect(
        Dictionary.Keys.BigInt(256),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
    const _uint8_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _uint8_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    const _uint8_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _uint8_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    const _uint8_bool = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _uint8_cell = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    const _uint8_address = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _uint8_struct = Dictionary.loadDirect(
        Dictionary.Keys.Uint(8),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
    const _uint42_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _uint42_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    source = source.readTuple();
    const _uint42_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _uint42_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    const _uint42_bool = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _uint42_cell = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    const _uint42_address = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _uint42_struct = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(42),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
    const _uint256_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _uint256_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    const _uint256_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _uint256_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    const _uint256_bool = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _uint256_cell = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    const _uint256_address = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _uint256_struct = Dictionary.loadDirect(
        Dictionary.Keys.BigUint(256),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
    source = source.readTuple();
    const _address_varint16 = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarInt(4),
        source.readCellOpt(),
    );
    const _address_varint32 = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarInt(5),
        source.readCellOpt(),
    );
    const _address_varuint16 = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarUint(4),
        source.readCellOpt(),
    );
    const _address_varuint32 = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        Dictionary.Values.BigVarUint(5),
        source.readCellOpt(),
    );
    const _address_bool = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        Dictionary.Values.Bool(),
        source.readCellOpt(),
    );
    const _address_cell = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        Dictionary.Values.Cell(),
        source.readCellOpt(),
    );
    const _address_address = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        Dictionary.Values.Address(),
        source.readCellOpt(),
    );
    const _address_struct = Dictionary.loadDirect(
        Dictionary.Keys.Address(),
        dictValueParserSomeStruct(),
        source.readCellOpt(),
    );
...
function storeTupleMapTestContract$Data(source: MapTestContract$Data) {
    ...
    builder.writeCell(
        source.int_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int_varuint16,
                      Dictionary.Keys.BigInt(257),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int_varuint32,
                      Dictionary.Keys.BigInt(257),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int8_varint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int8_varint16,
                      Dictionary.Keys.Int(8),
                      Dictionary.Values.BigVarInt(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int8_varint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int8_varint32,
                      Dictionary.Keys.Int(8),
                      Dictionary.Values.BigVarInt(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int8_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int8_varuint16,
                      Dictionary.Keys.Int(8),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int8_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int8_varuint32,
                      Dictionary.Keys.Int(8),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int42_varint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int42_varint16,
                      Dictionary.Keys.BigInt(42),
                      Dictionary.Values.BigVarInt(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int42_varint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int42_varint32,
                      Dictionary.Keys.BigInt(42),
                      Dictionary.Values.BigVarInt(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int42_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int42_varuint16,
                      Dictionary.Keys.BigInt(42),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int42_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int42_varuint32,
                      Dictionary.Keys.BigInt(42),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int42_address.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int42_address,
                      Dictionary.Keys.BigInt(42),
                      Dictionary.Values.Address(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int256_varint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int256_varint16,
                      Dictionary.Keys.BigInt(256),
                      Dictionary.Values.BigVarInt(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int256_varint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int256_varint32,
                      Dictionary.Keys.BigInt(256),
                      Dictionary.Values.BigVarInt(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int256_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int256_varuint16,
                      Dictionary.Keys.BigInt(256),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int256_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int256_varuint32,
                      Dictionary.Keys.BigInt(256),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int256_address.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int256_address,
                      Dictionary.Keys.BigInt(256),
                      Dictionary.Values.Address(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.int256_struct.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.int256_struct,
                      Dictionary.Keys.BigInt(256),
                      dictValueParserSomeStruct(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint8_varint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint8_varint16,
                      Dictionary.Keys.Uint(8),
                      Dictionary.Values.BigVarInt(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint8_varint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint8_varint32,
                      Dictionary.Keys.Uint(8),
                      Dictionary.Values.BigVarInt(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint8_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint8_varuint16,
                      Dictionary.Keys.Uint(8),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint8_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint8_varuint32,
                      Dictionary.Keys.Uint(8),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint8_address.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint8_address,
                      Dictionary.Keys.Uint(8),
                      Dictionary.Values.Address(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint42_varint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint42_varint16,
                      Dictionary.Keys.BigUint(42),
                      Dictionary.Values.BigVarInt(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint42_varint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint42_varint32,
                      Dictionary.Keys.BigUint(42),
                      Dictionary.Values.BigVarInt(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint42_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint42_varuint16,
                      Dictionary.Keys.BigUint(42),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint42_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint42_varuint32,
                      Dictionary.Keys.BigUint(42),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint42_address.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint42_address,
                      Dictionary.Keys.BigUint(42),
                      Dictionary.Values.Address(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint42_struct.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint42_struct,
                      Dictionary.Keys.BigUint(42),
                      dictValueParserSomeStruct(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint256_varint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint256_varint16,
                      Dictionary.Keys.BigUint(256),
                      Dictionary.Values.BigVarInt(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint256_varint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint256_varint32,
                      Dictionary.Keys.BigUint(256),
                      Dictionary.Values.BigVarInt(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint256_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint256_varuint16,
                      Dictionary.Keys.BigUint(256),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint256_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint256_varuint32,
                      Dictionary.Keys.BigUint(256),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint256_address.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint256_address,
                      Dictionary.Keys.BigUint(256),
                      Dictionary.Values.Address(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.uint256_struct.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.uint256_struct,
                      Dictionary.Keys.BigUint(256),
                      dictValueParserSomeStruct(),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.address_varint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.address_varint16,
                      Dictionary.Keys.Address(),
                      Dictionary.Values.BigVarInt(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.address_varint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.address_varint32,
                      Dictionary.Keys.Address(),
                      Dictionary.Values.BigVarInt(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.address_varuint16.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.address_varuint16,
                      Dictionary.Keys.Address(),
                      Dictionary.Values.BigVarUint(4),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.address_varuint32.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.address_varuint32,
                      Dictionary.Keys.Address(),
                      Dictionary.Values.BigVarUint(5),
                  )
                  .endCell()
    ...
    builder.writeCell(
        source.address_struct.size > 0
            ? beginCell()
                  .storeDictDirect(
                      source.address_struct,
                      Dictionary.Keys.Address(),
                      dictValueParserSomeStruct(),
                  )
                  .endCell()
...
const MapTestContract_types: ABIType[] = [
    ...
    { name: "CheckNullReference", header: 2978152160, fields: [] },
    {
        ...
        fields: [
            ...
            {
                name: "int8_bool",
                type: { kind: "dict", key: "int", keyFormat: 8, value: "bool" },
            },
            {
                name: "int8_cell",
                type: {
...
const MapTestContract_getters: ABIGetter[] = [
    ...
    },
    {
        ...
        arguments: [
            ...
            {
                name: "valueStruct",
                type: { kind: "simple", type: "SomeStruct", optional: false },
            },
        ],
        returnType: {
            kind: "simple",
...
const MapTestContract_receivers: ABIReceiver[] = [
    ...
    {
        receiver: "internal",
        message: { kind: "typed", type: "ReplaceAllMaps" },
    },
    {
        receiver: "internal",
        message: { kind: "typed", type: "ReplaceGetAllMaps" },
    },
    {
        receiver: "internal",
        message: { kind: "typed", type: "CheckNullReference" },
    },
];
...
export class MapTestContract implements Contract {
    ...
    async send(
        ...
        if (
            ...
            typeof message === "object" &&
            !(message instanceof Slice) &&
            message.$$type === "ReplaceGetAllMaps"
        ) {
        ...
        if (
            ...
            typeof message === "object" &&
            !(message instanceof Slice) &&
            message.$$type === "CheckNullReference"
        ) {
            body = beginCell()
                .store(storeCheckNullReference(message))
                .endCell();
        }
        if (body === null) {
    ...
    async getAllMaps(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(94363 as any, builder.build()))
            .stack;
    ...
    async getGetAllMaps(
        ...
        const source = (await provider.get(96520 as any, builder.build()))
            .stack;
    ...
    async getReplaceAllMaps(
        ...
        const source = (await provider.get(66237 as any, builder.build()))
            .stack;
        const result = loadGetterTupleReplaceAllMapsResult(source);
        return result;
    }

    async getReplaceGetAllMaps(
        provider: ContractProvider,
        keyInt: bigint,
        keyInt8: bigint,
        keyInt42: bigint,
        ...
        builder.writeAddress(valueAddress);
        builder.writeTuple(storeTupleSomeStruct(valueStruct));
        const source = (await provider.get(90912 as any, builder.build()))
            .stack;
        const result = loadGetterTupleReplaceGetAllMapsResult(source);
        return result;
    }

    async getExistsAllMaps(
        provider: ContractProvider,
        keyInt: bigint,
        keyInt8: bigint,
        keyInt42: bigint,
        ...
        builder.writeNumber(keyUint256);
        builder.writeAddress(keyAddress);
        const source = (await provider.get(66408 as any, builder.build()))
            .stack;
    ...
    async getIsEmptyAllMaps(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(98752 as any, builder.build()))
            .stack;
    ...
    async getAsCellAllMaps(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(117227 as any, builder.build()))
            .stack;
    ...
    async getCheckNullReference(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(70003 as any, builder.build()))
            .stack;
