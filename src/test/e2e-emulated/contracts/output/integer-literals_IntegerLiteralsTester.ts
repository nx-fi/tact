...
export function storeIntegerLiteralsTester$Data(src: IntegerLiteralsTester$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

export function loadIntegerLiteralsTester$Data(slice: Slice) {
    const sc_0 = slice;
    return { $$type: 'IntegerLiteralsTester$Data' as const };
}

function loadTupleIntegerLiteralsTester$Data(source: TupleReader) {
    return { $$type: 'IntegerLiteralsTester$Data' as const };
}

function loadGetterTupleIntegerLiteralsTester$Data(source: TupleReader) {
    return { $$type: 'IntegerLiteralsTester$Data' as const };
}

function storeTupleIntegerLiteralsTester$Data(source: IntegerLiteralsTester$Data) {
    const builder = new TupleBuilder();
    return builder.build();
}

function dictValueParserIntegerLiteralsTester$Data(): DictionaryValue<IntegerLiteralsTester$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeIntegerLiteralsTester$Data(src)).endCell());
        },
        parse: (src) => {
...
async function IntegerLiteralsTester_init() {
    const __code = Cell.fromBase64('');
...
export const IntegerLiteralsTester_getterMapping: { [key: string]: string } = {
...
export class IntegerLiteralsTester implements Contract {
    ...
    async getDecLiteral1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(102042 as any, builder.build())).stack;
    ...
    async getDecLiteral2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(114425 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getDecLiteral3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(110296 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getHexLiteral1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(76310 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getHexLiteral2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(72309 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getHexLiteral3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(68180 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBinLiteral1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(116259 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBinLiteral2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(128576 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getBinLiteral3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(124513 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getOctLiteral1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115972 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getOctLiteral2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(128359 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getOctLiteral3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(124230 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
