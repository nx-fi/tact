...
export class JettonDefaultWallet implements Contract {
    ...
    async getMsgValue(provider: ContractProvider, value: bigint) {
        ...
        const source = (await provider.get(115218 as any, builder.build())).stack;
