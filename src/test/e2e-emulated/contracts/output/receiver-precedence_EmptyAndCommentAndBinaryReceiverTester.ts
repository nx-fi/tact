...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndCommentAndBinaryReceiverTester_init_args = {
    $$type: 'EmptyAndCommentAndBinaryReceiverTester_init_args';
}

function initEmptyAndCommentAndBinaryReceiverTester_init_args(src: EmptyAndCommentAndBinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const EmptyAndCommentAndBinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndCommentAndBinaryReceiverTester_types: ABIType[] = [
...
const EmptyAndCommentAndBinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndCommentAndBinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndCommentAndBinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndCommentAndBinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message" | Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | null | 'message' | Message) {
