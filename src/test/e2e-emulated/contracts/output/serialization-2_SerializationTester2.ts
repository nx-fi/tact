...
function storeTupleSerializationTester2$Data(
    source: SerializationTester2$Data,
) {
    const builder = new TupleBuilder();
    builder.writeTuple(storeTupleVars(source.a));
    builder.writeTuple(storeTupleVars(source.b));
...
function dictValueParserSerializationTester2$Data(): DictionaryValue<SerializationTester2$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell()
                    .store(storeSerializationTester2$Data(src))
                    .endCell(),
            );
        },
        parse: (src) => {
...
function initSerializationTester2_init_args(
    src: SerializationTester2_init_args,
) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.store(storeVars(src.a));
...
const SerializationTester2_types: ABIType[] = [
    ...
    },
    {
        ...
        fields: [
            {
                name: "a",
                type: { kind: "simple", type: "Vars", optional: false },
            },
            {
                name: "b",
                type: { kind: "simple", type: "Vars", optional: false },
    ...
    {
        name: "SerializationTester2$Data",
        header: null,
        fields: [
            {
                name: "a",
...
const SerializationTester2_getters: ABIGetter[] = [
    {
        ...
        methodId: 123932,
        arguments: [],
        returnType: { kind: "simple", type: "Vars", optional: false },
    },
    {
        name: "getAOpt",
        methodId: 81209,
        arguments: [],
        returnType: { kind: "simple", type: "Vars", optional: true },
    },
    {
        name: "getB",
        methodId: 119935,
    ...
    },
    {
        ...
        methodId: 81754,
        arguments: [],
        returnType: { kind: "simple", type: "Both", optional: false },
    },
    {
        name: "getBothOpt",
        methodId: 69430,
        arguments: [],
        returnType: { kind: "simple", type: "Both", optional: true },
    },
    {
        name: "process",
        methodId: 104435,
        arguments: [
            ...
            {
                name: "both",
                type: { kind: "simple", type: "Both", optional: false },
            },
            {
                name: "both2",
                type: { kind: "simple", type: "Both", optional: true },
            },
        ],
        returnType: { kind: "simple", type: "Vars", optional: false },
    },
...
export class SerializationTester2 implements Contract {
    ...
    async getGetAOpt(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(81209 as any, builder.build()))
            .stack;
    ...
    async getGetB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(119935 as any, builder.build()))
            .stack;
        const result = loadGetterTupleVars(source);
        return result;
    }
    ...
    async getGetBOpt(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(108261 as any, builder.build()))
            .stack;
        const result_p = source.readTupleOpt();
        const result = result_p ? loadTupleVars(result_p) : null;
        return result;
    ...
    async getGetBoth(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(81754 as any, builder.build()))
            .stack;
    ...
    async getGetBothOpt(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(69430 as any, builder.build()))
            .stack;
        const result_p = source.readTupleOpt();
    ...
    async getProcess(
        ...
        const source = (await provider.get(104435 as any, builder.build()))
            .stack;
        const result = loadGetterTupleVars(source);
        return result;
    }
