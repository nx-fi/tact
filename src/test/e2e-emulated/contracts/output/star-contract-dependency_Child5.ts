...
function dictValueParserParent$Data(): DictionaryValue<Parent$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeParent$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild0$Data(): DictionaryValue<Child0$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild0$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild1$Data(): DictionaryValue<Child1$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild1$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild2$Data(): DictionaryValue<Child2$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild2$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild3$Data(): DictionaryValue<Child3$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild3$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild4$Data(): DictionaryValue<Child4$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild4$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild5$Data(): DictionaryValue<Child5$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild5$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild6$Data(): DictionaryValue<Child6$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild6$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild7$Data(): DictionaryValue<Child7$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild7$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild8$Data(): DictionaryValue<Child8$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild8$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
function dictValueParserChild9$Data(): DictionaryValue<Child9$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeChild9$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
type Child5_init_args = {
    $$type: "Child5_init_args";
};

function initChild5_init_args(src: Child5_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child5_errors: { [key: number]: { message: string } } = {
...
const Child5_getters: ABIGetter[] = [
    {
        name: "getParent",
        methodId: 115590,
        arguments: [],
...
export const Child5_getterMapping: { [key: string]: string } = {
    getParent: "getGetParent",
};

const Child5_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child5 implements Contract {
    static async init() {
