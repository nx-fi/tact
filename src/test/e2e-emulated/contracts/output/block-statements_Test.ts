...
export class Test implements Contract {
    ...
    async getA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(88293 as any, builder.build()))
            .stack;
    ...
    async getB(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(92294 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(96423 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(67648 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(71777 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
