...
type Child6_init_args = {
    $$type: "Child6_init_args";
};

function initChild6_init_args(src: Child6_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child6_errors: { [key: number]: { message: string } } = {
...
const Child6_getters: ABIGetter[] = [];

export const Child6_getterMapping: { [key: string]: string } = {};

const Child6_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child6 implements Contract {
    static async init() {
