...
async function Test_init() {
    const __code = Cell.fromBase64(
        "te6ccgEBBQEAnwABFP8A9KQT9LzyyAsBA9LTAdBy1yHSANIA+kAhEDRQZm8E+GEC+GLbPAOSXwPgcCLXSSDCH5UxAtMfMJEz4sAAAsEhErCPLAHbPDCCAJLpAsAqEvL0cAHbPDCBeukiwCry9Mh/AcoAWQLL/4EBAc8Aye1U4FvywIICAwMALu1E0NIAAZrT/4EBAdcAWWwS4DBwgQDvAQTbPAQACIAqMn8=",
    );
