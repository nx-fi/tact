...
export class Tester implements Contract {
    ...
    async getTest11(provider: ContractProvider, x: bigint | null) {
        ...
        const source = (await provider.get(111617 as any, builder.build()))
            .stack;
    ...
    async getTest12(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(99426 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
