...
async function Test_init(i: InitData) {
    const __code = Cell.fromBase64(
        "te6ccgEBAwEAeQABFP8A9KQT9LzyyAsBAYrTAdBy1yHSANIA+kAhEDRQZm8E+GEC+GLbPAKRW+BwIddJIMIflTEB0x8wkTLiwAABwSGwm8h/AcoAAc8Wye1U4DDywIICAETtRNDSAAGU+kABMeDTHwGCEH55+0i68uCB+kDTP1kC0QEw",
    );
