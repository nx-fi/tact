...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndCommentAndSliceReceiverTester_init_args = {
    $$type: 'EmptyAndCommentAndSliceReceiverTester_init_args';
}

function initEmptyAndCommentAndSliceReceiverTester_init_args(src: EmptyAndCommentAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyAndCommentAndSliceReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyAndCommentAndSliceReceiverTester_init_args({ $$type: 'EmptyAndCommentAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyAndCommentAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndCommentAndSliceReceiverTester_types: ABIType[] = [
...
const EmptyAndCommentAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndCommentAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndCommentAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndCommentAndSliceReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyAndCommentAndSliceReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyAndCommentAndSliceReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyAndCommentAndSliceReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyAndCommentAndSliceReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyAndCommentAndSliceReceiverTester_types,
        getters: EmptyAndCommentAndSliceReceiverTester_getters,
        receivers: EmptyAndCommentAndSliceReceiverTester_receivers,
        errors: EmptyAndCommentAndSliceReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message" | Slice) {
    ...
    async sendExternal(provider: ContractProvider, message: null | 'message' | Slice) {
