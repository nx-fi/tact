...
export function loadSerializationTester$Data(slice: Slice) {
    ...
    const _i = sc_2.loadIntBig(257);
    return {
        $$type: "SerializationTester$Data" as const,
        a: _a,
        b: _b,
        c: _c,
        d: _d,
...
function dictValueParserSerializationTester$Data(): DictionaryValue<SerializationTester$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(
                beginCell().store(storeSerializationTester$Data(src)).endCell(),
            );
        },
        parse: (src) => {
...
async function SerializationTester_init(
    a: bigint,
    b: bigint,
    c: bigint,
    d: bigint,
...
export class SerializationTester implements Contract {
    ...
    static async fromInit(
        ...
        const __gen_init = await SerializationTester_init(
            a,
            b,
            c,
            d,
    ...
    async getGetC(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(115806 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetD(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(111801 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetE(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107672 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetG(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(99546 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetH(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(95541 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getGetI(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(91412 as any, builder.build()))
            .stack;
        const result = source.readBigNumber();
        return result;
    }
