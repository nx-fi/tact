...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type CommentAndStringAndBinaryAndSliceReceiverTester_init_args = {
    $$type: 'CommentAndStringAndBinaryAndSliceReceiverTester_init_args';
}

function initCommentAndStringAndBinaryAndSliceReceiverTester_init_args(src: CommentAndStringAndBinaryAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const CommentAndStringAndBinaryAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const CommentAndStringAndBinaryAndSliceReceiverTester_types: ABIType[] = [
...
const CommentAndStringAndBinaryAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const CommentAndStringAndBinaryAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const CommentAndStringAndBinaryAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class CommentAndStringAndBinaryAndSliceReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "message" | string | Message | Slice | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | 'message' | string | Message | Slice) {
