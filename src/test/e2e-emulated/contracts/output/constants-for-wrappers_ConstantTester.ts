...
export function storeSimpleStruct(src: SimpleStruct) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeInt(src.value, 257);
    };
...
export function loadSimpleStruct(slice: Slice) {
    const sc_0 = slice;
    const _value = sc_0.loadIntBig(257);
    return { $$type: 'SimpleStruct' as const, value: _value };
}

function loadTupleSimpleStruct(source: TupleReader) {
    const _value = source.readBigNumber();
    return { $$type: 'SimpleStruct' as const, value: _value };
}

function loadGetterTupleSimpleStruct(source: TupleReader) {
    const _value = source.readBigNumber();
    return { $$type: 'SimpleStruct' as const, value: _value };
}

function storeTupleSimpleStruct(source: SimpleStruct) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.value);
    return builder.build();
}

function dictValueParserSimpleStruct(): DictionaryValue<SimpleStruct> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSimpleStruct(src)).endCell());
        },
        parse: (src) => {
...
export function storeNestedStruct(src: NestedStruct) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeInt(src.value, 257);
...
export function loadNestedStruct(slice: Slice) {
    const sc_0 = slice;
    const _value = sc_0.loadIntBig(257);
    const _other = loadSimpleStruct(sc_0);
    return { $$type: 'NestedStruct' as const, value: _value, other: _other };
}

function loadTupleNestedStruct(source: TupleReader) {
    const _value = source.readBigNumber();
    const _other = loadTupleSimpleStruct(source);
    return { $$type: 'NestedStruct' as const, value: _value, other: _other };
}

function loadGetterTupleNestedStruct(source: TupleReader) {
    const _value = source.readBigNumber();
    const _other = loadGetterTupleSimpleStruct(source);
    return { $$type: 'NestedStruct' as const, value: _value, other: _other };
}

function storeTupleNestedStruct(source: NestedStruct) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.value);
...
function dictValueParserNestedStruct(): DictionaryValue<NestedStruct> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeNestedStruct(src)).endCell());
        },
        parse: (src) => {
...
export const INT = 10n;
export const STRING = "hello world";
export const STRING_WITH_QUOTES = "hello \"world\"";
export const BOOL = true;
export const ADDR = address("EQCD39VS5jcptHL8vMjEXrzGaRcCVYto7HUn4bpAOg8xqB2N");
export const CELL = Cell.fromHex("");
export const SLICE = Cell.fromHex("").beginParse();
export const SIMPLE_STRUCT = { $$type: "SimpleStruct" as const, value: 10n };
export const NESTED_STRUCT = { $$type: "NestedStruct" as const, value: 10n, other: { $$type: "SimpleStruct" as const, value: 11n } };

export class ConstantTester implements Contract {
    
    public static readonly INT = 10n;
    public static readonly STRING = "hello world";
    public static readonly STRING_WITH_QUOTES = "hello \"world\"";
    public static readonly BOOL = true;
    public static readonly ADDR = address("EQCD39VS5jcptHL8vMjEXrzGaRcCVYto7HUn4bpAOg8xqB2N");
    public static readonly CELL = Cell.fromHex("");
    public static readonly SLICE = Cell.fromHex("").beginParse();
    public static readonly SIMPLE_STRUCT = { $$type: "SimpleStruct" as const, value: 10n };
    public static readonly NESTED_STRUCT = { $$type: "NestedStruct" as const, value: 10n, other: { $$type: "SimpleStruct" as const, value: 11n } };
    ...
    async getGlobalInt(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(67661 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getGlobalString(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(72260 as any, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    
    async getGlobalStringWithQuotes(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107522 as any, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    
    async getGlobalBool(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(104324 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    
    async getGlobalAddress(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(67506 as any, builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    
    async getGlobalCell(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(95138 as any, builder.build())).stack;
        const result = source.readCell();
        return result;
    }
    
    async getGlobalSlice(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(121876 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    
    async getGlobalSimpleStruct(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(69742 as any, builder.build())).stack;
        const result = loadGetterTupleSimpleStruct(source);
        return result;
    }
    
    async getGlobalNestedStruct(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(69915 as any, builder.build())).stack;
        const result = loadGetterTupleNestedStruct(source);
        return result;
    }
    
    async getContractInt(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(109434 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    
    async getContractString(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(90762 as any, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    
    async getContractStringWithQuotes(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107220 as any, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    
    async getContractBool(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(75021 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getContractAddress(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(79405 as any, builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    
    async getContractCell(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(114987 as any, builder.build())).stack;
        const result = source.readCell();
        return result;
    }
    
    async getContractSlice(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(119437 as any, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    
    async getContractSimpleStruct(provider: ContractProvider) {
        const builder = new TupleBuilder();
    ...
    async getContractNestedStruct(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107989 as any, builder.build())).stack;
        const result = loadGetterTupleNestedStruct(source);
        return result;
    }
