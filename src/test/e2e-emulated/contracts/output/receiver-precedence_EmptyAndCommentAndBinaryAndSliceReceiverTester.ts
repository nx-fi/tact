...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndCommentAndBinaryAndSliceReceiverTester_init_args = {
    $$type: 'EmptyAndCommentAndBinaryAndSliceReceiverTester_init_args';
}

function initEmptyAndCommentAndBinaryAndSliceReceiverTester_init_args(src: EmptyAndCommentAndBinaryAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const EmptyAndCommentAndBinaryAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndCommentAndBinaryAndSliceReceiverTester_types: ABIType[] = [
...
const EmptyAndCommentAndBinaryAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndCommentAndBinaryAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndCommentAndBinaryAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndCommentAndBinaryAndSliceReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | "message" | Message | Slice | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | null | 'message' | Message | Slice) {
