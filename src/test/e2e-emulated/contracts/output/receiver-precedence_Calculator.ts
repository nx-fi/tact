...
async function Calculator_init() {
    const __code = Cell.fromBase64(
        "",
    );
...
const Calculator_receivers: ABIReceiver[] = [
    ...
    {
        receiver: "internal",
        message: { kind: "typed", type: "BinaryIntOperation" },
    },
];
...
export class Calculator implements Contract {
    ...
    async send(
        ...
        message: "deploy" | BinaryIntOperation,
    ) {
        ...
        if (
            ...
            message.$$type === "BinaryIntOperation"
        ) {
            body = beginCell()
                .store(storeBinaryIntOperation(message))
                .endCell();
        }
        if (body === null) {
