...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndStringReceiverTester_init_args = {
    $$type: 'EmptyAndStringReceiverTester_init_args';
}

function initEmptyAndStringReceiverTester_init_args(src: EmptyAndStringReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyAndStringReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyAndStringReceiverTester_init_args({ $$type: 'EmptyAndStringReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyAndStringReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndStringReceiverTester_types: ABIType[] = [
...
const EmptyAndStringReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndStringReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndStringReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndStringReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyAndStringReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyAndStringReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyAndStringReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyAndStringReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyAndStringReceiverTester_types,
        getters: EmptyAndStringReceiverTester_getters,
        receivers: EmptyAndStringReceiverTester_receivers,
        errors: EmptyAndStringReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | string) {
    ...
    async sendExternal(provider: ContractProvider, message: null | string) {
