...
async function C4g_init(v: bigint) {
    const __code = Cell.fromBase64(
        "te6ccgEBBgEAXwABFP8A9KQT9LzyyAsBAgFiAgMBPtAw0HLXIdIA0gD6QCEQNFBVbwT4YQH4Yts8MNzywIIEAhGgCam2eAO2eGMEBQAu7UTQ0gABl4EBAdcAATHggQEB1wABAdEABlIQoA==",
    );
...
export class C4g implements Contract {
    ...
    async getIncrAndGetField(provider: ContractProvider, n: bigint) {
        ...
        const source = (await provider.get(66772 as any, builder.build()))
            .stack;
