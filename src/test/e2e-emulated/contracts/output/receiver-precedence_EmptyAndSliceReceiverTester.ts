...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndSliceReceiverTester_init_args = {
    $$type: 'EmptyAndSliceReceiverTester_init_args';
}

function initEmptyAndSliceReceiverTester_init_args(src: EmptyAndSliceReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyAndSliceReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyAndSliceReceiverTester_init_args({ $$type: 'EmptyAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyAndSliceReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndSliceReceiverTester_types: ABIType[] = [
...
const EmptyAndSliceReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndSliceReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndSliceReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndSliceReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyAndSliceReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyAndSliceReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyAndSliceReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyAndSliceReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyAndSliceReceiverTester_types,
        getters: EmptyAndSliceReceiverTester_getters,
        receivers: EmptyAndSliceReceiverTester_receivers,
        errors: EmptyAndSliceReceiverTester_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | Slice) {
    ...
    async sendExternal(provider: ContractProvider, message: null | Slice) {
