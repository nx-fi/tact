...
async function Test_init() {
    const __code = Cell.fromBase64('');
...
export class Test implements Contract {
    ...
    async getTestGetter(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(97823 as any, builder.build())).stack;
    ...
    async gettest_getter(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(111014 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getTest_getter(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(72668 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getContractData(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(71601 as any, builder.build())).stack;
    ...
    async getStructAsInput(provider: ContractProvider, s: S) {
        ...
        const source = (await provider.get(128711 as any, builder.build())).stack;
    ...
    async getMessageAsInput1(provider: ContractProvider, m: SetIdAndData) {
        ...
        const source = (await provider.get(122562 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getMessageAsInput2(provider: ContractProvider, m: SetIdAndData) {
        const builder = new TupleBuilder();
        builder.writeTuple(storeTupleSetIdAndData(m));
        const source = (await provider.get(126625 as any, builder.build())).stack;
    ...
    async getContractAsInput(provider: ContractProvider, test: Test$Data) {
        ...
        const source = (await provider.get(125793 as any, builder.build())).stack;
        const result = loadGetterTupleTest$Data(source);
        return result;
    }
    ...
    async getMethodIdExpr(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(45032 as any, builder.build())).stack;
    ...
    async getMethodIdConst(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(16384 as any, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getMethodIdMin(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(-262144 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    ...
    async getMethodIdMax(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(262143 as any, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
