...
async function Test_init() {
    const __code = Cell.fromBase64(
        "te6ccgEBBgEAgQABFP8A9KQT9LzyyAsBAgFiAgMBktAB0HLXIdIA0gD6QCEQNFBmbwT4YQL4Yts8ApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbCfyH8BygABAYEBAc8Aye1U4DDywIIEAg+g+Q+2ebZ4YwQFACTtRNDSAAGXgQEB1wABMeAwgHsAAiA=",
    );
...
export class Test implements Contract {
    ...
    async getA(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(97415 as any, builder.build()))
            .stack;
