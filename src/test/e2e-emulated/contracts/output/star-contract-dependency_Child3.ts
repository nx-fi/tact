...
type Child3_init_args = {
    $$type: "Child3_init_args";
};

function initChild3_init_args(src: Child3_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const Child3_errors: { [key: number]: { message: string } } = {
...
const Child3_getters: ABIGetter[] = [];

export const Child3_getterMapping: { [key: string]: string } = {};

const Child3_receivers: ABIReceiver[] = [
    { receiver: "internal", message: { kind: "empty" } },
];

export class Child3 implements Contract {
    static async init() {
