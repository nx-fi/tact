...
async function Test_init() {
    const __code = Cell.fromBase64(
        "te6ccgEBBgEAdgABFP8A9KQT9LzyyAsBAgFiAgMBhtAB0HLXIdIA0gD6QCEQNFBmbwT4YQL4Yts8ApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbCZMMh/AcoAye1U4DDywIIEAg+hLYG2ebZ4YwQFABTtRNDSADCRbeBtAAj4J28Q",
    );
...
export class Test implements Contract {
    ...
    async getBalance(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(104128 as any, builder.build()))
            .stack;
