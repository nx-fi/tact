...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type SliceBouncedTester_init_args = {
    $$type: 'SliceBouncedTester_init_args';
}

function initSliceBouncedTester_init_args(src: SliceBouncedTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const SliceBouncedTester_errors: { [key: number]: { message: string } } = {
...
const SliceBouncedTester_types: ABIType[] = [
...
const SliceBouncedTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const SliceBouncedTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const SliceBouncedTester_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SendCellToAddress"}},
    {"receiver":"internal","message":{"kind":"text","text":"reset"}},
]


export class SliceBouncedTester implements Contract {
