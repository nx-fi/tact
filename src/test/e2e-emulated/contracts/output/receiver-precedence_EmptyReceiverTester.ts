...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyReceiverTester_init_args = {
    $$type: 'EmptyReceiverTester_init_args';
}

function initEmptyReceiverTester_init_args(src: EmptyReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}

async function EmptyReceiverTester_init() {
    const __code = Cell.fromBase64('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEmptyReceiverTester_init_args({ $$type: 'EmptyReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const EmptyReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyReceiverTester_types: ABIType[] = [
...
const EmptyReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyReceiverTester_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
    {"receiver":"external","message":{"kind":"empty"}},
]


export class EmptyReceiverTester implements Contract {
    
    public static readonly storageReserve = 0n;
    
    static async init() {
        return await EmptyReceiverTester_init();
    }
    
    static async fromInit() {
        const __gen_init = await EmptyReceiverTester_init();
        const address = contractAddress(0, __gen_init);
        return new EmptyReceiverTester(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new EmptyReceiverTester(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  EmptyReceiverTester_types,
        getters: EmptyReceiverTester_getters,
        receivers: EmptyReceiverTester_receivers,
        errors: EmptyReceiverTester_errors,
    };
    ...
    async sendExternal(provider: ContractProvider, message: null) {
