...
function dictValueParserAllBouncedTester$Data(): DictionaryValue<AllBouncedTester$Data> {
 ...
 type EmptyAndStringAndBinaryReceiverTester_init_args = {
    $$type: 'EmptyAndStringAndBinaryReceiverTester_init_args';
}

function initEmptyAndStringAndBinaryReceiverTester_init_args(src: EmptyAndStringAndBinaryReceiverTester_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
}
...
const EmptyAndStringAndBinaryReceiverTester_errors: { [key: number]: { message: string } } = {
...
const EmptyAndStringAndBinaryReceiverTester_types: ABIType[] = [
...
const EmptyAndStringAndBinaryReceiverTester_getters: ABIGetter[] = [
    {"name":"receiver","methodId":78947,"arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

export const EmptyAndStringAndBinaryReceiverTester_getterMapping: { [key: string]: string } = {
    'receiver': 'getReceiver',
}

const EmptyAndStringAndBinaryReceiverTester_receivers: ABIReceiver[] = [
...
export class EmptyAndStringAndBinaryReceiverTester implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | string | Message | Empty) {
    ...
    async sendExternal(provider: ContractProvider, message: Empty | null | string | Message) {
