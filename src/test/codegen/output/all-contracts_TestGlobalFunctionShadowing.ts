...
function initTestGlobalFunctionShadowing_init_args(
    src: TestGlobalFunctionShadowing_init_args,
) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
...
async function TestGlobalFunctionShadowing_init() {
    const __code = Cell.fromBase64(
        "te6ccgEBAwEAeAABFP8A9KQT9LzyyAsBAbjTAdBy1yHSANIA+kAhEDRQZm8E+GEC+GLbPAKRW+Ag10nCH5PTHzHe+QGC8Pk3KPTjji+n6p05GrWBpOnBhO/e7nnnfbOPAcB6HGJLupkwyH8BygDJ7VTgMPLAggIAFO1E0NIAMJFt4G0=",
    );
    const builder = beginCell();
    builder.storeUint(0, 1);
    initTestGlobalFunctionShadowing_init_args({
        $$type: "TestGlobalFunctionShadowing_init_args",
    })(builder);
...
export const TestGlobalFunctionShadowing_getterMapping: {
    [key: string]: string;
} = {};
