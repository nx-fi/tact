...
async function Example_init() {
    const __code = Cell.fromBase64(
        "te6ccgEBAwEAgwABFP8A9KQT9LzyyAsBAc7TAdBy1yHSANIA+kAhEDRQZm8E+GEC+GLbPAKRW+CAINcFb6NbIIIIEBAQupowMMh/AcoAye1U4CDAU5owMMh/AcoAye1U4CDALJowMMh/AcoAye1U4MAtmTDIfwHKAMntVOAw8sCCAgAU7UTQ0gAwkW3gbQ==",
    );
...
export class Example implements Contract {
    ...
    async send(
        ...
        message: Binary | Octal | Decimal | Hexadecimal,
    ) {
