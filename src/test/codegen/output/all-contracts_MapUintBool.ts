...
async function MapUintBool_init() {
    const __code = Cell.fromBase64('te6ccgEBBAEAoAABFP8A9KQT9LzyyAsBAvTTAdBy1yHSANIA+kAhEDRQZm8E+GEC+GLbPAKRW+BwIddJIMIflTEB0x8wkTLiwAABwSGwjkIggEBwcUEz9A5voZQB1wAwkltt4m7y5ACAQHB/cSFulVtZ9FswmMgBzwBBM/RD4oBAcFn0WzDIfwHKAAEB9ADJ7VTgMAIDABztRNDSAAGU9AQBMeAwbQAG8sCC');
