...
function initMutatingMethodOnNonLvalues_init_args(
    src: MutatingMethodOnNonLvalues_init_args,
) {
    return (builder: Builder) => {
        const b_0 = builder;
    };
...
async function MutatingMethodOnNonLvalues_init() {
    const __code = Cell.fromBase64(
        "te6ccgEBBwEAmwABFP8A9KQT9LzyyAsBAqbTAdBy1yHSANIA+kAhEDRQZm8E+GEC+GLbPAKRW+Ag10nCH5PTHzHe+QGC8Pk3KPTjji+n6p05GrWBpOnBhO/e7nnnfbOPAcB6HGJLuuMCMPLAggIDABTtRNDSADCRbeBtBByAKds8gCrbPIAr2zyALAUFBQQBFts8MMh/AcoAye1UBQEG2zwwBgACpA==",
    );
    const builder = beginCell();
    builder.storeUint(0, 1);
    initMutatingMethodOnNonLvalues_init_args({
        $$type: "MutatingMethodOnNonLvalues_init_args",
    })(builder);
...
export const MutatingMethodOnNonLvalues_getterMapping: {
    [key: string]: string;
} = {};
