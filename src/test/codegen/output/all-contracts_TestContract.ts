...
async function TestContract_init() {
    const __code = Cell.fromBase64(
        "te6ccgEBCQEAZgABFP8A9KQT9LzyyAsBAgFiAgMBPtAw0HLXIdIA0gD6QCEQNFBVbwT4YQH4Yts8MNzywIIHAgEgBAUCEb3CxtngDtnhjAcGAhG99V7Z4A7Z4YwHCAACbgAU7UTQ0gAwkW3gbQAEbrM=",
    );
...
const TestContract_getters: ABIGetter[] = [
    {
        ...
        methodId: 79960,
        arguments: [
            { name: "s", type: { kind: "dict", key: "int", value: "int" } },
        ],
...
export class TestContract implements Contract {
    ...
    async getTestEq(provider: ContractProvider, s: Dictionary<bigint, bigint>) {
        ...
        const source = (await provider.get(79960 as any, builder.build()))
            .stack;
    ...
    async getTestNeq(
        ...
        const source = (await provider.get(114347 as any, builder.build()))
            .stack;
        const result = source.readBoolean();
        return result;
    }
