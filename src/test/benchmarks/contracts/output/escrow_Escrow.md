...
TL-B: `update_jetton_wallet_code#1d5a120d newJettonWalletCode:^cell = UpdateJettonWalletCode`
...
* 5357: low msg value
* 14215: not funded
* 15301: wrong fund amount
* 21150: not guarantor
* 33704: already funded
* 37726: notification not from escrow jetton wallet
* 48761: empty jetton wallet code
* 52368: wrong asset type
* 63374: only seller can change wallet code
