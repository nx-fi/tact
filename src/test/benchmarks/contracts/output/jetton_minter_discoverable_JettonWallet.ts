...
const JettonWallet_receivers: ABIReceiver[] = [
    {
        receiver: "internal",
        message: { kind: "typed", type: "JettonTransfer" },
    },
    {
        receiver: "internal",
        message: { kind: "typed", type: "JettonTransferInternal" },
    },
...
export class JettonWallet implements Contract {
    ...
    async send(
        ...
        message: JettonTransfer | JettonTransferInternal | JettonBurn,
    ) {
        ...
        if (
            ...
            typeof message === "object" &&
            !(message instanceof Slice) &&
            message.$$type === "JettonTransferInternal"
        ) {
            body = beginCell()
                .store(storeJettonTransferInternal(message))
                .endCell();
        }
        if (
            message &&
