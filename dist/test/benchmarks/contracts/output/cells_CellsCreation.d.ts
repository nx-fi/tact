...
export declare function storeCellsCreation$Data(src: CellsCreation$Data): (builder: Builder) => void;
export declare function loadCellsCreation$Data(slice: Slice): {
    $$type: "CellsCreation$Data";
};
export declare const CellsCreation_getterMapping: {
    [key: string]: string;
};
export declare class CellsCreation implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CellsCreation>;
    static fromAddress(address: Address): CellsCreation;
    ...
    getEmptyCell(provider: ContractProvider): Promise<Cell>;
    getEmptySlice(provider: ContractProvider): Promise<Slice>;
}
