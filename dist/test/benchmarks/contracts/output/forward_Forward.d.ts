...
export declare function storeTestGetFwdFee(src: TestGetFwdFee): (builder: Builder) => void;
export declare function loadTestGetFwdFee(slice: Slice): {
    $$type: "TestGetFwdFee";
    any: Slice;
};
...
export declare function storeForward$Data(src: Forward$Data): (builder: Builder) => void;
export declare function loadForward$Data(slice: Slice): {
    $$type: "Forward$Data";
};
export declare const Forward_getterMapping: {
    [key: string]: string;
};
export declare class Forward implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Forward>;
    static fromAddress(address: Address): Forward;
    ...
    }, message: TestGetFwdFee): Promise<void>;
}
