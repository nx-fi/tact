...
export declare function storeHashData(src: HashData): (builder: Builder) => void;
export declare function loadHashData(slice: Slice): {
    $$type: "HashData";
    value: string;
};
...
export declare function storeSha256AsSlice$Data(src: Sha256AsSlice$Data): (builder: Builder) => void;
export declare function loadSha256AsSlice$Data(slice: Slice): {
    $$type: "Sha256AsSlice$Data";
    result: bigint;
};
export declare const Sha256AsSlice_getterMapping: {
    [key: string]: string;
};
export declare class Sha256AsSlice implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Sha256AsSlice>;
    static fromAddress(address: Address): Sha256AsSlice;
    ...
    }, message: null | HashData): Promise<void>;
    getRes(provider: ContractProvider): Promise<bigint>;
}
