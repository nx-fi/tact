...
export declare function storeSha256Small$Data(src: Sha256Small$Data): (builder: Builder) => void;
export declare function loadSha256Small$Data(slice: Slice): {
    $$type: "Sha256Small$Data";
    result: bigint;
};
export declare const Sha256Small_getterMapping: {
    [key: string]: string;
};
export declare class Sha256Small implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Sha256Small>;
    static fromAddress(address: Address): Sha256Small;
