...
export declare const WithoutDeploy_getterMapping: {
    [key: string]: string;
};
export declare class WithoutDeploy implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<WithoutDeploy>;
    static fromAddress(address: Address): WithoutDeploy;
