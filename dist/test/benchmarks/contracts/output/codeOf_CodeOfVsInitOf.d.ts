...
export declare function storeCodeOfVsInitOf$Data(src: CodeOfVsInitOf$Data): (builder: Builder) => void;
export declare function loadCodeOfVsInitOf$Data(slice: Slice): {
    $$type: "CodeOfVsInitOf$Data";
};
...
export declare const CodeOfVsInitOf_getterMapping: {
    [key: string]: string;
};
export declare class CodeOfVsInitOf implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CodeOfVsInitOf>;
    static fromAddress(address: Address): CodeOfVsInitOf;
    ...
    getWithCodeOf(provider: ContractProvider): Promise<Cell>;
    getWithInitOf(provider: ContractProvider): Promise<Cell>;
    getCodeOfSelf(provider: ContractProvider): Promise<Cell>;
