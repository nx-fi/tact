...
exports.JettonMinter = exports.JettonMinter_getterMapping = void 0;
...
async function JettonMinter_init(owner, jettonContent) {
...
class JettonMinter {
    static async init(owner, jettonContent) {
        return await JettonMinter_init(owner, jettonContent);
    }
    static async fromInit(owner, jettonContent) {
