...
exports.JettonMinter = exports.Workchain = exports.ProvideAddressGasConsumption = exports.JettonMinter_getterMapping = void 0;
...
exports.storeJettonMasterState = storeJettonMasterState;
exports.loadJettonMasterState = loadJettonMasterState;
exports.storeJettonMinter$Data = storeJettonMinter$Data;
exports.loadJettonMinter$Data = loadJettonMinter$Data;
...
function storeJettonMasterState(src) {
    return (builder) => {
        const b_0 = builder;
...
function loadJettonMasterState(slice) {
    const sc_0 = slice;
    ...
    const _jettonWalletCode = sc_0.loadRef();
    return { $$type: 'JettonMasterState', totalSupply: _totalSupply, mintable: _mintable, adminAddress: _adminAddress, jettonContent: _jettonContent, jettonWalletCode: _jettonWalletCode };
}
function loadTupleJettonMasterState(source) {
    const _totalSupply = source.readBigNumber();
    const _mintable = source.readBoolean();
...
function loadGetterTupleJettonMasterState(source) {
    const _totalSupply = source.readBigNumber();
    const _mintable = source.readBoolean();
    const _adminAddress = source.readAddress();
    const _jettonContent = source.readCell();
...
function storeTupleJettonMasterState(source) {
    const builder = new core_1.TupleBuilder();
    builder.writeNumber(source.totalSupply);
    builder.writeBoolean(source.mintable);
...
function dictValueParserJettonMasterState() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeJettonMasterState(src)).endCell());
        },
        parse: (src) => {
...
function storeJettonMinter$Data(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeCoins(src.totalSupply);
        b_0.storeAddress(src.owner);
...
function loadJettonMinter$Data(slice) {
    const sc_0 = slice;
    const _totalSupply = sc_0.loadCoins();
    const _owner = sc_0.loadAddress();
    const _jettonContent = sc_0.loadRef();
    return { $$type: 'JettonMinter$Data', totalSupply: _totalSupply, owner: _owner, jettonContent: _jettonContent };
}
function loadTupleJettonMinter$Data(source) {
    const _totalSupply = source.readBigNumber();
    const _owner = source.readAddress();
    const _jettonContent = source.readCell();
    return { $$type: 'JettonMinter$Data', totalSupply: _totalSupply, owner: _owner, jettonContent: _jettonContent };
}
function loadGetterTupleJettonMinter$Data(source) {
    const _totalSupply = source.readBigNumber();
    const _owner = source.readAddress();
    const _jettonContent = source.readCell();
    return { $$type: 'JettonMinter$Data', totalSupply: _totalSupply, owner: _owner, jettonContent: _jettonContent };
}
function storeTupleJettonMinter$Data(source) {
    const builder = new core_1.TupleBuilder();
    builder.writeNumber(source.totalSupply);
    builder.writeAddress(source.owner);
    builder.writeCell(source.jettonContent);
...
function dictValueParserJettonMinter$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeJettonMinter$Data(src)).endCell());
        },
        parse: (src) => {
...
function initJettonMinter_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeCoins(src.totalSupply);
        b_0.storeAddress(src.owner);
...
async function JettonMinter_init(totalSupply, owner, jettonContent) {
...
exports.ProvideAddressGasConsumption = 10000000n;
exports.Workchain = 0n;
class JettonMinter {
    static minTonsForStorage = 10000000n;
    static gasConsumption = 15000000n;
    static storageReserve = 0n;
    static async init(totalSupply, owner, jettonContent) {
        return await JettonMinter_init(totalSupply, owner, jettonContent);
    }
    static async fromInit(totalSupply, owner, jettonContent) {
    ...
    async send(provider, via, args, message) {
        ...
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'JettonUpdateContent') {
            body = (0, core_1.beginCell)().store(storeJettonUpdateContent(message)).endCell();
        }
    ...
    async getGetWalletAddress(provider, ownerAddress) {
        const builder = new core_1.TupleBuilder();
