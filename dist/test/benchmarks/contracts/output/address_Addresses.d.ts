...
export declare function storeAddresses$Data(src: Addresses$Data): (builder: Builder) => void;
export declare function loadAddresses$Data(slice: Slice): {
    $$type: "Addresses$Data";
};
export declare const Addresses_getterMapping: {
    [key: string]: string;
};
export declare class Addresses implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Addresses>;
    static fromAddress(address: Address): Addresses;
    ...
    getContractAddressExt(provider: ContractProvider): Promise<Address>;
}
