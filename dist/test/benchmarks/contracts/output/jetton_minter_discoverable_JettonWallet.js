...
exports.JettonWallet = exports.Workchain = exports.ProvideAddressGasConsumption = exports.JettonWallet_getterMapping = void 0;
...
async function JettonWallet_init(balance, owner, master) {
...
class JettonWallet {
    ...
    static async init(balance, owner, master) {
        return await JettonWallet_init(balance, owner, master);
    }
    static async fromInit(balance, owner, master) {
