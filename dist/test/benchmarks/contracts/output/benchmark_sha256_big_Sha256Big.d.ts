...
export declare function storeSha256Big$Data(src: Sha256Big$Data): (builder: Builder) => void;
export declare function loadSha256Big$Data(slice: Slice): {
    $$type: "Sha256Big$Data";
    result: bigint;
};
export declare const Sha256Big_getterMapping: {
    [key: string]: string;
};
export declare class Sha256Big implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Sha256Big>;
    static fromAddress(address: Address): Sha256Big;
