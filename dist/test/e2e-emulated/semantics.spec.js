...
const semantics_SemanticsTester_1 = require("./contracts/output/semantics_SemanticsTester");
...
describe("semantics", () => {
    ...
    beforeEach(async () => {
        ...
        contract = blockchain.openContract(await semantics_SemanticsTester_1.SemanticsTester.fromInit());
    ...
    it("should implement semantics correctly", async () => {
        // Check methods
        expect(await contract.getCheckAllContractFieldsAreUnchanged()).toEqual(true);
        // Structs
        ...
        expect(await contract.getTernaryInfiniteLoopShortCircuit()).toEqual(true);
        ...
        const mutateResult = await contract.send(treasure.getSender(), { value: (0, core_1.toNano)("10") }, "mutate");
        ...
        expect(await contract.getTestInversesParseStdAddressAndNewAddress()).toEqual(true);
