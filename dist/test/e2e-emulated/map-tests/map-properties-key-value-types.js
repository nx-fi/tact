...
exports.valTypes = exports.keyTypes = void 0;
const intSizes = [8, 42, 257];
const uintSizes = [9, 32, 256];
const ints = intSizes.map((size) => ({
    type: `Int as int${size}`,
    _1: "-5n",
    _2: "42n",
}));
const uints = uintSizes.map((size) => ({
...
exports.keyTypes = ints.concat(uints, [address]);
exports.valTypes = allInts.concat(otherValueTypes, [address]);
