...
const key = {
    $$type: "KeyData",
    _1: (0, core_1.address)("UQBKgXCNLPexWhs2L79kiARR1phGH1LwXxRbNsCFF9doczSI"),
    _2: new core_1.Address(0, Buffer.alloc(32, 0)),
};
const val = {
    $$type: "ValData",
    _1: { $$type: 'SomeStruct', i: -321n, b: false, a: new core_1.Address(0, Buffer.alloc(32, 0)), u1: 10n, u2: 20n },
    _2: { $$type: 'SomeStruct', i: -322n, b: true, a: new core_1.Address(0, Buffer.alloc(32, 1)), u1: 101n, u2: 202n },
};
let contract;
beforeAll(async () => {
