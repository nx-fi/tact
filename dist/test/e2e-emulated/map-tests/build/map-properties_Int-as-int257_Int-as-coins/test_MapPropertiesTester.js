...
function storeValData(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeCoins(src._1);
        b_0.storeCoins(src._2);
    };
}
function loadValData(slice) {
    const sc_0 = slice;
    const __1 = sc_0.loadCoins();
    const __2 = sc_0.loadCoins();
...
const MapPropertiesTester_types = [
    ...
    { "name": "ValData", "header": null, "fields": [{ "name": "_1", "type": { "kind": "simple", "type": "uint", "optional": false, "format": "coins" } }, { "name": "_2", "type": { "kind": "simple", "type": "uint", "optional": false, "format": "coins" } }] },
