...
exports.C7gt = exports.C7gt_getterMapping = void 0;
...
function initC7gt_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeInt(src.v, 257);
    };
}
async function C7gt_init(v) {
    const __code = core_1.Cell.fromBase64('te6ccgEBAwEAbgABhv8AII41MDDQctch0gDSAPpAIRA0UFVvBPhhAfhi7UTQ0gABl4EBAdcAATGYgQEB1wABAdHiMNzywILh9KQT9LzyyAsBAT+mbL27UTQ0gABl4EBAdcAATGYgQEB1wABAdHiAds8MYAIABlIQoA==');
...
exports.C7gt_getterMapping = {
    'incrAndGetField1': 'getIncrAndGetField1',
};
const C7gt_receivers = [];
class C7gt {
    ...
    async getIncrAndGetField1(provider, t) {
        const builder = new core_1.TupleBuilder();
