...
exports.ConstantTester = exports.ConstantTester_getterMapping = void 0;
...
function loadConstantTester$Data(slice) {
    const sc_0 = slice;
    const _value = sc_0.loadIntBig(257);
    return { $$type: 'ConstantTester$Data', value: _value };
}
...
class ConstantTester {
    ...
    async getB(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(85220, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getC2(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(84072, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    ...
    async getTraitB(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(105663, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getTraitC2(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(120853, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
}
