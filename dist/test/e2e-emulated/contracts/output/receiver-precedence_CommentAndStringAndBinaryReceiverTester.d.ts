...
export declare const CommentAndStringAndBinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentAndStringAndBinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentAndStringAndBinaryReceiverTester>;
    static fromAddress(address: Address): CommentAndStringAndBinaryReceiverTester;
    ...
    }, message: "message" | string | Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | 'message' | string | Message): Promise<void>;
