...
export declare function storeBaseTraitsFunctionContract$Data(src: BaseTraitsFunctionContract$Data): (builder: Builder) => void;
export declare function loadBaseTraitsFunctionContract$Data(slice: Slice): {
    $$type: "BaseTraitsFunctionContract$Data";
    value: bigint;
};
export declare const BaseTraitsFunctionContract_getterMapping: {
    [key: string]: string;
};
export declare class BaseTraitsFunctionContract implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<BaseTraitsFunctionContract>;
    static fromAddress(address: Address): BaseTraitsFunctionContract;
