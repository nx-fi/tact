...
export declare const AllBouncedTester_getterMapping: {
    [key: string]: string;
};
export declare class AllBouncedTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<AllBouncedTester>;
    static fromAddress(address: Address): AllBouncedTester;
