...
export declare function storeSampleUpgradeContractV3$Data(src: SampleUpgradeContractV3$Data): (builder: Builder) => void;
export declare function loadSampleUpgradeContractV3$Data(slice: Slice): {
    $$type: "SampleUpgradeContractV3$Data";
    _version: bigint;
    owner: Address;
    counter: bigint;
};
export declare const SampleUpgradeContractV3_getterMapping: {
    [key: string]: string;
};
export declare class SampleUpgradeContractV3 implements Contract {
    static readonly storageReserve = 0n;
    static init(owner: Address): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address): Promise<SampleUpgradeContractV3>;
    static fromAddress(address: Address): SampleUpgradeContractV3;
    ...
    }, message: null | "increment" | "decrement" | Upgrade): Promise<void>;
