...
export declare const Child2_getterMapping: {
    [key: string]: string;
};
export declare class Child2 implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child2>;
    static fromAddress(address: Address): Child2;
