...
export declare const EmptyAndCommentAndBinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndCommentAndBinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndCommentAndBinaryReceiverTester>;
    static fromAddress(address: Address): EmptyAndCommentAndBinaryReceiverTester;
    ...
    }, message: null | "message" | Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | 'message' | Message): Promise<void>;
