...
exports.StringAndSliceReceiverTester = exports.StringAndSliceReceiverTester_getterMapping = void 0;
...
function initStringAndSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function StringAndSliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initStringAndSliceReceiverTester_init_args({ $$type: 'StringAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const StringAndSliceReceiverTester_errors = {
...
const StringAndSliceReceiverTester_types = [
...
const StringAndSliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.StringAndSliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const StringAndSliceReceiverTester_receivers = [
...
class StringAndSliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await StringAndSliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await StringAndSliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new StringAndSliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new StringAndSliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: StringAndSliceReceiverTester_types,
        getters: StringAndSliceReceiverTester_getters,
        receivers: StringAndSliceReceiverTester_receivers,
        errors: StringAndSliceReceiverTester_errors,
    };
...
exports.StringAndSliceReceiverTester = StringAndSliceReceiverTester;
