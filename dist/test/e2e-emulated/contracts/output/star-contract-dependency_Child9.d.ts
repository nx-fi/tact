...
export declare const Child9_getterMapping: {
    [key: string]: string;
};
export declare class Child9 implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child9>;
    static fromAddress(address: Address): Child9;
