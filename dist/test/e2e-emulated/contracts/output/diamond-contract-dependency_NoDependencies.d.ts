...
export declare const NoDependencies_getterMapping: {
    [key: string]: string;
};
export declare class NoDependencies implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<NoDependencies>;
    static fromAddress(address: Address): NoDependencies;
