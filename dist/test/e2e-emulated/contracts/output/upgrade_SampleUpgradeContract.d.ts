...
export declare function storeSampleUpgradeContract$Data(src: SampleUpgradeContract$Data): (builder: Builder) => void;
export declare function loadSampleUpgradeContract$Data(slice: Slice): {
    $$type: "SampleUpgradeContract$Data";
    _version: bigint;
    owner: Address;
    counter: bigint;
};
export declare const SampleUpgradeContract_getterMapping: {
    [key: string]: string;
};
export declare class SampleUpgradeContract implements Contract {
    static readonly storageReserve = 0n;
    static init(owner: Address): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address): Promise<SampleUpgradeContract>;
    static fromAddress(address: Address): SampleUpgradeContract;
