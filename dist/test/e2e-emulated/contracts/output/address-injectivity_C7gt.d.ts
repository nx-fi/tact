...
export declare const C7gt_getterMapping: {
    [key: string]: string;
};
export declare class C7gt implements Contract {
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C7gt>;
    static fromAddress(address: Address): C7gt;
    ...
    private constructor();
    getIncrAndGetField1(provider: ContractProvider, t: bigint): Promise<bigint>;
}
