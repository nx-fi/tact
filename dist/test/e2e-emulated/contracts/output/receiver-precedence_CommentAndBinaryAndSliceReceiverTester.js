...
exports.CommentAndBinaryAndSliceReceiverTester = exports.CommentAndBinaryAndSliceReceiverTester_getterMapping = void 0;
...
function initCommentAndBinaryAndSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function CommentAndBinaryAndSliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initCommentAndBinaryAndSliceReceiverTester_init_args({ $$type: 'CommentAndBinaryAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const CommentAndBinaryAndSliceReceiverTester_errors = {
...
const CommentAndBinaryAndSliceReceiverTester_types = [
...
const CommentAndBinaryAndSliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.CommentAndBinaryAndSliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const CommentAndBinaryAndSliceReceiverTester_receivers = [
...
class CommentAndBinaryAndSliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await CommentAndBinaryAndSliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await CommentAndBinaryAndSliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new CommentAndBinaryAndSliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new CommentAndBinaryAndSliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: CommentAndBinaryAndSliceReceiverTester_types,
        getters: CommentAndBinaryAndSliceReceiverTester_getters,
        receivers: CommentAndBinaryAndSliceReceiverTester_receivers,
        errors: CommentAndBinaryAndSliceReceiverTester_errors,
    };
...
exports.CommentAndBinaryAndSliceReceiverTester = CommentAndBinaryAndSliceReceiverTester;
