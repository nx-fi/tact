...
export declare const C1_getterMapping: {
    [key: string]: string;
};
export declare class C1 implements Contract {
    static readonly storageReserve = 0n;
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C1>;
    static fromAddress(address: Address): C1;
