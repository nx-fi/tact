...
exports.BinaryAndSliceReceiverTester = exports.BinaryAndSliceReceiverTester_getterMapping = void 0;
...
function initBinaryAndSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function BinaryAndSliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initBinaryAndSliceReceiverTester_init_args({ $$type: 'BinaryAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const BinaryAndSliceReceiverTester_errors = {
...
const BinaryAndSliceReceiverTester_types = [
...
const BinaryAndSliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.BinaryAndSliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const BinaryAndSliceReceiverTester_receivers = [
...
class BinaryAndSliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await BinaryAndSliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await BinaryAndSliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new BinaryAndSliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new BinaryAndSliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: BinaryAndSliceReceiverTester_types,
        getters: BinaryAndSliceReceiverTester_getters,
        receivers: BinaryAndSliceReceiverTester_receivers,
        errors: BinaryAndSliceReceiverTester_errors,
    };
...
exports.BinaryAndSliceReceiverTester = BinaryAndSliceReceiverTester;
