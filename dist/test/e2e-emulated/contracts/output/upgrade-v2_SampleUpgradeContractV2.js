...
exports.SampleUpgradeContractV2 = exports.SampleUpgradeContractV2_getterMapping = void 0;
...
exports.storeSampleUpgradeContractV2$Data = storeSampleUpgradeContractV2$Data;
exports.loadSampleUpgradeContractV2$Data = loadSampleUpgradeContractV2$Data;
...
function storeSampleUpgradeContractV2$Data(src) {
    return (builder) => {
        const b_0 = builder;
...
function loadSampleUpgradeContractV2$Data(slice) {
    const sc_0 = slice;
    const __version = sc_0.loadUintBig(32);
    const _owner = sc_0.loadAddress();
    const _counter = sc_0.loadUintBig(32);
    return { $$type: 'SampleUpgradeContractV2$Data', _version: __version, owner: _owner, counter: _counter };
}
function loadTupleSampleUpgradeContractV2$Data(source) {
    const __version = source.readBigNumber();
    const _owner = source.readAddress();
    const _counter = source.readBigNumber();
    return { $$type: 'SampleUpgradeContractV2$Data', _version: __version, owner: _owner, counter: _counter };
}
function loadGetterTupleSampleUpgradeContractV2$Data(source) {
    const __version = source.readBigNumber();
    const _owner = source.readAddress();
    const _counter = source.readBigNumber();
    return { $$type: 'SampleUpgradeContractV2$Data', _version: __version, owner: _owner, counter: _counter };
}
function storeTupleSampleUpgradeContractV2$Data(source) {
    const builder = new core_1.TupleBuilder();
...
function dictValueParserSampleUpgradeContractV2$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeSampleUpgradeContractV2$Data(src)).endCell());
        },
        parse: (src) => {
...
function initSampleUpgradeContractV2_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
    };
}
async function SampleUpgradeContractV2_init(owner) {
...
const SampleUpgradeContractV2_errors = {
...
const SampleUpgradeContractV2_types = [
...
const SampleUpgradeContractV2_getters = [
...
exports.SampleUpgradeContractV2 = SampleUpgradeContractV2;
