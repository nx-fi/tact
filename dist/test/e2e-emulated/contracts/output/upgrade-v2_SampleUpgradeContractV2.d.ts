...
export declare function storeSampleUpgradeContractV2$Data(src: SampleUpgradeContractV2$Data): (builder: Builder) => void;
export declare function loadSampleUpgradeContractV2$Data(slice: Slice): {
    $$type: "SampleUpgradeContractV2$Data";
    _version: bigint;
    owner: Address;
    counter: bigint;
};
export declare const SampleUpgradeContractV2_getterMapping: {
    [key: string]: string;
};
export declare class SampleUpgradeContractV2 implements Contract {
    static readonly storageReserve = 0n;
    static init(owner: Address): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address): Promise<SampleUpgradeContractV2>;
    static fromAddress(address: Address): SampleUpgradeContractV2;
    ...
    }, message: null | "increment" | Upgrade): Promise<void>;
