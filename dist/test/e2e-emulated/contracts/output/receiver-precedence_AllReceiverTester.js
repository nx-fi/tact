...
exports.AllReceiverTester = exports.AllReceiverTester_getterMapping = void 0;
...
function initAllReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function AllReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initAllReceiverTester_init_args({ $$type: 'AllReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const AllReceiverTester_errors = {
...
const AllReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.AllReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const AllReceiverTester_receivers = [
...
class AllReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await AllReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await AllReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new AllReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new AllReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: AllReceiverTester_types,
        getters: AllReceiverTester_getters,
        receivers: AllReceiverTester_receivers,
        errors: AllReceiverTester_errors,
    };
...
exports.AllReceiverTester = AllReceiverTester;
