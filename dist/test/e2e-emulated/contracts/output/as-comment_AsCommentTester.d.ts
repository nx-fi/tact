...
export declare function storeAsCommentTester$Data(src: AsCommentTester$Data): (builder: Builder) => void;
export declare function loadAsCommentTester$Data(slice: Slice): {
    $$type: "AsCommentTester$Data";
};
export declare const AsCommentTester_getterMapping: {
    [key: string]: string;
};
export declare const ConstantCell: Cell;
export declare class AsCommentTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<AsCommentTester>;
    static fromAddress(address: Address): AsCommentTester;
    ...
    getConstantCell(provider: ContractProvider): Promise<Cell>;
    getAsCommentRuntimeCell(provider: ContractProvider, val: string): Promise<Cell>;
}
