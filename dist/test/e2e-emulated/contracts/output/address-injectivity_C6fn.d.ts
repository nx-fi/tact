...
export declare const C6fn_getterMapping: {
    [key: string]: string;
};
export declare class C6fn implements Contract {
    static readonly storageReserve = 0n;
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C6fn>;
    static fromAddress(address: Address): C6fn;
