...
export declare const EmptyAndCommentAndBinaryAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndCommentAndBinaryAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndCommentAndBinaryAndSliceReceiverTester>;
    static fromAddress(address: Address): EmptyAndCommentAndBinaryAndSliceReceiverTester;
    ...
    }, message: null | "message" | Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | 'message' | Message | Slice): Promise<void>;
