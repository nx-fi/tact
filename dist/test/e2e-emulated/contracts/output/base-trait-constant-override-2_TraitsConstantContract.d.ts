...
export declare function storeTraitsConstantContract$Data(src: TraitsConstantContract$Data): (builder: Builder) => void;
export declare function loadTraitsConstantContract$Data(slice: Slice): {
    $$type: "TraitsConstantContract$Data";
};
export declare const TraitsConstantContract_getterMapping: {
    [key: string]: string;
};
export declare class TraitsConstantContract implements Contract {
    static readonly storageReserve = 10000n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<TraitsConstantContract>;
    static fromAddress(address: Address): TraitsConstantContract;
    ...
    getConstant(provider: ContractProvider): Promise<bigint>;
}
