...
export declare const StringReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class StringReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<StringReceiverTester>;
    static fromAddress(address: Address): StringReceiverTester;
    ...
    sendExternal(provider: ContractProvider, message: string): Promise<void>;
