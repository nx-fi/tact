...
exports.CommentAndBinaryReceiverTester = exports.CommentAndBinaryReceiverTester_getterMapping = void 0;
...
function initCommentAndBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function CommentAndBinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initCommentAndBinaryReceiverTester_init_args({ $$type: 'CommentAndBinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const CommentAndBinaryReceiverTester_errors = {
...
const CommentAndBinaryReceiverTester_types = [
...
const CommentAndBinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.CommentAndBinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const CommentAndBinaryReceiverTester_receivers = [
...
class CommentAndBinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await CommentAndBinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await CommentAndBinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new CommentAndBinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new CommentAndBinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: CommentAndBinaryReceiverTester_types,
        getters: CommentAndBinaryReceiverTester_getters,
        receivers: CommentAndBinaryReceiverTester_receivers,
        errors: CommentAndBinaryReceiverTester_errors,
    };
...
exports.CommentAndBinaryReceiverTester = CommentAndBinaryReceiverTester;
