...
exports.EmptyAndStringAndBinaryReceiverTester = exports.EmptyAndStringAndBinaryReceiverTester_getterMapping = void 0;
...
function initEmptyAndStringAndBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function EmptyAndStringAndBinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initEmptyAndStringAndBinaryReceiverTester_init_args({ $$type: 'EmptyAndStringAndBinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const EmptyAndStringAndBinaryReceiverTester_errors = {
...
const EmptyAndStringAndBinaryReceiverTester_types = [
...
const EmptyAndStringAndBinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.EmptyAndStringAndBinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const EmptyAndStringAndBinaryReceiverTester_receivers = [
...
class EmptyAndStringAndBinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await EmptyAndStringAndBinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await EmptyAndStringAndBinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new EmptyAndStringAndBinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new EmptyAndStringAndBinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: EmptyAndStringAndBinaryReceiverTester_types,
        getters: EmptyAndStringAndBinaryReceiverTester_getters,
        receivers: EmptyAndStringAndBinaryReceiverTester_receivers,
        errors: EmptyAndStringAndBinaryReceiverTester_errors,
    };
...
exports.EmptyAndStringAndBinaryReceiverTester = EmptyAndStringAndBinaryReceiverTester;
