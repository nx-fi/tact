...
export declare const Child1_getterMapping: {
    [key: string]: string;
};
export declare class Child1 implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child1>;
    static fromAddress(address: Address): Child1;
