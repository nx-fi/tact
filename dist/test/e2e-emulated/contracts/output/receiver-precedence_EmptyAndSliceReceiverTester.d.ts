...
export declare const EmptyAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndSliceReceiverTester>;
    static fromAddress(address: Address): EmptyAndSliceReceiverTester;
    ...
    }, message: null | Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: null | Slice): Promise<void>;
