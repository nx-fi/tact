...
export declare const CommentAndBinaryAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentAndBinaryAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentAndBinaryAndSliceReceiverTester>;
    static fromAddress(address: Address): CommentAndBinaryAndSliceReceiverTester;
    ...
    }, message: "message" | Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | 'message' | Message | Slice): Promise<void>;
