...
export declare const Child3_getterMapping: {
    [key: string]: string;
};
export declare class Child3 implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child3>;
    static fromAddress(address: Address): Child3;
