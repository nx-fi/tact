...
exports.EmptyAndBinaryReceiverTester = exports.EmptyAndBinaryReceiverTester_getterMapping = void 0;
...
function initEmptyAndBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function EmptyAndBinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initEmptyAndBinaryReceiverTester_init_args({ $$type: 'EmptyAndBinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const EmptyAndBinaryReceiverTester_errors = {
...
const EmptyAndBinaryReceiverTester_types = [
...
const EmptyAndBinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.EmptyAndBinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const EmptyAndBinaryReceiverTester_receivers = [
...
class EmptyAndBinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await EmptyAndBinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await EmptyAndBinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new EmptyAndBinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new EmptyAndBinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: EmptyAndBinaryReceiverTester_types,
        getters: EmptyAndBinaryReceiverTester_getters,
        receivers: EmptyAndBinaryReceiverTester_receivers,
        errors: EmptyAndBinaryReceiverTester_errors,
    };
...
exports.EmptyAndBinaryReceiverTester = EmptyAndBinaryReceiverTester;
