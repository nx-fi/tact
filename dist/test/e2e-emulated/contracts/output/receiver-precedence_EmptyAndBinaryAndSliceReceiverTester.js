...
exports.EmptyAndBinaryAndSliceReceiverTester = exports.EmptyAndBinaryAndSliceReceiverTester_getterMapping = void 0;
...
function initEmptyAndBinaryAndSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function EmptyAndBinaryAndSliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initEmptyAndBinaryAndSliceReceiverTester_init_args({ $$type: 'EmptyAndBinaryAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const EmptyAndBinaryAndSliceReceiverTester_errors = {
...
const EmptyAndBinaryAndSliceReceiverTester_types = [
...
const EmptyAndBinaryAndSliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.EmptyAndBinaryAndSliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const EmptyAndBinaryAndSliceReceiverTester_receivers = [
...
class EmptyAndBinaryAndSliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await EmptyAndBinaryAndSliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await EmptyAndBinaryAndSliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new EmptyAndBinaryAndSliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new EmptyAndBinaryAndSliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: EmptyAndBinaryAndSliceReceiverTester_types,
        getters: EmptyAndBinaryAndSliceReceiverTester_getters,
        receivers: EmptyAndBinaryAndSliceReceiverTester_receivers,
        errors: EmptyAndBinaryAndSliceReceiverTester_errors,
    };
...
exports.EmptyAndBinaryAndSliceReceiverTester = EmptyAndBinaryAndSliceReceiverTester;
