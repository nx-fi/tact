...
async function Test_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBBgEAgQABFP8A9KQT9LzyyAsBAgFiAgMBktAB0HLXIdIA0gD6QCEQNFBmbwT4YQL4Yts8ApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbCfyH8BygABAYEBAc8Aye1U4DDywIIEAg+g+Q+2ebZ4YwQFACTtRNDSAAGXgQEB1wABMeAwgHsAAiA=');
...
class Test {
    ...
    async getA(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(97415, builder.build())).stack;
