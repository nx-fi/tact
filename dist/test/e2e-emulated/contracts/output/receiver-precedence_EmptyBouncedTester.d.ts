...
export declare const EmptyBouncedTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyBouncedTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyBouncedTester>;
    static fromAddress(address: Address): EmptyBouncedTester;
