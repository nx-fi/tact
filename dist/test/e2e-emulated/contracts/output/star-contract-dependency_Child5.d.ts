...
export declare const Child5_getterMapping: {
    [key: string]: string;
};
export declare class Child5 implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child5>;
    static fromAddress(address: Address): Child5;
    ...
    getGetParent(provider: ContractProvider): Promise<{
        $$type: "StateInit";
        code: Cell;
        data: Cell;
    }>;
