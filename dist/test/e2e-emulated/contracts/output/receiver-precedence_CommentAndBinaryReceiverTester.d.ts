...
export declare const CommentAndBinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentAndBinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentAndBinaryReceiverTester>;
    static fromAddress(address: Address): CommentAndBinaryReceiverTester;
    ...
    }, message: "message" | Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | 'message' | Message): Promise<void>;
