...
export declare const StringAndBinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class StringAndBinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<StringAndBinaryReceiverTester>;
    static fromAddress(address: Address): StringAndBinaryReceiverTester;
    ...
    }, message: string | Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | string | Message): Promise<void>;
