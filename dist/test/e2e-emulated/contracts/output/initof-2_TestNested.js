...
exports.TestNested = exports.TestNested_getterMapping = void 0;
...
function initTestNested_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function TestNested_init() {
    const __code = core_1.Cell.fromBase64('');
...
const TestNested_getters = [];
exports.TestNested_getterMapping = {};
const TestNested_receivers = [
