...
export declare const BinaryAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class BinaryAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<BinaryAndSliceReceiverTester>;
    static fromAddress(address: Address): BinaryAndSliceReceiverTester;
    ...
    }, message: Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | Message | Slice): Promise<void>;
