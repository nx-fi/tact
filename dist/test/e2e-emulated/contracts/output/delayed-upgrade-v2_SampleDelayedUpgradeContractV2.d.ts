...
export declare function storeSampleDelayedUpgradeContractV2$Data(src: SampleDelayedUpgradeContractV2$Data): (builder: Builder) => void;
export declare function loadSampleDelayedUpgradeContractV2$Data(slice: Slice): {
    $$type: "SampleDelayedUpgradeContractV2$Data";
    _version: bigint;
    initiatedAt: bigint;
    upgradeInfo: {
...
export declare const SampleDelayedUpgradeContractV2_getterMapping: {
    [key: string]: string;
};
export declare class SampleDelayedUpgradeContractV2 implements Contract {
    static readonly storageReserve = 0n;
    static init(owner: Address): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address): Promise<SampleDelayedUpgradeContractV2>;
    static fromAddress(address: Address): SampleDelayedUpgradeContractV2;
    ...
    }, message: null | "increment" | Confirm | Upgrade): Promise<void>;
