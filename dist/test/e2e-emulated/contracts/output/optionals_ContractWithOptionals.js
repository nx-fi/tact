...
exports.ContractWithOptionals = exports.ContractWithOptionals_getterMapping = void 0;
...
function initContractWithOptionals_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        if (src.a !== null && src.a !== undefined) {
            b_0.storeBit(true).storeInt(src.a, 257);
...
async function ContractWithOptionals_init(a, b, c, d, e, f) {
    const __code = core_1.Cell.fromBase64('');
...
const ContractWithOptionals_errors = {
...
const ContractWithOptionals_types = [
...
const ContractWithOptionals_getters = [
    { "name": "isNotNullA", "methodId": 74449, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "isNotNullB", "methodId": 70322, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "isNotNullC", "methodId": 66195, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "isNotNullD", "methodId": 94836, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "isNotNullE", "methodId": 90709, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "isNotNullF", "methodId": 86582, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "nullA", "methodId": 119020, "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": true, "format": 257 } },
    { "name": "nullB", "methodId": 123023, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": true } },
    { "name": "nullC", "methodId": 127150, "arguments": [], "returnType": { "kind": "simple", "type": "cell", "optional": true } },
    { "name": "nullD", "methodId": 98377, "arguments": [], "returnType": { "kind": "simple", "type": "address", "optional": true } },
    { "name": "nullE", "methodId": 102504, "arguments": [], "returnType": { "kind": "simple", "type": "SomeGenericStruct", "optional": true } },
    { "name": "nullF", "methodId": 106507, "arguments": [], "returnType": { "kind": "simple", "type": "StructWithOptionals", "optional": true } },
    { "name": "notNullA", "methodId": 110911, "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "notNullB", "methodId": 98652, "arguments": [], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "notNullC", "methodId": 102781, "arguments": [], "returnType": { "kind": "simple", "type": "cell", "optional": false } },
    { "name": "notNullD", "methodId": 123290, "arguments": [], "returnType": { "kind": "simple", "type": "address", "optional": false } },
    { "name": "notNullE", "methodId": 127419, "arguments": [], "returnType": { "kind": "simple", "type": "SomeGenericStruct", "optional": false } },
    { "name": "notNullF", "methodId": 115160, "arguments": [], "returnType": { "kind": "simple", "type": "StructWithOptionals", "optional": false } },
    { "name": "testVariables", "methodId": 87190, "arguments": [], "returnType": { "kind": "simple", "type": "SomeGenericStruct", "optional": false } },
];
exports.ContractWithOptionals_getterMapping = {
    'isNotNullA': 'getIsNotNullA',
    'isNotNullB': 'getIsNotNullB',
    'isNotNullC': 'getIsNotNullC',
    'isNotNullD': 'getIsNotNullD',
    'isNotNullE': 'getIsNotNullE',
    'isNotNullF': 'getIsNotNullF',
    'nullA': 'getNullA',
    'nullB': 'getNullB',
    'nullC': 'getNullC',
    'nullD': 'getNullD',
    'nullE': 'getNullE',
    'nullF': 'getNullF',
    'notNullA': 'getNotNullA',
    'notNullB': 'getNotNullB',
    'notNullC': 'getNotNullC',
    'notNullD': 'getNotNullD',
    'notNullE': 'getNotNullE',
    'notNullF': 'getNotNullF',
    'testVariables': 'getTestVariables',
};
const ContractWithOptionals_receivers = [
    { "receiver": "internal", "message": { "kind": "empty" } },
    { "receiver": "internal", "message": { "kind": "typed", "type": "Update" } },
];
class ContractWithOptionals {
    static async init(a, b, c, d, e, f) {
        return await ContractWithOptionals_init(a, b, c, d, e, f);
    }
    static async fromInit(a, b, c, d, e, f) {
        const __gen_init = await ContractWithOptionals_init(a, b, c, d, e, f);
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new ContractWithOptionals(address, __gen_init);
    }
    ...
    async getIsNotNullA(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(74449, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getIsNotNullB(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(70322, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getIsNotNullC(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(66195, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getIsNotNullD(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(94836, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getIsNotNullE(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(90709, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getIsNotNullF(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(86582, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getNullA(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(119020, builder.build())).stack;
        const result = source.readBigNumberOpt();
        return result;
    }
    async getNullB(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(123023, builder.build())).stack;
        const result = source.readBooleanOpt();
        return result;
    }
    async getNullC(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(127150, builder.build())).stack;
        const result = source.readCellOpt();
        return result;
    }
    async getNullD(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(98377, builder.build())).stack;
        const result = source.readAddressOpt();
        return result;
    }
    async getNullE(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(102504, builder.build())).stack;
        const result_p = source.readTupleOpt();
        const result = result_p ? loadTupleSomeGenericStruct(result_p) : null;
        return result;
    }
    async getNullF(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(106507, builder.build())).stack;
        const result_p = source.readTupleOpt();
        const result = result_p ? loadTupleStructWithOptionals(result_p) : null;
        return result;
    }
    async getNotNullA(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(110911, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getNotNullB(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(98652, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getNotNullC(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(102781, builder.build())).stack;
        const result = source.readCell();
        return result;
    }
    async getNotNullD(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(123290, builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    async getNotNullE(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(127419, builder.build())).stack;
        const result = loadGetterTupleSomeGenericStruct(source);
        return result;
    }
    async getNotNullF(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(115160, builder.build())).stack;
        const result = loadGetterTupleStructWithOptionals(source);
        return result;
    }
    async getTestVariables(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(87190, builder.build())).stack;
        const result = loadGetterTupleSomeGenericStruct(source);
        return result;
    }
}
exports.ContractWithOptionals = ContractWithOptionals;
