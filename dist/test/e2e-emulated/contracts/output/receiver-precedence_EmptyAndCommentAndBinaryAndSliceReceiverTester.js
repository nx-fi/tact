...
exports.EmptyAndCommentAndBinaryAndSliceReceiverTester = exports.EmptyAndCommentAndBinaryAndSliceReceiverTester_getterMapping = void 0;
...
function initEmptyAndCommentAndBinaryAndSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function EmptyAndCommentAndBinaryAndSliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initEmptyAndCommentAndBinaryAndSliceReceiverTester_init_args({ $$type: 'EmptyAndCommentAndBinaryAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const EmptyAndCommentAndBinaryAndSliceReceiverTester_errors = {
...
const EmptyAndCommentAndBinaryAndSliceReceiverTester_types = [
...
const EmptyAndCommentAndBinaryAndSliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.EmptyAndCommentAndBinaryAndSliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const EmptyAndCommentAndBinaryAndSliceReceiverTester_receivers = [
...
class EmptyAndCommentAndBinaryAndSliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await EmptyAndCommentAndBinaryAndSliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await EmptyAndCommentAndBinaryAndSliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new EmptyAndCommentAndBinaryAndSliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new EmptyAndCommentAndBinaryAndSliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: EmptyAndCommentAndBinaryAndSliceReceiverTester_types,
        getters: EmptyAndCommentAndBinaryAndSliceReceiverTester_getters,
        receivers: EmptyAndCommentAndBinaryAndSliceReceiverTester_receivers,
        errors: EmptyAndCommentAndBinaryAndSliceReceiverTester_errors,
    };
...
exports.EmptyAndCommentAndBinaryAndSliceReceiverTester = EmptyAndCommentAndBinaryAndSliceReceiverTester;
