...
exports.Opt3 = exports.Opt3_getterMapping = void 0;
...
function initOpt3_init_args(src) {
    return (builder) => {
        const b_0 = builder;
...
async function Opt3_init(arg) {
    const __code = core_1.Cell.fromBase64('te6ccgEBAwEAXAABFP8A9KQT9LzyyAsBAT7TMNBy1yHSANIA+kAhEDRQVW8E+GEB+GLbPDDc8sCCAgBW7UTQ0gABkjBt4NIAAY4V0x8BghCxGWKauvLggYEBAdcAAW8BkW3iAdEwbQ==');
...
const Opt3_getters = [];
exports.Opt3_getterMapping = {};
const Opt3_receivers = [];
class Opt3 {
