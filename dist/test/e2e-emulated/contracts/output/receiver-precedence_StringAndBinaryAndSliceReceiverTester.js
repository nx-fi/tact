...
exports.StringAndBinaryAndSliceReceiverTester = exports.StringAndBinaryAndSliceReceiverTester_getterMapping = void 0;
...
function initStringAndBinaryAndSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function StringAndBinaryAndSliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initStringAndBinaryAndSliceReceiverTester_init_args({ $$type: 'StringAndBinaryAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const StringAndBinaryAndSliceReceiverTester_errors = {
...
const StringAndBinaryAndSliceReceiverTester_types = [
...
const StringAndBinaryAndSliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.StringAndBinaryAndSliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const StringAndBinaryAndSliceReceiverTester_receivers = [
...
class StringAndBinaryAndSliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await StringAndBinaryAndSliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await StringAndBinaryAndSliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new StringAndBinaryAndSliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new StringAndBinaryAndSliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: StringAndBinaryAndSliceReceiverTester_types,
        getters: StringAndBinaryAndSliceReceiverTester_getters,
        receivers: StringAndBinaryAndSliceReceiverTester_receivers,
        errors: StringAndBinaryAndSliceReceiverTester_errors,
    };
...
exports.StringAndBinaryAndSliceReceiverTester = StringAndBinaryAndSliceReceiverTester;
