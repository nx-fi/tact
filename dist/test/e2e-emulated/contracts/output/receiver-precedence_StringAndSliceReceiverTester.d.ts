...
export declare const StringAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class StringAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<StringAndSliceReceiverTester>;
    static fromAddress(address: Address): StringAndSliceReceiverTester;
    ...
    }, message: string | Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: string | Slice): Promise<void>;
