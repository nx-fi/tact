...
export declare function storeSampleDelayedUpgradeContract$Data(src: SampleDelayedUpgradeContract$Data): (builder: Builder) => void;
export declare function loadSampleDelayedUpgradeContract$Data(slice: Slice): {
    $$type: "SampleDelayedUpgradeContract$Data";
    _version: bigint;
    initiatedAt: bigint;
    upgradeInfo: {
...
export declare const SampleDelayedUpgradeContract_getterMapping: {
    [key: string]: string;
};
export declare class SampleDelayedUpgradeContract implements Contract {
    static readonly storageReserve = 0n;
    static init(owner: Address): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner: Address): Promise<SampleDelayedUpgradeContract>;
    static fromAddress(address: Address): SampleDelayedUpgradeContract;
