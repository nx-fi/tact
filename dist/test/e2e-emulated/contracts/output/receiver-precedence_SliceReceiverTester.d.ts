...
export declare const SliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class SliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<SliceReceiverTester>;
    static fromAddress(address: Address): SliceReceiverTester;
    ...
    }, message: Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: Slice): Promise<void>;
