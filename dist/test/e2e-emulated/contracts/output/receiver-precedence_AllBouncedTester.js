...
exports.AllBouncedTester = exports.AllBouncedTester_getterMapping = void 0;
...
function initAllBouncedTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
...
exports.AllBouncedTester = AllBouncedTester;
