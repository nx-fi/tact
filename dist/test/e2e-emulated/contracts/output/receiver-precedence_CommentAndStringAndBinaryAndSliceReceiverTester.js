...
exports.CommentAndStringAndBinaryAndSliceReceiverTester = exports.CommentAndStringAndBinaryAndSliceReceiverTester_getterMapping = void 0;
...
function initCommentAndStringAndBinaryAndSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function CommentAndStringAndBinaryAndSliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initCommentAndStringAndBinaryAndSliceReceiverTester_init_args({ $$type: 'CommentAndStringAndBinaryAndSliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const CommentAndStringAndBinaryAndSliceReceiverTester_errors = {
...
const CommentAndStringAndBinaryAndSliceReceiverTester_types = [
...
const CommentAndStringAndBinaryAndSliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.CommentAndStringAndBinaryAndSliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const CommentAndStringAndBinaryAndSliceReceiverTester_receivers = [
...
class CommentAndStringAndBinaryAndSliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await CommentAndStringAndBinaryAndSliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await CommentAndStringAndBinaryAndSliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new CommentAndStringAndBinaryAndSliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new CommentAndStringAndBinaryAndSliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: CommentAndStringAndBinaryAndSliceReceiverTester_types,
        getters: CommentAndStringAndBinaryAndSliceReceiverTester_getters,
        receivers: CommentAndStringAndBinaryAndSliceReceiverTester_receivers,
        errors: CommentAndStringAndBinaryAndSliceReceiverTester_errors,
    };
    ...
    async send(provider, via, args, message) {
        ...
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'Empty') {
            body = (0, core_1.beginCell)().store(storeEmpty(message)).endCell();
        }
        if (body === null) {
...
exports.CommentAndStringAndBinaryAndSliceReceiverTester = CommentAndStringAndBinaryAndSliceReceiverTester;
