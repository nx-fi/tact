...
export declare const C9g2_getterMapping: {
    [key: string]: string;
};
export declare class C9g2 implements Contract {
    static readonly storageReserve = 0n;
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C9g2>;
    static fromAddress(address: Address): C9g2;
