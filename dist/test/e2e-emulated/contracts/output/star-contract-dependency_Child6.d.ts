...
export declare const Child6_getterMapping: {
    [key: string]: string;
};
export declare class Child6 implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child6>;
    static fromAddress(address: Address): Child6;
