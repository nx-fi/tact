...
export declare const C10o_getterMapping: {
    [key: string]: string;
};
export declare class C10o implements Contract {
    static readonly storageReserve = 0n;
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C10o>;
    static fromAddress(address: Address): C10o;
    ...
    getGetField2(provider: ContractProvider): Promise<bigint>;
}
