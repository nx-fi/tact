...
exports.CommentAndStringAndBinaryReceiverTester = exports.CommentAndStringAndBinaryReceiverTester_getterMapping = void 0;
...
function initCommentAndStringAndBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function CommentAndStringAndBinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initCommentAndStringAndBinaryReceiverTester_init_args({ $$type: 'CommentAndStringAndBinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const CommentAndStringAndBinaryReceiverTester_errors = {
...
const CommentAndStringAndBinaryReceiverTester_types = [
...
const CommentAndStringAndBinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.CommentAndStringAndBinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const CommentAndStringAndBinaryReceiverTester_receivers = [
...
class CommentAndStringAndBinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await CommentAndStringAndBinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await CommentAndStringAndBinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new CommentAndStringAndBinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new CommentAndStringAndBinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: CommentAndStringAndBinaryReceiverTester_types,
        getters: CommentAndStringAndBinaryReceiverTester_getters,
        receivers: CommentAndStringAndBinaryReceiverTester_receivers,
        errors: CommentAndStringAndBinaryReceiverTester_errors,
    };
...
exports.CommentAndStringAndBinaryReceiverTester = CommentAndStringAndBinaryReceiverTester;
