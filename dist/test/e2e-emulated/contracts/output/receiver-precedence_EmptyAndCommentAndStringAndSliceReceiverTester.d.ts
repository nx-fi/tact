...
export declare const EmptyAndCommentAndStringAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndCommentAndStringAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndCommentAndStringAndSliceReceiverTester>;
    static fromAddress(address: Address): EmptyAndCommentAndStringAndSliceReceiverTester;
    ...
    }, message: null | "message" | string | Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: null | 'message' | string | Slice): Promise<void>;
