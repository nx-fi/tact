...
exports.SliceReceiverTester = exports.SliceReceiverTester_getterMapping = void 0;
...
function initSliceReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function SliceReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initSliceReceiverTester_init_args({ $$type: 'SliceReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const SliceReceiverTester_errors = {
...
const SliceReceiverTester_types = [
...
const SliceReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.SliceReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const SliceReceiverTester_receivers = [
    { "receiver": "internal", "message": { "kind": "any" } },
    { "receiver": "external", "message": { "kind": "any" } },
];
class SliceReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await SliceReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await SliceReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new SliceReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new SliceReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: SliceReceiverTester_types,
        getters: SliceReceiverTester_getters,
        receivers: SliceReceiverTester_receivers,
        errors: SliceReceiverTester_errors,
    };
...
exports.SliceReceiverTester = SliceReceiverTester;
