...
export declare const CommentAndStringReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentAndStringReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentAndStringReceiverTester>;
    static fromAddress(address: Address): CommentAndStringReceiverTester;
    ...
    sendExternal(provider: ContractProvider, message: 'message' | string): Promise<void>;
