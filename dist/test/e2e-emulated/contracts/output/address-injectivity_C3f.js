...
exports.C3f = exports.C3f_getterMapping = void 0;
...
function initC3f_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeInt(src.v, 257);
    };
}
async function C3f_init(v) {
    const __code = core_1.Cell.fromBase64('te6ccgEBAwEAfwABlv8AII49MDDQctch0gDSAPpAIRA0UFVvBPhhAfhi7UTQ0gABnYEBAdcAgQEB1wBZbBKagQEB1wABAdGAZOJb3PLAguH0pBP0vPLICwEBUaZsvbtRNDSAAGdgQEB1wCBAQHXAFlsEpqBAQHXAAEB0YBk4ljbPGwhgAgAGUiCg');
