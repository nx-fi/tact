...
exports.SampleDelayedUpgradeContract = exports.SampleDelayedUpgradeContract_getterMapping = void 0;
...
exports.storeSampleDelayedUpgradeContract$Data = storeSampleDelayedUpgradeContract$Data;
exports.loadSampleDelayedUpgradeContract$Data = loadSampleDelayedUpgradeContract$Data;
...
function storeSampleDelayedUpgradeContract$Data(src) {
    return (builder) => {
        const b_0 = builder;
...
function loadSampleDelayedUpgradeContract$Data(slice) {
    const sc_0 = slice;
    ...
    return { $$type: 'SampleDelayedUpgradeContract$Data', _version: __version, initiatedAt: _initiatedAt, upgradeInfo: _upgradeInfo, owner: _owner, counter: _counter };
}
function loadTupleSampleDelayedUpgradeContract$Data(source) {
...
function loadGetterTupleSampleDelayedUpgradeContract$Data(source) {
    const __version = source.readBigNumber();
    const _initiatedAt = source.readBigNumber();
...
function storeTupleSampleDelayedUpgradeContract$Data(source) {
    const builder = new core_1.TupleBuilder();
...
function dictValueParserSampleDelayedUpgradeContract$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeSampleDelayedUpgradeContract$Data(src)).endCell());
        },
        parse: (src) => {
...
function initSampleDelayedUpgradeContract_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
    };
}
async function SampleDelayedUpgradeContract_init(owner) {
...
const SampleDelayedUpgradeContract_errors = {
...
const SampleDelayedUpgradeContract_types = [
...
const SampleDelayedUpgradeContract_getters = [
...
exports.SampleDelayedUpgradeContract_getterMapping = {
    'counter': 'getCounter',
    'isUpgradable': 'getIsUpgradable',
    'version': 'getVersion',
    'owner': 'getOwner',
};
const SampleDelayedUpgradeContract_receivers = [
...
class SampleDelayedUpgradeContract {
...
exports.SampleDelayedUpgradeContract = SampleDelayedUpgradeContract;
