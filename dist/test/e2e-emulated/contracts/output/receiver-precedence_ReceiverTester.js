...
exports.ReceiverTester = exports.ReceiverTester_getterMapping = void 0;
...
function initReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function ReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initReceiverTester_init_args({ $$type: 'ReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const ReceiverTester_errors = {
...
const ReceiverTester_getters = [
    { "name": "receiverKind", "methodId": 87389, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.ReceiverTester_getterMapping = {
    'receiverKind': 'getReceiverKind',
};
const ReceiverTester_receivers = [
    ...
    { "receiver": "internal", "message": { "kind": "text", "text": "do_unsupported_op" } },
    { "receiver": "internal", "message": { "kind": "text", "text": "do_div_by_zero" } },
    { "receiver": "internal", "message": { "kind": "text", "text": "do_success_div" } },
    { "receiver": "internal", "message": { "kind": "text", "text": "do_unknown_request" } },
...
class ReceiverTester {
    ...
    async send(provider, via, args, message) {
        ...
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'Message') {
            body = (0, core_1.beginCell)().store(storeMessage(message)).endCell();
        }
    ...
    async sendExternal(provider, message) {
        let body = null;
        if (typeof message === 'string') {
            body = (0, core_1.beginCell)().storeUint(0, 32).storeStringTail(message).endCell();
        }
    ...
    async getReceiverKind(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(87389, builder.build())).stack;
        const result = source.readString();
        return result;
    }
}
exports.ReceiverTester = ReceiverTester;
