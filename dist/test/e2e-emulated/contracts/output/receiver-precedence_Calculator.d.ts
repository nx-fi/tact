...
export declare const Calculator_getterMapping: {
    [key: string]: string;
};
export declare class Calculator implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Calculator>;
    static fromAddress(address: Address): Calculator;
    ...
    }, message: "deploy" | BinaryIntOperation): Promise<void>;
}
