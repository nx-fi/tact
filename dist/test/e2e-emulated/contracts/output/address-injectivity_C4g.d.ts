...
export declare const C4g_getterMapping: {
    [key: string]: string;
};
export declare class C4g implements Contract {
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C4g>;
    static fromAddress(address: Address): C4g;
    ...
    private constructor();
    getIncrAndGetField(provider: ContractProvider, n: bigint): Promise<bigint>;
}
