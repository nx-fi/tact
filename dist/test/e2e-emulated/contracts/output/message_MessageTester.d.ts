...
export declare function storeMessageTester$Data(src: MessageTester$Data): (builder: Builder) => void;
export declare function loadMessageTester$Data(slice: Slice): {
    $$type: "MessageTester$Data";
};
export declare const MessageTester_getterMapping: {
    [key: string]: string;
};
export declare class MessageTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<MessageTester>;
    static fromAddress(address: Address): MessageTester;
    ...
    }, message: "Hello" | "topup" | "ReserveAtMost_1" | "ReserveAtMost_2" | Deploy): Promise<void>;
}
