...
export declare const EmptyAndCommentAndStringAndBinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndCommentAndStringAndBinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndCommentAndStringAndBinaryReceiverTester>;
    static fromAddress(address: Address): EmptyAndCommentAndStringAndBinaryReceiverTester;
    ...
    }, message: null | "message" | string | Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | 'message' | string | Message): Promise<void>;
