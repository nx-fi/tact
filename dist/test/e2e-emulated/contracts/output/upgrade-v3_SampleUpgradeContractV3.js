...
exports.SampleUpgradeContractV3 = exports.SampleUpgradeContractV3_getterMapping = void 0;
...
exports.storeSampleUpgradeContractV3$Data = storeSampleUpgradeContractV3$Data;
exports.loadSampleUpgradeContractV3$Data = loadSampleUpgradeContractV3$Data;
...
function loadUpgrade(slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3703389397) {
        throw Error('Invalid prefix');
    }
    const _code = sc_0.loadBit() ? sc_0.loadRef() : null;
    const _data = sc_0.loadBit() ? sc_0.loadRef() : null;
    return { $$type: 'Upgrade', code: _code, data: _data };
}
...
function storeSampleUpgradeContractV3$Data(src) {
    return (builder) => {
        const b_0 = builder;
...
function loadSampleUpgradeContractV3$Data(slice) {
    const sc_0 = slice;
    const __version = sc_0.loadUintBig(32);
    const _owner = sc_0.loadAddress();
    const _counter = sc_0.loadIntBig(32);
    return { $$type: 'SampleUpgradeContractV3$Data', _version: __version, owner: _owner, counter: _counter };
}
function loadTupleSampleUpgradeContractV3$Data(source) {
    const __version = source.readBigNumber();
    const _owner = source.readAddress();
    const _counter = source.readBigNumber();
    return { $$type: 'SampleUpgradeContractV3$Data', _version: __version, owner: _owner, counter: _counter };
}
function loadGetterTupleSampleUpgradeContractV3$Data(source) {
    const __version = source.readBigNumber();
    const _owner = source.readAddress();
    const _counter = source.readBigNumber();
    return { $$type: 'SampleUpgradeContractV3$Data', _version: __version, owner: _owner, counter: _counter };
}
function storeTupleSampleUpgradeContractV3$Data(source) {
    const builder = new core_1.TupleBuilder();
...
function dictValueParserSampleUpgradeContractV3$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeSampleUpgradeContractV3$Data(src)).endCell());
        },
        parse: (src) => {
...
function initSampleUpgradeContractV3_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
    };
}
async function SampleUpgradeContractV3_init(owner) {
...
const SampleUpgradeContractV3_errors = {
...
const SampleUpgradeContractV3_types = [
...
const SampleUpgradeContractV3_getters = [
...
exports.SampleUpgradeContractV3_getterMapping = {
    'counter': 'getCounter',
    'isUpgradable': 'getIsUpgradable',
    'version': 'getVersion',
    'owner': 'getOwner',
};
const SampleUpgradeContractV3_receivers = [
...
exports.SampleUpgradeContractV3 = SampleUpgradeContractV3;
