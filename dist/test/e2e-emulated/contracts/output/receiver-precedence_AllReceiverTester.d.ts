...
export declare const AllReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class AllReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<AllReceiverTester>;
    static fromAddress(address: Address): AllReceiverTester;
    ...
    }, message: null | "message" | string | Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | 'message' | string | Message | Slice): Promise<void>;
