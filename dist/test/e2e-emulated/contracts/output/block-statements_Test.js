...
exports.Test = exports.NestedConstant = exports.SubsequentConstant = exports.Test_getterMapping = void 0;
...
exports.SubsequentConstant = 1308n;
exports.NestedConstant = 84n;
class Test {
    ...
    async getA(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(88293, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getB(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(92294, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getC(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(96423, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getD(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(67648, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getE(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(71777, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
}
