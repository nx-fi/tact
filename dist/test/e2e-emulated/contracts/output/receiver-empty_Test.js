...
async function Test_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBBgEAdgABFP8A9KQT9LzyyAsBAgFiAgMBhtAB0HLXIdIA0gD6QCEQNFBmbwT4YQL4Yts8ApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbCZMMh/AcoAye1U4DDywIIEAg+hLYG2ebZ4YwQFABTtRNDSADCRbeBtAAj4J28Q');
...
class Test {
    ...
    async getBalance(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(104128, builder.build())).stack;
