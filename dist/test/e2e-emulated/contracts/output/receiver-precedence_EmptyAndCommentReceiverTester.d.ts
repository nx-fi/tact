...
export declare const EmptyAndCommentReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndCommentReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndCommentReceiverTester>;
    static fromAddress(address: Address): EmptyAndCommentReceiverTester;
    ...
    }, message: null | "message"): Promise<void>;
    sendExternal(provider: ContractProvider, message: null | 'message'): Promise<void>;
