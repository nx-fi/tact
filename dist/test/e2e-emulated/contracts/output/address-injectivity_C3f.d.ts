...
export declare const C3f_getterMapping: {
    [key: string]: string;
};
export declare class C3f implements Contract {
    static readonly storageReserve = 0n;
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C3f>;
    static fromAddress(address: Address): C3f;
