...
export declare function storeInit(src: Init): (builder: Builder) => void;
export declare function loadInit(slice: Slice): {
    $$type: "Init";
    foo: bigint;
};
...
export declare class Test implements Contract {
    static init(init: Init): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(init: Init): Promise<Test>;
    ...
    getData(provider: ContractProvider): Promise<bigint>;
}
