...
export declare const Child4_getterMapping: {
    [key: string]: string;
};
export declare class Child4 implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child4>;
    static fromAddress(address: Address): Child4;
