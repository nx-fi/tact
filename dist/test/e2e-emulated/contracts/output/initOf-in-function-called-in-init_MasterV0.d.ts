...
export declare function storeMasterV0$Data(src: MasterV0$Data): (builder: Builder) => void;
export declare function loadMasterV0$Data(slice: Slice): {
    $$type: "MasterV0$Data";
    state: bigint;
};
export declare const MasterV0_getterMapping: {
    [key: string]: string;
};
export declare class MasterV0 implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<MasterV0>;
    static fromAddress(address: Address): MasterV0;
    ...
    private constructor();
    getState(provider: ContractProvider): Promise<bigint>;
}
