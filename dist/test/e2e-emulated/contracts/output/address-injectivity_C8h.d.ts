...
export declare const C8h_getterMapping: {
    [key: string]: string;
};
export declare class C8h implements Contract {
    static readonly storageReserve = 0n;
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C8h>;
    static fromAddress(address: Address): C8h;
