...
export declare const EmptyAndCommentAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndCommentAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndCommentAndSliceReceiverTester>;
    static fromAddress(address: Address): EmptyAndCommentAndSliceReceiverTester;
    ...
    }, message: null | "message" | Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: null | 'message' | Slice): Promise<void>;
