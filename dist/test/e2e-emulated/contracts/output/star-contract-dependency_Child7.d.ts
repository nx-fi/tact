...
export declare const Child7_getterMapping: {
    [key: string]: string;
};
export declare class Child7 implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child7>;
    static fromAddress(address: Address): Child7;
