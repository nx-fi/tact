...
export declare const StringAndBinaryAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class StringAndBinaryAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<StringAndBinaryAndSliceReceiverTester>;
    static fromAddress(address: Address): StringAndBinaryAndSliceReceiverTester;
    ...
    }, message: string | Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | string | Message | Slice): Promise<void>;
