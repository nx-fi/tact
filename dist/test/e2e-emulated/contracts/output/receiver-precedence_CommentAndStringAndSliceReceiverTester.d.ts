...
export declare const CommentAndStringAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentAndStringAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentAndStringAndSliceReceiverTester>;
    static fromAddress(address: Address): CommentAndStringAndSliceReceiverTester;
    ...
    }, message: "message" | string | Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: 'message' | string | Slice): Promise<void>;
