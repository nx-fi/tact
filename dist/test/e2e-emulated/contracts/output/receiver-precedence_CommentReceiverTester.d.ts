...
export declare const CommentReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentReceiverTester>;
    static fromAddress(address: Address): CommentReceiverTester;
    ...
    sendExternal(provider: ContractProvider, message: 'message'): Promise<void>;
