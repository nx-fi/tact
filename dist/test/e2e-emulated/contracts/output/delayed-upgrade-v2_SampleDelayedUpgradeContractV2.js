...
exports.SampleDelayedUpgradeContractV2 = exports.SampleDelayedUpgradeContractV2_getterMapping = void 0;
...
exports.storeSampleDelayedUpgradeContractV2$Data = storeSampleDelayedUpgradeContractV2$Data;
exports.loadSampleDelayedUpgradeContractV2$Data = loadSampleDelayedUpgradeContractV2$Data;
...
function storeSampleDelayedUpgradeContractV2$Data(src) {
    return (builder) => {
        const b_0 = builder;
...
function loadSampleDelayedUpgradeContractV2$Data(slice) {
    const sc_0 = slice;
    ...
    return { $$type: 'SampleDelayedUpgradeContractV2$Data', _version: __version, initiatedAt: _initiatedAt, upgradeInfo: _upgradeInfo, owner: _owner, counter: _counter };
}
function loadTupleSampleDelayedUpgradeContractV2$Data(source) {
...
function loadGetterTupleSampleDelayedUpgradeContractV2$Data(source) {
    const __version = source.readBigNumber();
    const _initiatedAt = source.readBigNumber();
...
function storeTupleSampleDelayedUpgradeContractV2$Data(source) {
    const builder = new core_1.TupleBuilder();
...
function dictValueParserSampleDelayedUpgradeContractV2$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeSampleDelayedUpgradeContractV2$Data(src)).endCell());
        },
        parse: (src) => {
...
function initSampleDelayedUpgradeContractV2_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
    };
}
async function SampleDelayedUpgradeContractV2_init(owner) {
...
const SampleDelayedUpgradeContractV2_errors = {
...
const SampleDelayedUpgradeContractV2_types = [
...
const SampleDelayedUpgradeContractV2_getters = [
...
exports.SampleDelayedUpgradeContractV2_getterMapping = {
    'counter': 'getCounter',
    'isUpgradable': 'getIsUpgradable',
    'version': 'getVersion',
    'owner': 'getOwner',
};
const SampleDelayedUpgradeContractV2_receivers = [
...
class SampleDelayedUpgradeContractV2 {
...
exports.SampleDelayedUpgradeContractV2 = SampleDelayedUpgradeContractV2;
