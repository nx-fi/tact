...
export declare const CommentAndStringAndBinaryAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentAndStringAndBinaryAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentAndStringAndBinaryAndSliceReceiverTester>;
    static fromAddress(address: Address): CommentAndStringAndBinaryAndSliceReceiverTester;
    ...
    }, message: "message" | string | Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | 'message' | string | Message | Slice): Promise<void>;
