...
exports.EmptyAndCommentAndStringAndBinaryReceiverTester = exports.EmptyAndCommentAndStringAndBinaryReceiverTester_getterMapping = void 0;
...
function initEmptyAndCommentAndStringAndBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function EmptyAndCommentAndStringAndBinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initEmptyAndCommentAndStringAndBinaryReceiverTester_init_args({ $$type: 'EmptyAndCommentAndStringAndBinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const EmptyAndCommentAndStringAndBinaryReceiverTester_errors = {
...
const EmptyAndCommentAndStringAndBinaryReceiverTester_types = [
...
const EmptyAndCommentAndStringAndBinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.EmptyAndCommentAndStringAndBinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const EmptyAndCommentAndStringAndBinaryReceiverTester_receivers = [
...
class EmptyAndCommentAndStringAndBinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await EmptyAndCommentAndStringAndBinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await EmptyAndCommentAndStringAndBinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new EmptyAndCommentAndStringAndBinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new EmptyAndCommentAndStringAndBinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: EmptyAndCommentAndStringAndBinaryReceiverTester_types,
        getters: EmptyAndCommentAndStringAndBinaryReceiverTester_getters,
        receivers: EmptyAndCommentAndStringAndBinaryReceiverTester_receivers,
        errors: EmptyAndCommentAndStringAndBinaryReceiverTester_errors,
    };
...
exports.EmptyAndCommentAndStringAndBinaryReceiverTester = EmptyAndCommentAndStringAndBinaryReceiverTester;
