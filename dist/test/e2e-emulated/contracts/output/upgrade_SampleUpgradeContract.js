...
exports.SampleUpgradeContract = exports.SampleUpgradeContract_getterMapping = void 0;
...
exports.storeSampleUpgradeContract$Data = storeSampleUpgradeContract$Data;
exports.loadSampleUpgradeContract$Data = loadSampleUpgradeContract$Data;
...
function storeSampleUpgradeContract$Data(src) {
    return (builder) => {
        const b_0 = builder;
...
function loadSampleUpgradeContract$Data(slice) {
    const sc_0 = slice;
    const __version = sc_0.loadUintBig(32);
    const _owner = sc_0.loadAddress();
    const _counter = sc_0.loadUintBig(32);
    return { $$type: 'SampleUpgradeContract$Data', _version: __version, owner: _owner, counter: _counter };
}
function loadTupleSampleUpgradeContract$Data(source) {
    const __version = source.readBigNumber();
    const _owner = source.readAddress();
    const _counter = source.readBigNumber();
    return { $$type: 'SampleUpgradeContract$Data', _version: __version, owner: _owner, counter: _counter };
}
function loadGetterTupleSampleUpgradeContract$Data(source) {
    const __version = source.readBigNumber();
    const _owner = source.readAddress();
    const _counter = source.readBigNumber();
    return { $$type: 'SampleUpgradeContract$Data', _version: __version, owner: _owner, counter: _counter };
}
function storeTupleSampleUpgradeContract$Data(source) {
    const builder = new core_1.TupleBuilder();
...
function dictValueParserSampleUpgradeContract$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeSampleUpgradeContract$Data(src)).endCell());
        },
        parse: (src) => {
...
function initSampleUpgradeContract_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
    };
}
async function SampleUpgradeContract_init(owner) {
...
const SampleUpgradeContract_errors = {
...
const SampleUpgradeContract_types = [
...
const SampleUpgradeContract_getters = [
...
exports.SampleUpgradeContract = SampleUpgradeContract;
