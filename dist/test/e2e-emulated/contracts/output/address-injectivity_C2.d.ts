...
export declare const C2_getterMapping: {
    [key: string]: string;
};
export declare class C2 implements Contract {
    static readonly storageReserve = 0n;
    static init(v: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(v: bigint): Promise<C2>;
    static fromAddress(address: Address): C2;
