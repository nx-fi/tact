...
export declare const BinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class BinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<BinaryReceiverTester>;
    static fromAddress(address: Address): BinaryReceiverTester;
    ...
    }, message: Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | Message): Promise<void>;
