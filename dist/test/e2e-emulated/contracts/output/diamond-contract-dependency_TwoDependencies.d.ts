...
export declare const TwoDependencies_getterMapping: {
    [key: string]: string;
};
export declare class TwoDependencies implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<TwoDependencies>;
    static fromAddress(address: Address): TwoDependencies;
    ...
    getGetFirstDep(provider: ContractProvider): Promise<{
        $$type: "StateInit";
        code: Cell;
        data: Cell;
    }>;
    getGetSecondDep(provider: ContractProvider): Promise<{
        $$type: "StateInit";
        code: Cell;
        data: Cell;
    }>;
    getGetNoDep(provider: ContractProvider): Promise<{
        $$type: "StateInit";
        code: Cell;
        data: Cell;
    }>;
