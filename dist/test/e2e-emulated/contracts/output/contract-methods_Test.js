...
function loadTest$Data(slice) {
    ...
    return { $$type: 'Test$Data', flags: _flags, oneMoreVar: _oneMoreVar };
}
...
async function Test_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBBQEAoQABGv8AIOMDbYAT9LzyyAsBA/gwAdBy1yHSANIA+kAhEDRQZm8E+GEC+GLtRNDSAAGa0/+BAQHXAFlsEpUwcIEA7+IDkl8D4HAi10kgwh+VMQLTHzCRM+LAAALBIRKwjywB2zwwggCS6QLAKhLy9HAB2zwwgXrpIsAq8vTIfwHKAFkCy/+BAQHPAMntVOBbAgIDAQTbPAQABvLAggAIgCoyfw==');
