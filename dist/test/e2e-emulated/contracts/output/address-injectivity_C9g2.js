...
exports.C9g2 = exports.C9g2_getterMapping = void 0;
...
function initC9g2_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeInt(src.v, 257);
    };
}
async function C9g2_init(v) {
    const __code = core_1.Cell.fromBase64('te6ccgEBBgEAsAABlv8AII49MDDQctch0gDSAPpAIRA0UFVvBPhhAfhi7UTQ0gABnYEBAdcAgQEB1wBZbBKagQEB1wABAdGAZOJb3PLAguH0pBP0vPLICwECAnECAwFNvijnaiaGkAAM7AgIDrgECAgOuALLYJTUCAgOuAAIDowDJxbZ42EMBAFPvZe3aiaGkAAM7AgIDrgECAgOuALLYJTUCAgOuAAIDowDJxLG2eNhDAUAAiAABlIgoA==');
