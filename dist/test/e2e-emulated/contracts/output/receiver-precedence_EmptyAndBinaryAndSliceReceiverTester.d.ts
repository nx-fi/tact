...
export declare const EmptyAndBinaryAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndBinaryAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndBinaryAndSliceReceiverTester>;
    static fromAddress(address: Address): EmptyAndBinaryAndSliceReceiverTester;
    ...
    }, message: null | Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | Message | Slice): Promise<void>;
