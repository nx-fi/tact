...
export declare const EmptyAndStringAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndStringAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndStringAndSliceReceiverTester>;
    static fromAddress(address: Address): EmptyAndStringAndSliceReceiverTester;
    ...
    }, message: null | string | Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: null | string | Slice): Promise<void>;
