...
export declare const EmptyAndStringAndBinaryAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndStringAndBinaryAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndStringAndBinaryAndSliceReceiverTester>;
    static fromAddress(address: Address): EmptyAndStringAndBinaryAndSliceReceiverTester;
    ...
    }, message: null | string | Message | Slice | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | string | Message | Slice): Promise<void>;
