...
export declare const EmptyAndBinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndBinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndBinaryReceiverTester>;
    static fromAddress(address: Address): EmptyAndBinaryReceiverTester;
    ...
    }, message: null | Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | Message): Promise<void>;
