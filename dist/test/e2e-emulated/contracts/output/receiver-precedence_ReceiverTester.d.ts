...
export declare class ReceiverTester implements Contract {
    ...
    }, message: null | string | Message | Slice | "message" | "do_unsupported_op" | "do_div_by_zero" | "do_success_div" | "do_unknown_request"): Promise<void>;
    sendExternal(provider: ContractProvider, message: string | null | 'message' | Message): Promise<void>;
