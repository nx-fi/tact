...
export declare const ReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class ReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<ReceiverTester>;
    static fromAddress(address: Address): ReceiverTester;
    ...
    }, message: null | string | Message | Slice | "message" | "do_unsupported_op" | "do_div_by_zero" | "do_success_div" | "do_unknown_request" | SendCellToAddress): Promise<void>;
    sendExternal(provider: ContractProvider, message: string | null | 'message' | Message | Slice): Promise<void>;
    getReceiverKind(provider: ContractProvider): Promise<string>;
}
