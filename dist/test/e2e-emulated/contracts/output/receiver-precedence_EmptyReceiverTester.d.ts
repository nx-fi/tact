...
export declare const EmptyReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyReceiverTester>;
    static fromAddress(address: Address): EmptyReceiverTester;
    ...
    sendExternal(provider: ContractProvider, message: null): Promise<void>;
