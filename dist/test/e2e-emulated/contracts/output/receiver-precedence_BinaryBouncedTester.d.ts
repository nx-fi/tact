...
export declare const BinaryBouncedTester_getterMapping: {
    [key: string]: string;
};
export declare class BinaryBouncedTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<BinaryBouncedTester>;
    static fromAddress(address: Address): BinaryBouncedTester;
    ...
    }, message: SendCellToAddress | "reset"): Promise<void>;
