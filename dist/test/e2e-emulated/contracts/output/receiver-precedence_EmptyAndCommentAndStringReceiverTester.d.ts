...
export declare const EmptyAndCommentAndStringReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndCommentAndStringReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndCommentAndStringReceiverTester>;
    static fromAddress(address: Address): EmptyAndCommentAndStringReceiverTester;
    ...
    }, message: null | "message" | string): Promise<void>;
    sendExternal(provider: ContractProvider, message: null | 'message' | string): Promise<void>;
