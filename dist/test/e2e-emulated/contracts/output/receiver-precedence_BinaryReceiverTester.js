...
exports.BinaryReceiverTester = exports.BinaryReceiverTester_getterMapping = void 0;
...
function initBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function BinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initBinaryReceiverTester_init_args({ $$type: 'BinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const BinaryReceiverTester_errors = {
...
const BinaryReceiverTester_types = [
...
const BinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.BinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const BinaryReceiverTester_receivers = [
...
class BinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await BinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await BinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new BinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new BinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: BinaryReceiverTester_types,
        getters: BinaryReceiverTester_getters,
        receivers: BinaryReceiverTester_receivers,
        errors: BinaryReceiverTester_errors,
    };
...
exports.BinaryReceiverTester = BinaryReceiverTester;
