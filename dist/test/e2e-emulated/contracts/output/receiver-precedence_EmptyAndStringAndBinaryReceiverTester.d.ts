...
export declare const EmptyAndStringAndBinaryReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndStringAndBinaryReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndStringAndBinaryReceiverTester>;
    static fromAddress(address: Address): EmptyAndStringAndBinaryReceiverTester;
    ...
    }, message: null | string | Message | Empty): Promise<void>;
    sendExternal(provider: ContractProvider, message: Empty | null | string | Message): Promise<void>;
