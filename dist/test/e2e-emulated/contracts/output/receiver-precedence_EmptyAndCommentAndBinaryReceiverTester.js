...
exports.EmptyAndCommentAndBinaryReceiverTester = exports.EmptyAndCommentAndBinaryReceiverTester_getterMapping = void 0;
...
function initEmptyAndCommentAndBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function EmptyAndCommentAndBinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initEmptyAndCommentAndBinaryReceiverTester_init_args({ $$type: 'EmptyAndCommentAndBinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const EmptyAndCommentAndBinaryReceiverTester_errors = {
...
const EmptyAndCommentAndBinaryReceiverTester_types = [
...
const EmptyAndCommentAndBinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.EmptyAndCommentAndBinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const EmptyAndCommentAndBinaryReceiverTester_receivers = [
...
class EmptyAndCommentAndBinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await EmptyAndCommentAndBinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await EmptyAndCommentAndBinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new EmptyAndCommentAndBinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new EmptyAndCommentAndBinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: EmptyAndCommentAndBinaryReceiverTester_types,
        getters: EmptyAndCommentAndBinaryReceiverTester_getters,
        receivers: EmptyAndCommentAndBinaryReceiverTester_receivers,
        errors: EmptyAndCommentAndBinaryReceiverTester_errors,
    };
...
exports.EmptyAndCommentAndBinaryReceiverTester = EmptyAndCommentAndBinaryReceiverTester;
