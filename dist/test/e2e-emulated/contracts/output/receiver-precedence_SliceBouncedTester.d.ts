...
export declare const SliceBouncedTester_getterMapping: {
    [key: string]: string;
};
export declare class SliceBouncedTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<SliceBouncedTester>;
    static fromAddress(address: Address): SliceBouncedTester;
