...
exports.NoReceiverTester = exports.NoReceiverTester_getterMapping = void 0;
...
function initNoReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function NoReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBAwEAaQABhP8AII40MDDQctch0gDSAPpAIRA0UFVvBPhhAfhi7UTQ0gABlNQB0DGaMIt3Vua25vd26OIw3PLAguH0pBP0vPLICwEBO6ZNGPtRNDSAAGU1AHQMZowi3dW5rbm93bo4ts8MYAIAAiA=');
...
const NoReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.NoReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const NoReceiverTester_receivers = [];
class NoReceiverTester {
...
exports.NoReceiverTester = NoReceiverTester;
