...
exports.LocalTypeInferenceTester = exports.LocalTypeInferenceTester_getterMapping = void 0;
...
exports.storeLocalTypeInferenceTester$Data = storeLocalTypeInferenceTester$Data;
exports.loadLocalTypeInferenceTester$Data = loadLocalTypeInferenceTester$Data;
...
function loadMyStruct(slice) {
    ...
    return { $$type: 'MyStruct', x: _x, y: _y };
}
...
function storeLocalTypeInferenceTester$Data(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
function loadLocalTypeInferenceTester$Data(slice) {
    const sc_0 = slice;
    return { $$type: 'LocalTypeInferenceTester$Data' };
}
function loadTupleLocalTypeInferenceTester$Data(source) {
    return { $$type: 'LocalTypeInferenceTester$Data' };
}
function loadGetterTupleLocalTypeInferenceTester$Data(source) {
    return { $$type: 'LocalTypeInferenceTester$Data' };
}
function storeTupleLocalTypeInferenceTester$Data(source) {
    const builder = new core_1.TupleBuilder();
    return builder.build();
}
function dictValueParserLocalTypeInferenceTester$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeLocalTypeInferenceTester$Data(src)).endCell());
        },
        parse: (src) => {
...
function initLocalTypeInferenceTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function LocalTypeInferenceTester_init() {
    const __code = core_1.Cell.fromBase64('');
...
const LocalTypeInferenceTester_errors = {
...
const LocalTypeInferenceTester_types = [
...
const LocalTypeInferenceTester_getters = [
...
exports.LocalTypeInferenceTester_getterMapping = {
    'test1': 'getTest1',
    'test2': 'getTest2',
    'test3': 'getTest3',
    'test4': 'getTest4',
...
const LocalTypeInferenceTester_receivers = [
    { "receiver": "internal", "message": { "kind": "typed", "type": "Deploy" } },
];
class LocalTypeInferenceTester {
    ...
    async getTest1(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(70304, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getTest2(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(74435, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getTest3(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(78562, builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    async getTest4(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(82437, builder.build())).stack;
        const result = source.readAddress();
        return result;
    }
    async getTest5(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(86564, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getTest6(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(90695, builder.build())).stack;
        const result = source.readCell().asSlice();
        return result;
    }
    async getTest7(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(94822, builder.build())).stack;
        const result = source.readCell();
        return result;
    }
    async getTest8(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(99209, builder.build())).stack;
        const result = source.readCell().asBuilder();
        return result;
    }
    async getTest9(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(103336, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    async getTest10(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(107552, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    async getTest11(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(111617, builder.build())).stack;
        const result = loadGetterTupleStateInit(source);
        return result;
    }
    async getTest12(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(99426, builder.build())).stack;
    ...
    async getTest13(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(103491, builder.build())).stack;
        const result = core_1.Dictionary.loadDirect(core_1.Dictionary.Keys.BigInt(257), core_1.Dictionary.Values.Uint(32), source.readCellOpt());
        return result;
    }
    async getTest14(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(124068, builder.build())).stack;
        const result = loadGetterTupleMyStruct(source);
        return result;
    }
    async getTest15(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(128133, builder.build())).stack;
        const result = loadGetterTupleMyStruct(source);
        return result;
    }
    async getTest16(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(115942, builder.build())).stack;
        const result = source.readBigNumberOpt();
        return result;
    }
    async getTest17(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(120007, builder.build())).stack;
        const result = source.readBigNumberOpt();
        return result;
    }
    async getTest18(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(75048, builder.build())).stack;
        const result = source.readBigNumberOpt();
        return result;
    }
    async getTest19(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(79113, builder.build())).stack;
        const result = source.readBigNumberOpt();
        return result;
    }
}
exports.LocalTypeInferenceTester = LocalTypeInferenceTester;
