...
export declare const EmptyAndStringReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class EmptyAndStringReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<EmptyAndStringReceiverTester>;
    static fromAddress(address: Address): EmptyAndStringReceiverTester;
    ...
    }, message: null | string): Promise<void>;
    sendExternal(provider: ContractProvider, message: null | string): Promise<void>;
