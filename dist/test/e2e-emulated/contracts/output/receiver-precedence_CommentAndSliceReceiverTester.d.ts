...
export declare const CommentAndSliceReceiverTester_getterMapping: {
    [key: string]: string;
};
export declare class CommentAndSliceReceiverTester implements Contract {
    static readonly storageReserve = 0n;
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<CommentAndSliceReceiverTester>;
    static fromAddress(address: Address): CommentAndSliceReceiverTester;
    ...
    }, message: "message" | Slice): Promise<void>;
    sendExternal(provider: ContractProvider, message: 'message' | Slice): Promise<void>;
