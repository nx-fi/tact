...
export declare const Child8_getterMapping: {
    [key: string]: string;
};
export declare class Child8 implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<Child8>;
    static fromAddress(address: Address): Child8;
