...
exports.RandomContract = exports.RandomContract_getterMapping = void 0;
...
exports.storeRandomContract$Data = storeRandomContract$Data;
exports.loadRandomContract$Data = loadRandomContract$Data;
...
function storeRandomContract$Data(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
function loadRandomContract$Data(slice) {
    const sc_0 = slice;
    return { $$type: 'RandomContract$Data' };
}
function loadTupleRandomContract$Data(source) {
    return { $$type: 'RandomContract$Data' };
}
function loadGetterTupleRandomContract$Data(source) {
    return { $$type: 'RandomContract$Data' };
}
function storeTupleRandomContract$Data(source) {
    const builder = new core_1.TupleBuilder();
    return builder.build();
}
function dictValueParserRandomContract$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeRandomContract$Data(src)).endCell());
        },
        parse: (src) => {
            return loadRandomContract$Data(src.loadRef().beginParse());
        }
    };
}
function initRandomContract_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function RandomContract_init() {
    const __code = core_1.Cell.fromBase64('');
...
const RandomContract_types = [
    ...
    { "name": "RandomContract$Data", "header": null, "fields": [] },
];
const RandomContract_getters = [
    { "name": "randomInt", "methodId": 128647, "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "random", "methodId": 92013, "arguments": [{ "name": "min", "type": { "kind": "simple", "type": "int", "optional": false, "format": 257 } }, { "name": "max", "type": { "kind": "simple", "type": "int", "optional": false, "format": 257 } }], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
];
exports.RandomContract_getterMapping = {
    'randomInt': 'getRandomInt',
    'random': 'getRandom',
};
const RandomContract_receivers = [
...
class RandomContract {
    ...
    static async fromInit() {
        const __gen_init = await RandomContract_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new RandomContract(address, __gen_init);
    }
    ...
    init;
    abi = {
        types: RandomContract_types,
        getters: RandomContract_getters,
        receivers: RandomContract_receivers,
    ...
    async getRandomInt(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(128647, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
    async getRandom(provider, min, max) {
        const builder = new core_1.TupleBuilder();
        builder.writeNumber(min);
        builder.writeNumber(max);
        const source = (await provider.get(92013, builder.build())).stack;
        const result = source.readBigNumber();
        return result;
    }
}
