...
async function Test_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBBgEAlAABFP8A9KQT9LzyyAsBAgFiAgMBhtAB0HLXIdIA0gD6QCEQNFBmbwT4YQL4Yts8ApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbCZMMh/AcoAye1U4DDywIIEAhGhXy22eAO2eGMEBQAU7UTQ0gAwkW3gbQBCi1aGVsbG+CFfAm2LVoZWxsb4Il8CbpMgw2SRcOKSpgrg');
...
class Test {
    ...
    async getFoo(provider, a) {
        const builder = new core_1.TupleBuilder();
        builder.writeNumber(a);
        const source = (await provider.get(110486, builder.build())).stack;
