...
exports.StringAndBinaryReceiverTester = exports.StringAndBinaryReceiverTester_getterMapping = void 0;
...
function initStringAndBinaryReceiverTester_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function StringAndBinaryReceiverTester_init() {
    const __code = core_1.Cell.fromBase64('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initStringAndBinaryReceiverTester_init_args({ $$type: 'StringAndBinaryReceiverTester_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
const StringAndBinaryReceiverTester_errors = {
...
const StringAndBinaryReceiverTester_types = [
...
const StringAndBinaryReceiverTester_getters = [
    { "name": "receiver", "methodId": 78947, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
];
exports.StringAndBinaryReceiverTester_getterMapping = {
    'receiver': 'getReceiver',
};
const StringAndBinaryReceiverTester_receivers = [
...
class StringAndBinaryReceiverTester {
    static storageReserve = 0n;
    static async init() {
        return await StringAndBinaryReceiverTester_init();
    }
    static async fromInit() {
        const __gen_init = await StringAndBinaryReceiverTester_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new StringAndBinaryReceiverTester(address, __gen_init);
    }
    static fromAddress(address) {
        return new StringAndBinaryReceiverTester(address);
    }
    address;
    init;
    abi = {
        types: StringAndBinaryReceiverTester_types,
        getters: StringAndBinaryReceiverTester_getters,
        receivers: StringAndBinaryReceiverTester_receivers,
        errors: StringAndBinaryReceiverTester_errors,
    };
...
exports.StringAndBinaryReceiverTester = StringAndBinaryReceiverTester;
