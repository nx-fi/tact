...
exports.C4g = exports.C4g_getterMapping = void 0;
...
function initC4g_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeInt(src.v, 257);
    };
}
async function C4g_init(v) {
    const __code = core_1.Cell.fromBase64('te6ccgEBAwEAbgABhv8AII41MDDQctch0gDSAPpAIRA0UFVvBPhhAfhi7UTQ0gABl4EBAdcAATGYgQEB1wABAdHiMNzywILh9KQT9LzyyAsBAT+mQTU7UTQ0gABl4EBAdcAATGYgQEB1wABAdHiAds8MYAIABlIQoA==');
...
class C4g {
    ...
    async getIncrAndGetField(provider, n) {
        const builder = new core_1.TupleBuilder();
        builder.writeNumber(n);
        const source = (await provider.get(66772, builder.build())).stack;
