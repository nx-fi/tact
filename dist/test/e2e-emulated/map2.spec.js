...
const maps2_MapTestContract_1 = require("./contracts/output/maps2_MapTestContract");
...
const testCases = [
    {
        ...
        values: {
            ...
            valueInt256: 789n,
            valueUint8: 255n,
            valueUint42: 123456789n,
            valueUint256: 999999999999n,
            valueCoins: 100000000n,
        },
    },
    {
        keys: {
...
describe("MapTestContract", () => {
    ...
    beforeEach(async () => {
        ...
        contract = blockchain.openContract(await maps2_MapTestContract_1.MapTestContract.fromInit());
