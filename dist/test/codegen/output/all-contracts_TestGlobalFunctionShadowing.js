...
exports.TestGlobalFunctionShadowing = exports.GlobalConst = exports.TestGlobalFunctionShadowing_getterMapping = void 0;
...
function initTestGlobalFunctionShadowing_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function TestGlobalFunctionShadowing_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBAQEAawAA0v8AII5bMAHQctch0gDSAPpAIRA0UGZvBPhhAvhi7UTQ0gAwkW2RbeIwAZEw4CDXScIfk9MfMd75AYLw+Tco9OOOL6fqnTkatYGk6cGE797ueed9s48BwHocYku63PLAguFtgBP0vPLICw==');
...
const TestGlobalFunctionShadowing_errors = {
...
const TestGlobalFunctionShadowing_types = [
...
const TestGlobalFunctionShadowing_getters = [];
exports.TestGlobalFunctionShadowing_getterMapping = {};
const TestGlobalFunctionShadowing_receivers = [
    { "receiver": "internal", "message": { "kind": "text", "text": "foo" } },
];
exports.GlobalConst = 42n;
class TestGlobalFunctionShadowing {
...
exports.TestGlobalFunctionShadowing = TestGlobalFunctionShadowing;
