...
exports.MapUintBool = exports.GlobalConst = exports.MapUintBool_getterMapping = void 0;
...
function initMapUintBool_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function MapUintBool_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBAgEAnAABqv8AII7HMAHQctch0gDSAPpAIRA0UGZvBPhhAvhi7UTQ0gABlPQEATGSMG3iApFb4HAh10kgwh+VMQHTHzCRMuLAAAHBIbDjAjDywILhbYAT9LzyyAsBAIQggEBwcUEz9A5voZQB1wAwkltt4m7y5ACAQHB/cSFulVtZ9FswmMgBzwBBM/RD4oBAcFn0WzDIfwHKAAEB9ADJ7VQ=');
...
const MapUintBool_getters = [];
exports.MapUintBool_getterMapping = {};
const MapUintBool_receivers = [
...
exports.MapUintBool = MapUintBool;
