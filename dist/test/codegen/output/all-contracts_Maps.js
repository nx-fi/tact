...
exports.Maps = exports.Maps_getterMapping = void 0;
...
function initMaps_init_args(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeDict(src.arg, core_1.Dictionary.Keys.BigInt(257), core_1.Dictionary.Values.Bool());
    };
}
async function Maps_init(arg) {
    const __code = core_1.Cell.fromBase64('');
...
const Maps_getters = [
    { "name": "oneItem", "methodId": 68660, "arguments": [{ "name": "key", "type": { "kind": "simple", "type": "int", "optional": false, "format": 257 } }], "returnType": { "kind": "simple", "type": "address", "optional": true } },
    { "name": "itemCheck", "methodId": 102138, "arguments": [], "returnType": { "kind": "simple", "type": "string", "optional": false } },
    { "name": "allItems", "methodId": 68968, "arguments": [], "returnType": { "kind": "dict", "key": "address", "value": "TokenInfo", "valueFormat": "ref" } },
];
exports.Maps_getterMapping = {
    'oneItem': 'getOneItem',
    'itemCheck': 'getItemCheck',
...
class Maps {
    ...
    static async fromInit(arg) {
        const __gen_init = await Maps_init(arg);
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new Maps(address, __gen_init);
    }
    ...
    async send(provider, via, args, message) {
        ...
        if (message && typeof message === 'object' && !(message instanceof core_1.Slice) && message.$$type === 'Replace') {
            body = (0, core_1.beginCell)().store(storeReplace(message)).endCell();
        }
    ...
    async getOneItem(provider, key) {
        ...
        const source = (await provider.get(68660, builder.build())).stack;
        const result = source.readAddressOpt();
        return result;
    }
    async getItemCheck(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(102138, builder.build())).stack;
        const result = source.readString();
        return result;
    }
    async getAllItems(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get(68968, builder.build())).stack;
        const result = core_1.Dictionary.loadDirect(core_1.Dictionary.Keys.Address(), dictValueParserTokenInfo(), source.readCellOpt());
        return result;
    }
}
exports.Maps = Maps;
