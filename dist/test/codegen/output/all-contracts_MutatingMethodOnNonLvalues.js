...
exports.MutatingMethodOnNonLvalues = exports.GlobalConst = exports.MutatingMethodOnNonLvalues_getterMapping = void 0;
...
function initMutatingMethodOnNonLvalues_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function MutatingMethodOnNonLvalues_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBBQEAmAAB1P8AII7cMAHQctch0gDSAPpAIRA0UGZvBPhhAvhi7UTQ0gAwkW2RbeICkVvgINdJwh+T0x8x3vkBgvD5Nyj0444vp+qdORq1gaTpwYTv3u55532zjwHAehxiS7rjAjDywILhbYAT9LzyyAsBBByAKds8gCrbPIAr2zyALAMDAwIBFts8MMh/AcoAye1UAwEG2zwwBAACpA==');
...
const MutatingMethodOnNonLvalues_errors = {
...
const MutatingMethodOnNonLvalues_types = [
...
const MutatingMethodOnNonLvalues_getters = [];
exports.MutatingMethodOnNonLvalues_getterMapping = {};
const MutatingMethodOnNonLvalues_receivers = [
    { "receiver": "internal", "message": { "kind": "text", "text": "foo" } },
];
exports.GlobalConst = 42n;
class MutatingMethodOnNonLvalues {
...
exports.MutatingMethodOnNonLvalues = MutatingMethodOnNonLvalues;
