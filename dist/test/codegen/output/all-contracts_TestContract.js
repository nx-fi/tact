...
exports.TestContract = exports.GlobalConst = exports.TestContract_getterMapping = void 0;
...
function initTestContract_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function TestContract_init() {
    const __code = core_1.Cell.fromBase64('te6ccgEBBgEAbwABbP8AII4oMDDQctch0gDSAPpAIRA0UFVvBPhhAfhi7UTQ0gAwkW2RbeIw3PLAguH0pBP0vPLICwECAnECAwEjvcLHaiaGkAGEi2yLbxAO2eGMBAEjvfVfaiaGkAGEi2yLbxAO2eGMBQACbgAEbrM=');
...
const TestContract_getters = [
    { "name": "testEq", "methodId": 79960, "arguments": [{ "name": "s", "type": { "kind": "dict", "key": "int", "value": "int" } }], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
    { "name": "testNeq", "methodId": 114347, "arguments": [{ "name": "s", "type": { "kind": "dict", "key": "int", "value": "int" } }], "returnType": { "kind": "simple", "type": "bool", "optional": false } },
];
exports.TestContract_getterMapping = {
    'testEq': 'getTestEq',
    'testNeq': 'getTestNeq',
};
const TestContract_receivers = [];
...
class TestContract {
    ...
    static async fromInit() {
        const __gen_init = await TestContract_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new TestContract(address, __gen_init);
    }
    ...
    async getTestEq(provider, s) {
        const builder = new core_1.TupleBuilder();
        builder.writeCell(s.size > 0 ? (0, core_1.beginCell)().storeDictDirect(s, core_1.Dictionary.Keys.BigInt(257), core_1.Dictionary.Values.BigInt(257)).endCell() : null);
        const source = (await provider.get(79960, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
    async getTestNeq(provider, s) {
        const builder = new core_1.TupleBuilder();
        builder.writeCell(s.size > 0 ? (0, core_1.beginCell)().storeDictDirect(s, core_1.Dictionary.Keys.BigInt(257), core_1.Dictionary.Values.BigInt(257)).endCell() : null);
        const source = (await provider.get(114347, builder.build())).stack;
        const result = source.readBoolean();
        return result;
    }
}
