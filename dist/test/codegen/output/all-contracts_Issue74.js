...
exports.Issue74 = exports.GlobalConst = exports.Issue74_getterMapping = void 0;
...
function initIssue74_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function Issue74_init() {
    const __code = core_1.Cell.fromBase64('');
...
const Issue74_getters = [];
exports.Issue74_getterMapping = {};
const Issue74_receivers = [
