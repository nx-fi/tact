...
export type AstStatement = AstStatementLet | AstStatementReturn | AstStatementExpression | AstStatementAssign | AstStatementAugmentedAssign | AstStatementCondition | AstStatementWhile | AstStatementUntil | AstStatementRepeat | AstStatementTry | AstStatementForEach | AstStatementDestruct | AstStatementBlock;
...
export type AstExpression = AstOpBinary | AstOpUnary | AstConditional | AstMethodCall | AstFieldAccess | AstStaticCall | AstStructInstance | AstId | AstInitOf | AstCodeOf | AstString | AstLiteral;
export type AstLiteral = AstNumber | AstBoolean | AstNull | AstSimplifiedString | AstAddress | AstCell | AstSlice | AstStructValue;
...
export type AstFieldAccess = {
    ...
    readonly aggregate: AstExpression;
...
export type AstReceiverSubKind = AstReceiverSimple | AstReceiverFallback | AstReceiverComment;
...
export type AstReceiverKind = AstReceiverInternal | AstReceiverExternal | AstReceiverBounce;
export type AstNode = AstFuncId | AstDestructMapping | AstDestructEnd | AstExpression | AstStatement | AstTypeDecl | AstFieldDecl | AstTypedParameter | AstFunctionDef | AstFunctionAttribute | AstAsmFunctionDef | AstFunctionDecl | AstModule | AstNativeFunctionDecl | AstStructFieldInitializer | AstStructFieldValue | AstType | AstContractInit | AstReceiver | AstImport | AstConstantDef | AstConstantDecl | AstReceiverKind | AstReceiverSubKind;
