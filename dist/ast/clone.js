...
function cloneNode(src, { cloneNode }) {
    const recurse = (src) => {
        if (src.kind === "boolean") {
            ...
            return cloneNode({
                ...
                catchBlock: src.catchBlock
                    ? {
                        ...
                        catchStatements: src.catchBlock.catchStatements.map(recurse),
                    }
                    : undefined,
            });
        }
