...
async function build(args) {
    ...
    for (const contract of contracts) {
        ...
        const descriptor = (0, resolveDescriptors_1.getType)(ctx, contract);
    ...
    for (const pkg of packages) {
        ...
        try {
            const bindingsServer = (0, writeTypescript_1.writeTypescript)(JSON.parse(pkg.abi), ctx, built[pkg.name]?.constants ?? [], {
                code: pkg.code,
