...
const parseContract = ({ name, attributes, traits, declarations, loc, }) => (ctx) => {
    return ctx.ast.Contract(parseId(name)(ctx), map(parseList(traits), parseId)(ctx), map(attributes, parseContractAttribute)(ctx), map(declarations, parseContractItem)(ctx), loc);
};
