...
function testEquality(expr1, expr2, equal) {
    const ast = (0, ast_helpers_1.getAstFactory)();
    const { parseExpression } = (0, __1.getParser)(ast, grammar_1.defaultParser);
    expect((0, ast_helpers_1.eqExpressions)(parseExpression(expr1), parseExpression(expr2))).toBe(equal);
}
