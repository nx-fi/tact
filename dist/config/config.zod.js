...
exports.configSchema = exports.projectSchema = exports.modeSchema = exports.optionsSchema = exports.safetyOptionsSchema = void 0;
...
exports.optionsSchema = zod_1.z.object({
     ...
     */
    parser: zod_1.z.union([zod_1.z.literal("new"), zod_1.z.literal("old")]).optional(),
    /**
