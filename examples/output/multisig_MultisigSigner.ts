...
async function MultisigSigner_init(
    master: Address,
    members: Dictionary<Address, bigint>,
    requiredWeight: bigint,
    request: Request,
...
const MultisigSigner_getters: ABIGetter[] = [
    {
        ...
        methodId: 107262,
        arguments: [],
        returnType: { kind: "simple", type: "Request", optional: false },
    },
];
...
export class MultisigSigner implements Contract {
    static async init(
        ...
        return await MultisigSigner_init(
            master,
            members,
            requiredWeight,
            request,
    ...
    static async fromInit(
        ...
        const __gen_init = await MultisigSigner_init(
            master,
            members,
            requiredWeight,
            request,
    ...
    async getRequest(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(107262 as any, builder.build()))
            .stack;
