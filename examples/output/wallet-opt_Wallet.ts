...
function storeTupleTransferMessage(source: TransferMessage) {
    ...
    builder.writeSlice(source.transfer.asCell());
    return builder.build();
}
...
async function Wallet_init(key: bigint, walletId: bigint) {
    const __code = Cell.fromBase64('');
