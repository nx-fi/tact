...
TL-B: `_ seqno:uint32 user1Key:uint256 user2Key:uint256 user3Key:uint256 = MultisigContract`
Signature: `MultisigContract{seqno:uint32,user1Key:uint256,user2Key:uint256,user3Key:uint256}`
