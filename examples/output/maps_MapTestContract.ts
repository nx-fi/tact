...
function dictValueParserSetAddrMap1(): DictionaryValue<SetAddrMap1> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSetAddrMap1(src)).endCell());
        },
        parse: (src) => {
...
function dictValueParserSetAddrMap2(): DictionaryValue<SetAddrMap2> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSetAddrMap2(src)).endCell());
        },
        parse: (src) => {
...
function dictValueParserSetAddrMap3(): DictionaryValue<SetAddrMap3> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSetAddrMap3(src)).endCell());
        },
        parse: (src) => {
...
function dictValueParserSetAddrMap4(): DictionaryValue<SetAddrMap4> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSetAddrMap4(src)).endCell());
        },
        parse: (src) => {
...
export function loadSomeStruct2(slice: Slice) {
    const sc_0 = slice;
    const _value = sc_0.loadIntBig(257);
    const _intMap1 = Dictionary.load(Dictionary.Keys.Uint(8), Dictionary.Values.Uint(8), sc_0);
    return { $$type: 'SomeStruct2' as const, value: _value, intMap1: _intMap1 };
}

function loadTupleSomeStruct2(source: TupleReader) {
    const _value = source.readBigNumber();
    const _intMap1 = Dictionary.loadDirect(Dictionary.Keys.Uint(8), Dictionary.Values.Uint(8), source.readCellOpt());
    return { $$type: 'SomeStruct2' as const, value: _value, intMap1: _intMap1 };
}
...
function dictValueParserSomeStruct2(): DictionaryValue<SomeStruct2> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSomeStruct2(src)).endCell());
        },
        parse: (src) => {
...
export function storeMapTestContract$Data(src: MapTestContract$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeDict(src.intMap1, Dictionary.Keys.Uint(8), Dictionary.Values.Uint(8));
        b_0.storeDict(src.intMap2, Dictionary.Keys.BigInt(257), Dictionary.Values.Bool());
        const b_1 = new Builder();
        b_1.storeDict(src.intMap3, Dictionary.Keys.BigInt(257), Dictionary.Values.Cell());
        b_1.storeDict(src.intMap4, Dictionary.Keys.BigInt(257), dictValueParserSomeStruct());
        b_1.storeDict(src.addrMap1, Dictionary.Keys.Address(), Dictionary.Values.BigInt(257));
        const b_2 = new Builder();
        b_2.storeDict(src.addrMap2, Dictionary.Keys.Address(), Dictionary.Values.Bool());
        b_2.storeDict(src.addrMap3, Dictionary.Keys.Address(), Dictionary.Values.Cell());
        b_2.storeDict(src.addrMap4, Dictionary.Keys.Address(), dictValueParserSomeStruct());
...
export function loadMapTestContract$Data(slice: Slice) {
    const sc_0 = slice;
    const _intMap1 = Dictionary.load(Dictionary.Keys.Uint(8), Dictionary.Values.Uint(8), sc_0);
    const _intMap2 = Dictionary.load(Dictionary.Keys.BigInt(257), Dictionary.Values.Bool(), sc_0);
    const sc_1 = sc_0.loadRef().beginParse();
    const _intMap3 = Dictionary.load(Dictionary.Keys.BigInt(257), Dictionary.Values.Cell(), sc_1);
    const _intMap4 = Dictionary.load(Dictionary.Keys.BigInt(257), dictValueParserSomeStruct(), sc_1);
    const _addrMap1 = Dictionary.load(Dictionary.Keys.Address(), Dictionary.Values.BigInt(257), sc_1);
    const sc_2 = sc_1.loadRef().beginParse();
    const _addrMap2 = Dictionary.load(Dictionary.Keys.Address(), Dictionary.Values.Bool(), sc_2);
    const _addrMap3 = Dictionary.load(Dictionary.Keys.Address(), Dictionary.Values.Cell(), sc_2);
    const _addrMap4 = Dictionary.load(Dictionary.Keys.Address(), dictValueParserSomeStruct(), sc_2);
    return { $$type: 'MapTestContract$Data' as const, intMap1: _intMap1, intMap2: _intMap2, intMap3: _intMap3, intMap4: _intMap4, addrMap1: _addrMap1, addrMap2: _addrMap2, addrMap3: _addrMap3, addrMap4: _addrMap4 };
}

function loadTupleMapTestContract$Data(source: TupleReader) {
    const _intMap1 = Dictionary.loadDirect(Dictionary.Keys.Uint(8), Dictionary.Values.Uint(8), source.readCellOpt());
    const _intMap2 = Dictionary.loadDirect(Dictionary.Keys.BigInt(257), Dictionary.Values.Bool(), source.readCellOpt());
    const _intMap3 = Dictionary.loadDirect(Dictionary.Keys.BigInt(257), Dictionary.Values.Cell(), source.readCellOpt());
    const _intMap4 = Dictionary.loadDirect(Dictionary.Keys.BigInt(257), dictValueParserSomeStruct(), source.readCellOpt());
    const _addrMap1 = Dictionary.loadDirect(Dictionary.Keys.Address(), Dictionary.Values.BigInt(257), source.readCellOpt());
    const _addrMap2 = Dictionary.loadDirect(Dictionary.Keys.Address(), Dictionary.Values.Bool(), source.readCellOpt());
    const _addrMap3 = Dictionary.loadDirect(Dictionary.Keys.Address(), Dictionary.Values.Cell(), source.readCellOpt());
    const _addrMap4 = Dictionary.loadDirect(Dictionary.Keys.Address(), dictValueParserSomeStruct(), source.readCellOpt());
    return { $$type: 'MapTestContract$Data' as const, intMap1: _intMap1, intMap2: _intMap2, intMap3: _intMap3, intMap4: _intMap4, addrMap1: _addrMap1, addrMap2: _addrMap2, addrMap3: _addrMap3, addrMap4: _addrMap4 };
}
...
function storeTupleMapTestContract$Data(source: MapTestContract$Data) {
    const builder = new TupleBuilder();
    builder.writeCell(source.intMap1.size > 0 ? beginCell().storeDictDirect(source.intMap1, Dictionary.Keys.Uint(8), Dictionary.Values.Uint(8)).endCell() : null);
    builder.writeCell(source.intMap2.size > 0 ? beginCell().storeDictDirect(source.intMap2, Dictionary.Keys.BigInt(257), Dictionary.Values.Bool()).endCell() : null);
    builder.writeCell(source.intMap3.size > 0 ? beginCell().storeDictDirect(source.intMap3, Dictionary.Keys.BigInt(257), Dictionary.Values.Cell()).endCell() : null);
    builder.writeCell(source.intMap4.size > 0 ? beginCell().storeDictDirect(source.intMap4, Dictionary.Keys.BigInt(257), dictValueParserSomeStruct()).endCell() : null);
    builder.writeCell(source.addrMap1.size > 0 ? beginCell().storeDictDirect(source.addrMap1, Dictionary.Keys.Address(), Dictionary.Values.BigInt(257)).endCell() : null);
    builder.writeCell(source.addrMap2.size > 0 ? beginCell().storeDictDirect(source.addrMap2, Dictionary.Keys.Address(), Dictionary.Values.Bool()).endCell() : null);
    builder.writeCell(source.addrMap3.size > 0 ? beginCell().storeDictDirect(source.addrMap3, Dictionary.Keys.Address(), Dictionary.Values.Cell()).endCell() : null);
    builder.writeCell(source.addrMap4.size > 0 ? beginCell().storeDictDirect(source.addrMap4, Dictionary.Keys.Address(), dictValueParserSomeStruct()).endCell() : null);
    return builder.build();
}
...
async function MapTestContract_init() {
    const __code = Cell.fromBase64('');
...
const MapTestContract_types: ABIType[] = [
    ...
    {"name":"MapTestContract$Data","header":null,"fields":[{"name":"intMap1","type":{"kind":"dict","key":"uint","keyFormat":8,"value":"uint","valueFormat":8}},{"name":"intMap2","type":{"kind":"dict","key":"int","value":"bool"}},{"name":"intMap3","type":{"kind":"dict","key":"int","value":"cell","valueFormat":"ref"}},{"name":"intMap4","type":{"kind":"dict","key":"int","value":"SomeStruct","valueFormat":"ref"}},{"name":"addrMap1","type":{"kind":"dict","key":"address","value":"int"}},{"name":"addrMap2","type":{"kind":"dict","key":"address","value":"bool"}},{"name":"addrMap3","type":{"kind":"dict","key":"address","value":"cell","valueFormat":"ref"}},{"name":"addrMap4","type":{"kind":"dict","key":"address","value":"SomeStruct","valueFormat":"ref"}}]},
]

const MapTestContract_getters: ABIGetter[] = [
    {"name":"intMap1","methodId":67207,"arguments":[],"returnType":{"kind":"dict","key":"uint","keyFormat":8,"value":"uint","valueFormat":8}},
    {"name":"intMap1Value","methodId":103396,"arguments":[{"name":"key","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"int","optional":true,"format":257}},
    {"name":"intMap2","methodId":79588,"arguments":[],"returnType":{"kind":"dict","key":"int","value":"bool"}},
    {"name":"intMap2Value","methodId":89348,"arguments":[{"name":"key","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"bool","optional":true}},
    {"name":"intMap3","methodId":75461,"arguments":[],"returnType":{"kind":"dict","key":"int","value":"cell","valueFormat":"ref"}},
    {"name":"intMap3Value","methodId":71844,"arguments":[{"name":"key","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"cell","optional":true}},
    {"name":"intMap4","methodId":87586,"arguments":[],"returnType":{"kind":"dict","key":"int","value":"SomeStruct","valueFormat":"ref"}},
    {"name":"intMap4Value","methodId":119013,"arguments":[{"name":"key","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"SomeStruct","optional":true}},
    {"name":"addrMap1","methodId":93537,"arguments":[],"returnType":{"kind":"dict","key":"address","value":"int"}},
    {"name":"addrMap1Value","methodId":116148,"arguments":[{"name":"key","type":{"kind":"simple","type":"address","optional":false}}],"returnType":{"kind":"simple","type":"int","optional":true,"format":257}},
    {"name":"addrMap2","methodId":89346,"arguments":[],"returnType":{"kind":"dict","key":"address","value":"bool"}},
    {"name":"addrMap2Value","methodId":68436,"arguments":[{"name":"key","type":{"kind":"simple","type":"address","optional":false}}],"returnType":{"kind":"simple","type":"bool","optional":true}},
    {"name":"addrMap3","methodId":85283,"arguments":[],"returnType":{"kind":"dict","key":"address","value":"cell","valueFormat":"ref"}},
    {"name":"addrMap3Value","methodId":85748,"arguments":[{"name":"key","type":{"kind":"simple","type":"address","optional":false}}],"returnType":{"kind":"simple","type":"cell","optional":true}},
    {"name":"addrMap4","methodId":81348,"arguments":[],"returnType":{"kind":"dict","key":"address","value":"SomeStruct","valueFormat":"ref"}},
    {"name":"addrMap4Value","methodId":100021,"arguments":[{"name":"key","type":{"kind":"simple","type":"address","optional":false}}],"returnType":{"kind":"simple","type":"SomeStruct","optional":true}},
]
...
export class MapTestContract implements Contract {
    ...
    async getIntMap1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(67207 as any, builder.build())).stack;
        const result = Dictionary.loadDirect(Dictionary.Keys.Uint(8), Dictionary.Values.Uint(8), source.readCellOpt());
        return result;
    }
    ...
    async getIntMap1Value(provider: ContractProvider, key: bigint) {
        ...
        const source = (await provider.get(103396 as any, builder.build())).stack;
    ...
    async getIntMap2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(79588 as any, builder.build())).stack;
    ...
    async getIntMap2Value(provider: ContractProvider, key: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(key);
        const source = (await provider.get(89348 as any, builder.build())).stack;
    ...
    async getIntMap3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(75461 as any, builder.build())).stack;
        const result = Dictionary.loadDirect(Dictionary.Keys.BigInt(257), Dictionary.Values.Cell(), source.readCellOpt());
        return result;
    }
    ...
    async getIntMap3Value(provider: ContractProvider, key: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(key);
        const source = (await provider.get(71844 as any, builder.build())).stack;
    ...
    async getIntMap4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(87586 as any, builder.build())).stack;
        const result = Dictionary.loadDirect(Dictionary.Keys.BigInt(257), dictValueParserSomeStruct(), source.readCellOpt());
        return result;
    }
    ...
    async getIntMap4Value(provider: ContractProvider, key: bigint) {
        const builder = new TupleBuilder();
        builder.writeNumber(key);
        const source = (await provider.get(119013 as any, builder.build())).stack;
    ...
    async getAddrMap1(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(93537 as any, builder.build())).stack;
    ...
    async getAddrMap1Value(provider: ContractProvider, key: Address) {
        ...
        const source = (await provider.get(116148 as any, builder.build())).stack;
        const result = source.readBigNumberOpt();
        return result;
    }
    ...
    async getAddrMap2(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(89346 as any, builder.build())).stack;
    ...
    async getAddrMap2Value(provider: ContractProvider, key: Address) {
        const builder = new TupleBuilder();
        builder.writeAddress(key);
        const source = (await provider.get(68436 as any, builder.build())).stack;
        const result = source.readBooleanOpt();
        return result;
    }
    ...
    async getAddrMap3(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(85283 as any, builder.build())).stack;
        const result = Dictionary.loadDirect(Dictionary.Keys.Address(), Dictionary.Values.Cell(), source.readCellOpt());
        return result;
    }
    ...
    async getAddrMap3Value(provider: ContractProvider, key: Address) {
        const builder = new TupleBuilder();
        builder.writeAddress(key);
        const source = (await provider.get(85748 as any, builder.build())).stack;
        const result = source.readCellOpt();
        return result;
    }
    ...
    async getAddrMap4(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get(81348 as any, builder.build())).stack;
        const result = Dictionary.loadDirect(Dictionary.Keys.Address(), dictValueParserSomeStruct(), source.readCellOpt());
        return result;
    }
    ...
    async getAddrMap4Value(provider: ContractProvider, key: Address) {
        const builder = new TupleBuilder();
        builder.writeAddress(key);
        const source = (await provider.get(100021 as any, builder.build())).stack;
        const result_p = source.readTupleOpt();
        const result = result_p ? loadTupleSomeStruct(result_p) : null;
        return result;
    }
