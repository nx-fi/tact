...
function dictValueParserTreasure$Data(): DictionaryValue<Treasure$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeTreasure$Data(src)).endCell());
        },
        parse: (src) => {
...
async function Treasure_init(owner: Address) {
    const __code = Cell.fromBase64('');
...
const Treasure_types: ABIType[] = [
    ...
    {"name":"Withdraw","header":1672521544,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"mode","type":{"kind":"simple","type":"uint","optional":false,"format":8}}]},
    {"name":"Treasure$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}}]},
]
